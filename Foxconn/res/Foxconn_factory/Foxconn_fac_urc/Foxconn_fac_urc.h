...
#define BTN_FAC_HDMI1               BTN_HDMI_1	// Tommy 20191009 
#define BTN_FAC_HDMI2               BTN_HDMI_2	// Tommy 20191009 
#define BTN_FAC_HDMI3               BTN_HDMI_3	// Tommy 20191009 
#define BTN_FAC_HDMI4               BTN_HDMI_4 	// Tommy 20191009 
#define BTN_FAC_RETURN              BTN_RETURN	// Tommy 20191009 
...
extern INT32 a_Foxconn_fac_urc_dialog_register(VOID);

extern VOID Foxconn_custom_rcu_key_pre_handler(NAV_MODEL_T * pt_this,NAV_EVN_T * pt_event);   //ke_vizio_20160429 add
extern BOOL Foxconn_custom_system_key_cb(UINT32     ui4_evt_code);  //ke_vizio_20160429 add

#ifdef APP_Foxconn_DFT_WIFI_AUTO_DETECTION
extern VOID Foxconn_fac_set_WIFI_status(BOOL b_connect);
extern BOOL Foxconn_fac_get_WIFI_status(VOID);
#endif
