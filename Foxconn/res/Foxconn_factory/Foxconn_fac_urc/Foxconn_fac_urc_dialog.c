...
static INT32 _nav_fac_urc_dialog_image_init(NAV_FAC_URC_DIALOG_VIEW_T*    pt_nav_fac_dialog)
{
    ...
    i4_ret = Foxconn_fac_img_create_T_img_tpl(&pt_nav_fac_dialog->h_ui_simple_dialog_bk0);
    if(WGLR_OK != i4_ret)
    {
        return NAVR_FAIL;
    }
                                ...
                                HANDLE_T*                nav_fac_dialog)              /* Out */
{
    ...
    do
    {
        ...
        *nav_fac_dialog = pt_nav_fac_dialog_show->h_frm_simple_dialog;
        ...
        /* Done */
         _nav_fac_urc_dialog_set_attach_data(pt_nav_fac_dialog_show->h_frm_simple_dialog,
                                          pt_nav_fac_dialog_show);
        i4_ret = APP_UIR_OK;
    ...
    wgl_widget_proc_fct pf_wdgt_proc)
{
    ...
    {
        c_memset(&t_nav_fac_dialog_init, 0, sizeof(NAV_FAC_URC_DIALOG_SHOW_INIT_T));	//Tommy20200224
 ...
 * Returns  -
 *---------------------------------------------------------------------------*/
INT32 a_Foxconn_fac_urc_dialog_register(VOID)
{
    NAV_COMP_T      t_comp;
    INT32           i4_ret;
