...
#include "Foxconn_fac_img.h"

//#include "nav_fac_image_8888.i"
#include "Foxconn_fac_image_8888.i"
...
/*-----------------------------------------------------------------------------
 * Name
 *      Foxconn_fac_img_create_T_img_tpl
 * Description
 * Input arguments
 * Output arguments
 * Returns
 *---------------------------------------------------------------------------*/
INT32 Foxconn_fac_img_create_T_img_tpl(WGL_HIMG_TPL_T* ph_img_tpl)
{
    INT32 i4_ret;
...
/*-----------------------------------------------------------------------------
 * Name
 *      Foxconn_fac_img_create_menu_bk_img_tpl
 * Description
 * Input arguments
 * Output arguments
 * Returns
 *---------------------------------------------------------------------------*/
 INT32 Foxconn_fac_img_create_menu_bk_img_tpl(
...
/*-----------------------------------------------------------------------------
* Name
*      Foxconn_img_create_pwd_bk_img_tpl
* Description
* Input arguments
* Output arguments
* Returns
*---------------------------------------------------------------------------*/
INT32 Foxconn_fac_img_create_menu_hilight_img_tpl(
                WGL_HIMG_TPL_T*             ph_img_tpl
                )
{
    INT32 i4_ret;
 ...
 * Returns
 *---------------------------------------------------------------------------*/
INT32 Foxconn_fac_img_create_urc_bk_img_tpl(WGL_HIMG_TPL_T* ph_img_tpl)
{
    INT32 i4_ret;
 ...
 * Returns
 *---------------------------------------------------------------------------*/
INT32 Foxconn_fac_img_color_tuner_tpl(VOID)
{
    INT32 i4_ret;
