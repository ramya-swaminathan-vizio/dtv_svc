...
#include "Foxconn_color_tuner_v2.h"
...
//#define _Foxconn_fac_20_POINT_GAIN_COL_GAIN                     ((UINT8)0)
#define _Foxconn_fac_20_POINT_GAIN_COL_RED                      ((UINT8)1)
#define _Foxconn_fac_20_POINT_GAIN_COL_GREEN                    ((UINT8)2)
#define _Foxconn_fac_20_POINT_GAIN_COL_BLUE                     ((UINT8)3)
...
static INT32 _Foxconn_fac_clr_cpy_to_all_proc_fct(HANDLE_T h_widget,UINT32 ui4_msg,VOID * param1,VOID * param2);
static INT32 _Foxconn_fac_clr_tuner_20p_range_unit_proc(HANDLE_T h_focus, UINT32 ui4_keycode, UINT8 i1_hlt_num, INT16 i2_gain_num);
static INT32 _Foxconn_fac_set_nav(UINT16 ui2_keymap);
static INT32 _Foxconn_fac_20p_text_value_update(VOID);
...
static INT32 _Foxconn_fac_20_point_page_get_values(VOID);
static INT32 _Foxconn_fac_20_point_page_set_values(VOID);

const UINT8 ui1_Foxconn_color_eep_offset[COLOR_TUNER_FAC_TEMP_NUM][COLOR_TUNER_FAC_PLAY_CONTENT_NUM] = {{0,1,2,9}, {3,4,5,10}, {6,7,8,11}};  // 3 * 4

/*----------------------------------------------------------------------------
 * Name: Foxconn_fac_color_tuner_view_init_v2
 *
 * Description:
 *
 * Inputs:
 ...
 *
 ----------------------------------------------------------------------------*/
INT32 Foxconn_fac_color_tuner_view_init_v2(HANDLE_T h_parent, INT32 i4_frame_x_offset, INT32 i4_frame_y_offset)
{
    INT32 i4_ret = 0;
    ...
    Foxconn_fac_menu_frame_widget_create(h_parent, &h_color_tuner_frame_v2, i4_frame_x_offset, i4_frame_y_offset);
    
    Foxconn_fac_menu_frame_title_widget_create(h_color_tuner_frame_v2, &h_color_tuner_frame_title_v2, L"Color Tuner");
    
    Foxconn_fac_menu_text_widget_create(h_color_tuner_frame_v2, L"Color", 1, NULL, &h_clr_tuner_color_title_v2);
    Foxconn_fac_menu_list_widget_create(h_color_tuner_frame_v2, L"Color", 2, 1, _Foxconn_fac_clr_list_proc_fct, &h_clr_tuner_clr_sel_v2);
    Foxconn_fac_menu_range_widget_create(h_color_tuner_frame_v2, L"Hue", 3, -50, 50, _Foxconn_fac_clr_range_proc_fct, &h_clr_tuner_Hue_v2);
    Foxconn_fac_menu_range_widget_create(h_color_tuner_frame_v2, L"Saturation", 4, -50, 50, _Foxconn_fac_clr_range_proc_fct, &h_clr_tuner_Saturation_v2);
    Foxconn_fac_menu_range_widget_create(h_color_tuner_frame_v2, L"Brightness", 5, -50, 50, _Foxconn_fac_clr_range_proc_fct, &h_clr_tuner_Brightness_v2);
    Foxconn_fac_menu_range_widget_create(h_color_tuner_frame_v2, L"Offset", 6, -100, 100, _Foxconn_fac_clr_range_proc_fct, &h_clr_tuner_Offset_v2);
    Foxconn_fac_menu_range_widget_create(h_color_tuner_frame_v2, L"Gain", 7, -100, 100, _Foxconn_fac_clr_range_proc_fct, &h_clr_tuner_Gain_v2);

    Foxconn_fac_menu_text_widget_create(h_color_tuner_frame_v2, L"20 Point White Balance", 8, NULL, &h_clr_tuner_WB_title_v2);
    Foxconn_fac_menu_list_widget_create(h_color_tuner_frame_v2, L"Color", 9, 1, _Foxconn_fac_clr_list_proc_fct, &h_clr_tuner_WB_Gain_v2);
    Foxconn_fac_menu_range_widget_create(h_color_tuner_frame_v2, L"Red", 10, -50, 50, _Foxconn_fac_clr_range_proc_fct, &h_clr_tuner_Red_v2);
    Foxconn_fac_menu_range_widget_create(h_color_tuner_frame_v2, L"Green", 11, -50, 50, _Foxconn_fac_clr_range_proc_fct, &h_clr_tuner_Green_v2);
    Foxconn_fac_menu_range_widget_create(h_color_tuner_frame_v2, L"Blue", 12, -50, 50, _Foxconn_fac_clr_range_proc_fct, &h_clr_tuner_Blue_v2);
    Foxconn_fac_menu_text_widget_create(h_color_tuner_frame_v2, L"Copy Gain/offset & 20 pt to all", 13, _Foxconn_fac_clr_cpy_to_all_proc_fct, &h_clr_tuner_cpy_to_all_v2);
    Foxconn_fac_menu_text_widget_create(h_color_tuner_frame_v2, L"Reset to default", 14, _Foxconn_fac_clr_reset_proc_fct, &h_clr_tuner_reset_v2);

    //default string
    c_memset(w2s_string, 0, 10);
    c_uc_ps_to_w2s(ps_clr_tuner_str_v2[0], w2s_string, c_strlen(ps_clr_tuner_str_v2[0]));
    i4_ret = Foxconn_fac_menu_list_set_text(h_clr_tuner_clr_sel_v2, w2s_string);
    Foxconn_LOG_ON_FAIL(i4_ret);

    c_memset(w2s_string, 0, 10);
    c_uc_ps_to_w2s(ps_20p_WB_str_v2[0], w2s_string, c_strlen(ps_20p_WB_str_v2[0]));
    i4_ret = Foxconn_fac_menu_list_set_text(h_clr_tuner_WB_Gain_v2, w2s_string);
    Foxconn_LOG_ON_FAIL(i4_ret);
            ...
            switch (ui4_keycode)
            {
                ...
                case BTN_CURSOR_LEFT:
                {
                    ...
                    else //h_clr_tuner_WB_Gain_v2
                    {
                        ...
                        _Foxconn_fac_20p_text_value_update();
                    }
        ...
        case WGL_MSG_KEY_DOWN:
        {
            ...
            switch (ui4_keycode)
            {
                ...
                case BTN_CURSOR_RIGHT:
                {
                    ...
                    {
                        if(i2_clr_idx == COL_RED){
                            _Foxconn_fac_clr_tuner_clr_range_unit_proc(h_clr_tuner_Hue_v2, ui4_keycode, COLOR_TUNER_FAC_ADDRESS_OFFSET_HUE_R);
                        }
                        else if(i2_clr_idx == COL_GREEN)
                        {
                            _Foxconn_fac_clr_tuner_clr_range_unit_proc(h_clr_tuner_Hue_v2, ui4_keycode, COLOR_TUNER_FAC_ADDRESS_OFFSET_HUE_G);
                        }
                        else if(i2_clr_idx == COL_BLUE)
                        {
                            _Foxconn_fac_clr_tuner_clr_range_unit_proc(h_clr_tuner_Hue_v2, ui4_keycode, COLOR_TUNER_FAC_ADDRESS_OFFSET_HUE_B);
                        }
                        else if(i2_clr_idx == COL_CYAN)
                        {
                            _Foxconn_fac_clr_tuner_clr_range_unit_proc(h_clr_tuner_Hue_v2, ui4_keycode, COLOR_TUNER_FAC_ADDRESS_OFFSET_HUE_C);
                        }
                        else if(i2_clr_idx == COL_MAGENTA)
                        {
                            _Foxconn_fac_clr_tuner_clr_range_unit_proc(h_clr_tuner_Hue_v2, ui4_keycode, COLOR_TUNER_FAC_ADDRESS_OFFSET_HUE_M);
                        }
                        else //(i2_clr_idx == COL_YELLOW)
                        {
                            _Foxconn_fac_clr_tuner_clr_range_unit_proc(h_clr_tuner_Hue_v2, ui4_keycode, COLOR_TUNER_FAC_ADDRESS_OFFSET_HUE_Y);
                        }
                    ...
                    {
                        if(i2_clr_idx == COL_RED){
                            _Foxconn_fac_clr_tuner_clr_range_unit_proc(h_clr_tuner_Saturation_v2, ui4_keycode, COLOR_TUNER_FAC_ADDRESS_OFFSET_SAT_R);
                        }
                        else if(i2_clr_idx == COL_GREEN)
                        {
                            _Foxconn_fac_clr_tuner_clr_range_unit_proc(h_clr_tuner_Saturation_v2, ui4_keycode, COLOR_TUNER_FAC_ADDRESS_OFFSET_SAT_G);
                        }
                        else if(i2_clr_idx == COL_BLUE)
                        {
                            _Foxconn_fac_clr_tuner_clr_range_unit_proc(h_clr_tuner_Saturation_v2, ui4_keycode, COLOR_TUNER_FAC_ADDRESS_OFFSET_SAT_B);
                        }
                        else if(i2_clr_idx == COL_CYAN)
                        {
                            _Foxconn_fac_clr_tuner_clr_range_unit_proc(h_clr_tuner_Saturation_v2, ui4_keycode, COLOR_TUNER_FAC_ADDRESS_OFFSET_SAT_C);
                        }
                        else if(i2_clr_idx == COL_MAGENTA)
                        {
                            _Foxconn_fac_clr_tuner_clr_range_unit_proc(h_clr_tuner_Saturation_v2, ui4_keycode, COLOR_TUNER_FAC_ADDRESS_OFFSET_SAT_M);
                        }
                        else //(i2_clr_idx == COL_YELLOW)
                        {
                            _Foxconn_fac_clr_tuner_clr_range_unit_proc(h_clr_tuner_Saturation_v2, ui4_keycode, COLOR_TUNER_FAC_ADDRESS_OFFSET_SAT_Y);
                        }
                    ...
                    {
                        if(i2_clr_idx == COL_RED){
                            _Foxconn_fac_clr_tuner_clr_range_unit_proc(h_clr_tuner_Brightness_v2, ui4_keycode, COLOR_TUNER_FAC_ADDRESS_OFFSET_BRI_R);
                        }
                        else if(i2_clr_idx == COL_GREEN)
                        {
                            _Foxconn_fac_clr_tuner_clr_range_unit_proc(h_clr_tuner_Brightness_v2, ui4_keycode, COLOR_TUNER_FAC_ADDRESS_OFFSET_BRI_G);
                        }
                        else if(i2_clr_idx == COL_BLUE)
                        {
                            _Foxconn_fac_clr_tuner_clr_range_unit_proc(h_clr_tuner_Brightness_v2, ui4_keycode, COLOR_TUNER_FAC_ADDRESS_OFFSET_BRI_B);
                        }
                        else if(i2_clr_idx == COL_CYAN)
                        {
                            _Foxconn_fac_clr_tuner_clr_range_unit_proc(h_clr_tuner_Brightness_v2, ui4_keycode, COLOR_TUNER_FAC_ADDRESS_OFFSET_BRI_C);
                        }
                        else if(i2_clr_idx == COL_MAGENTA)
                        {
                            _Foxconn_fac_clr_tuner_clr_range_unit_proc(h_clr_tuner_Brightness_v2, ui4_keycode, COLOR_TUNER_FAC_ADDRESS_OFFSET_BRI_M);
                        }
                        else //(i2_clr_idx == COL_YELLOW)
                        {
                            _Foxconn_fac_clr_tuner_clr_range_unit_proc(h_clr_tuner_Brightness_v2, ui4_keycode, COLOR_TUNER_FAC_ADDRESS_OFFSET_BRI_Y);
                        }
                    ...
                    {
                        if(i2_clr_idx == COL_RED){
                            _Foxconn_fac_clr_tuner_clr_range_gain_offset_proc(h_clr_tuner_Offset_v2, ui4_keycode, APP_CFG_GRPID_FACTORY, APP_CFG_RECID_VID_FAC_OFFSET_R);
                        }
                        else if(i2_clr_idx == COL_GREEN)
                        {
                            _Foxconn_fac_clr_tuner_clr_range_gain_offset_proc(h_clr_tuner_Offset_v2, ui4_keycode, APP_CFG_GRPID_FACTORY, APP_CFG_RECID_VID_FAC_OFFSET_G);
                        }
                        else //(i2_clr_idx == COL_BLUE)
                        {
                            _Foxconn_fac_clr_tuner_clr_range_gain_offset_proc(h_clr_tuner_Offset_v2, ui4_keycode, APP_CFG_GRPID_FACTORY, APP_CFG_RECID_VID_FAC_OFFSET_B);
                        }
                    }
                    else if(h_focus == h_clr_tuner_Gain_v2)
                    {
                        if(i2_clr_idx == COL_RED){
                            _Foxconn_fac_clr_tuner_clr_range_gain_offset_proc(h_clr_tuner_Gain_v2, ui4_keycode, APP_CFG_GRPID_FACTORY, APP_CFG_RECID_VID_FAC_GAIN_R);
                        }
                        else if(i2_clr_idx == COL_GREEN)
                        {
                            _Foxconn_fac_clr_tuner_clr_range_gain_offset_proc(h_clr_tuner_Gain_v2, ui4_keycode, APP_CFG_GRPID_FACTORY, APP_CFG_RECID_VID_FAC_GAIN_G);
                        }
                        else //(i2_clr_idx == COL_BLUE)
                        {
                            _Foxconn_fac_clr_tuner_clr_range_gain_offset_proc(h_clr_tuner_Gain_v2, ui4_keycode, APP_CFG_GRPID_FACTORY, APP_CFG_RECID_VID_FAC_GAIN_B);
                        }
                    }
                    else if(h_focus == h_clr_tuner_Red_v2)
                    {
                        ui1_20_point_hlt_num = _Foxconn_fac_20_POINT_GAIN_COL_RED;
                        _Foxconn_fac_clr_tuner_20p_range_unit_proc(h_clr_tuner_Red_v2, ui4_keycode, ui1_20_point_hlt_num, i2_20_point_gain_num);

                        _Foxconn_fac_20_point_page_set_values();
                    }
                    else if(h_focus == h_clr_tuner_Green_v2)
                    {
                        ui1_20_point_hlt_num = _Foxconn_fac_20_POINT_GAIN_COL_GREEN;
                        _Foxconn_fac_clr_tuner_20p_range_unit_proc(h_clr_tuner_Green_v2, ui4_keycode, ui1_20_point_hlt_num, i2_20_point_gain_num);

                        _Foxconn_fac_20_point_page_set_values();
                    }
                    else  //h_clr_tuner_Blue_v2
                    {
                        ui1_20_point_hlt_num = _Foxconn_fac_20_POINT_GAIN_COL_BLUE;
                        _Foxconn_fac_clr_tuner_20p_range_unit_proc(h_clr_tuner_Blue_v2, ui4_keycode, ui1_20_point_hlt_num, i2_20_point_gain_num);
        ...
        case WGL_MSG_KEY_DOWN:
        {
            ...
            switch (ui4_keycode)
            {
                ...
                {   
                    ...
                    i2_clr_idx = COL_RED;
                    c_uc_ps_to_w2s(ps_clr_tuner_str_v2[i2_clr_idx], w2s_string, c_strlen(ps_clr_tuner_str_v2[i2_clr_idx]));
                    Foxconn_fac_menu_list_set_text(h_clr_tuner_clr_sel_v2, w2s_string);
                    _Foxconn_fac_color_tuner_update_clr_settig(i2_clr_idx);
                    ...
                    i2_20_point_gain_num = 0;
                    c_uc_ps_to_w2s(ps_20p_WB_str_v2[i2_20_point_gain_num], w2s_string, c_strlen(ps_20p_WB_str_v2[i2_20_point_gain_num]));
                    Foxconn_fac_menu_list_set_text(h_clr_tuner_WB_Gain_v2, w2s_string);
                    a_cfg_av_set(CFG_MAKE_ID(APP_CFG_GRPID_VIDEO, APP_CFG_RECID_VID_11_POINT_GAIN), i2_20_point_gain_num);
                    ...
                    _Foxconn_fac_20_point_page_get_values();
                    _Foxconn_fac_20p_text_value_update();
...
/*----------------------------------------------------------------------------
 * Name: _Foxconn_fac_clr_cpy_to_all_proc_fct
 *
 * Description:
 *
 * Inputs:
 ...
 *
 ----------------------------------------------------------------------------*/
static INT32 _Foxconn_fac_clr_cpy_to_all_proc_fct(HANDLE_T    h_widget,
                                          UINT32      ui4_msg,
                                          VOID*       param1,
                                          VOID*       param2)
{
...
//            UTF16_T w2s_string[10]={0};
            ...
            switch (ui4_keycode)
            {
                ...
                {   
                    ...
                    {
                        DBG_LOG_PRINT(("\n[Foxconn_FAC] %s ui4_clr_idx: %d\n", __FUNCTION__, ui4_clr_idx));
                        i4_ret = a_cfg_eep_raw_read(
                                ui4_dynamic_address + ui1_Foxconn_color_eep_offset[ui4_clr_idx][ui1_play_content] * COLOR_TUNER_FAC_PIECE_NUM + COLOR_TUNER_FAC_ADDRESS_OFFSET_R_GAIN,
                                (VOID *)&i1_R_gain,
                                1,
                                &ui4_read);
                        Foxconn_LOG_ON_FAIL(i4_ret);
                        ...
                        i4_ret = a_cfg_eep_raw_read(
                                ui4_dynamic_address + ui1_Foxconn_color_eep_offset[ui4_clr_idx][ui1_play_content] * COLOR_TUNER_FAC_PIECE_NUM + COLOR_TUNER_FAC_ADDRESS_OFFSET_G_GAIN,
                                (VOID *)&i1_G_gain,
                                1,
                                &ui4_read);
                        Foxconn_LOG_ON_FAIL(i4_ret);
                        ...
                        i4_ret = a_cfg_eep_raw_read(
                                ui4_dynamic_address + ui1_Foxconn_color_eep_offset[ui4_clr_idx][ui1_play_content] * COLOR_TUNER_FAC_PIECE_NUM + COLOR_TUNER_FAC_ADDRESS_OFFSET_B_GAIN,
                                (VOID *)&i1_B_gain,
                                1,
                                &ui4_read);
                        Foxconn_LOG_ON_FAIL(i4_ret);
                        ...
                        i4_ret = a_cfg_eep_raw_read(
                                ui4_dynamic_address + ui1_Foxconn_color_eep_offset[ui4_clr_idx][ui1_play_content] * COLOR_TUNER_FAC_PIECE_NUM + COLOR_TUNER_FAC_ADDRESS_OFFSET_R_OFFSET,
                                (VOID *)&i1_R_offset,
                                1,
                                &ui4_read);
                        Foxconn_LOG_ON_FAIL(i4_ret);
                        ...
                        i4_ret = a_cfg_eep_raw_read(
                                ui4_dynamic_address + ui1_Foxconn_color_eep_offset[ui4_clr_idx][ui1_play_content] * COLOR_TUNER_FAC_PIECE_NUM + COLOR_TUNER_FAC_ADDRESS_OFFSET_G_OFFSET,
                                (VOID *)&i1_G_offset,
                                1,
                                &ui4_read);
                        Foxconn_LOG_ON_FAIL(i4_ret);
                        ...
                        i4_ret = a_cfg_eep_raw_read(
                                ui4_dynamic_address + ui1_Foxconn_color_eep_offset[ui4_clr_idx][ui1_play_content] * COLOR_TUNER_FAC_PIECE_NUM + COLOR_TUNER_FAC_ADDRESS_OFFSET_B_OFFSET,
                                (VOID *)&i1_B_offset,
                                1,
                                &ui4_read);
                        Foxconn_LOG_ON_FAIL(i4_ret);

                        //DBG_LOG_PRINT(("\n[Foxconn_FAC] %s R i1_R_gain: %d\n", __FUNCTION__, i1_R_gain));
                        //DBG_LOG_PRINT(("\n[Foxconn_FAC] %s R i1_G_gain: %d\n", __FUNCTION__, i1_G_gain));
                        //DBG_LOG_PRINT(("\n[Foxconn_FAC] %s R i1_B_gain: %d\n", __FUNCTION__, i1_B_gain));
                        //DBG_LOG_PRINT(("\n[Foxconn_FAC] %s R i1_R_offset: %d\n", __FUNCTION__, i1_R_offset));
                        //DBG_LOG_PRINT(("\n[Foxconn_FAC] %s R i1_G_offset: %d\n", __FUNCTION__, i1_G_offset));
                        //DBG_LOG_PRINT(("\n[Foxconn_FAC] %s R i1_B_offset: %d\n", __FUNCTION__, i1_B_offset));
                        
                        for(ui4_content_idx = 0; ui4_content_idx < COLOR_TUNER_FAC_PLAY_CONTENT_NUM; ui4_content_idx++) //play_content
                        {
                            DBG_LOG_PRINT(("\n[Foxconn_FAC] %s ui4_content_idx: %d\n", __FUNCTION__, ui4_content_idx));
                            i4_ret = a_cfg_eep_raw_write(
                                    ui4_dynamic_address + ui1_Foxconn_color_eep_offset[ui4_clr_idx][ui4_content_idx] * COLOR_TUNER_FAC_PIECE_NUM + COLOR_TUNER_FAC_ADDRESS_OFFSET_R_GAIN,
                                    (VOID *)&i1_R_gain,
                                    1,
                                    &ui4_written); 
                            Foxconn_LOG_ON_FAIL(i4_ret);
                            ...
                            i4_ret = a_cfg_eep_raw_write(
                                    ui4_dynamic_address + ui1_Foxconn_color_eep_offset[ui4_clr_idx][ui4_content_idx] * COLOR_TUNER_FAC_PIECE_NUM + COLOR_TUNER_FAC_ADDRESS_OFFSET_G_GAIN,
                                    (VOID *)&i1_G_gain,
                                    1,
                                    &ui4_written); 
                            Foxconn_LOG_ON_FAIL(i4_ret);
                            ...
                            i4_ret = a_cfg_eep_raw_write(
                                    ui4_dynamic_address + ui1_Foxconn_color_eep_offset[ui4_clr_idx][ui4_content_idx] * COLOR_TUNER_FAC_PIECE_NUM + COLOR_TUNER_FAC_ADDRESS_OFFSET_B_GAIN,
                                    (VOID *)&i1_B_gain,
                                    1,
                                    &ui4_written); 
                            Foxconn_LOG_ON_FAIL(i4_ret);
                            ...
                            i4_ret = a_cfg_eep_raw_write(
                                    ui4_dynamic_address + ui1_Foxconn_color_eep_offset[ui4_clr_idx][ui4_content_idx] * COLOR_TUNER_FAC_PIECE_NUM + COLOR_TUNER_FAC_ADDRESS_OFFSET_R_OFFSET,
                                    (VOID *)&i1_R_offset,
                                    1,
                                    &ui4_written); 
                            Foxconn_LOG_ON_FAIL(i4_ret);
                            ...
                            i4_ret = a_cfg_eep_raw_write(
                                    ui4_dynamic_address + ui1_Foxconn_color_eep_offset[ui4_clr_idx][ui4_content_idx] * COLOR_TUNER_FAC_PIECE_NUM + COLOR_TUNER_FAC_ADDRESS_OFFSET_G_OFFSET,
                                    (VOID *)&i1_G_offset,
                                    1,
                                    &ui4_written); 
                            Foxconn_LOG_ON_FAIL(i4_ret);
                            ...
                            i4_ret = a_cfg_eep_raw_write(
                                    ui4_dynamic_address + ui1_Foxconn_color_eep_offset[ui4_clr_idx][ui4_content_idx] * COLOR_TUNER_FAC_PIECE_NUM + COLOR_TUNER_FAC_ADDRESS_OFFSET_B_OFFSET,
                                    (VOID *)&i1_B_offset,
                                    1,
                                    &ui4_written); 
                            Foxconn_LOG_ON_FAIL(i4_ret);
                    ...
                    {
                        i4_ret = a_cfg_eep_raw_read(
                                ui4_dynamic_address + ui1_Foxconn_color_eep_offset[ui4_clr_idx][ui1_play_content] * COLOR_TUNER_FAC_PIECE_NUM + COLOR_TUNER_FAC_ADDRESS_OFFSET_20_POINT_R,
                                (VOID *)&i1_R,
                        ...
                        i4_ret = a_cfg_eep_raw_read(
                                ui4_dynamic_address + ui1_Foxconn_color_eep_offset[ui4_clr_idx][ui1_play_content] * COLOR_TUNER_FAC_PIECE_NUM + COLOR_TUNER_FAC_ADDRESS_OFFSET_20_POINT_G,
                                (VOID *)&i1_G,
                                COLOR_TUNER_FAC_20POINT_NUM, //COLOR_TUNER_FAC_11POINT_NUM,
                                &ui4_read); 
                        Foxconn_LOG_ON_FAIL(i4_ret);
                        ...
                        i4_ret = a_cfg_eep_raw_read(
                                ui4_dynamic_address + ui1_Foxconn_color_eep_offset[ui4_clr_idx][ui1_play_content] * COLOR_TUNER_FAC_PIECE_NUM + COLOR_TUNER_FAC_ADDRESS_OFFSET_20_POINT_B,
                                (VOID *)&i1_B,
                                COLOR_TUNER_FAC_20POINT_NUM, //COLOR_TUNER_FAC_11POINT_NUM,
                                &ui4_read); 
                        Foxconn_LOG_ON_FAIL(i4_ret);
                        ...
                        {
                            i4_ret = a_cfg_eep_raw_write(
                                        ui4_dynamic_address + ui1_Foxconn_color_eep_offset[ui4_clr_idx][ui4_content_idx] * COLOR_TUNER_FAC_PIECE_NUM + COLOR_TUNER_FAC_ADDRESS_OFFSET_20_POINT_R,
                                        (VOID *)&i1_R,
                                        COLOR_TUNER_FAC_20POINT_NUM, //COLOR_TUNER_FAC_11POINT_NUM,
                                        &ui4_written); 
                            Foxconn_LOG_ON_FAIL(i4_ret);
                            ...
                            i4_ret = a_cfg_eep_raw_write(
                                        ui4_dynamic_address + ui1_Foxconn_color_eep_offset[ui4_clr_idx][ui4_content_idx] * COLOR_TUNER_FAC_PIECE_NUM + COLOR_TUNER_FAC_ADDRESS_OFFSET_20_POINT_G,
                                        (VOID *)&i1_G,
                                        COLOR_TUNER_FAC_20POINT_NUM , //COLOR_TUNER_FAC_11POINT_NUM,
                                        &ui4_written); 
                            Foxconn_LOG_ON_FAIL(i4_ret);
                            ...
                            i4_ret = a_cfg_eep_raw_write(
                                        ui4_dynamic_address + ui1_Foxconn_color_eep_offset[ui4_clr_idx][ui4_content_idx] * COLOR_TUNER_FAC_PIECE_NUM + COLOR_TUNER_FAC_ADDRESS_OFFSET_20_POINT_B,
                                        (VOID *)&i1_B,
                                        COLOR_TUNER_FAC_20POINT_NUM, //COLOR_TUNER_FAC_11POINT_NUM,
                                        &ui4_written); 
                            Foxconn_LOG_ON_FAIL(i4_ret);
...
static INT32 _Foxconn_fac_set_nav(UINT16 ui2_keymap)
{
    ...
    if(ui2_keymap == 1){
        ...
        at_key_lnk[1].ui4_key = BTN_CURSOR_DOWN;
        at_key_lnk[1].h_widget = h_clr_tuner_cpy_to_all_v2; //h_clr_tuner_reset_v2;
...
/*----------------------------------------------------------------------------
 * Name: _Foxconn_fac_20p_value_update
 *
 * Description:
 *
 * Inputs:
...
static INT32 _Foxconn_fac_20p_text_value_update(VOID)
{
    Foxconn_fac_menu_range_set_val(h_clr_tuner_Red_v2, (INT32)ai1_20_point_values[_Foxconn_fac_20_POINT_GAIN_COL_RED-1][i2_20_point_gain_num]);
    Foxconn_fac_menu_range_set_val(h_clr_tuner_Green_v2, (INT32)ai1_20_point_values[_Foxconn_fac_20_POINT_GAIN_COL_GREEN-1][i2_20_point_gain_num]);
    Foxconn_fac_menu_range_set_val(h_clr_tuner_Blue_v2, (INT32)ai1_20_point_values[_Foxconn_fac_20_POINT_GAIN_COL_BLUE-1][i2_20_point_gain_num]);
    return 0;
}

/*----------------------------------------------------------------------------
 * Name: Foxconn_fac_color_tuner_menu_show_v2
 *
 * Description:
 *
 * Inputs:
 ...
 *
 ----------------------------------------------------------------------------*/
INT32 Foxconn_fac_color_tuner_menu_show_v2(BOOL b_repaint)
{
    UTF16_T w2s_string[20]={0}; //UTF16_T w2s_string[15]={0};
    CHAR s_string[20] = {0};
    INT32 i4_ret = 0;
    UINT8 ui1_play_content = a_acfg_cust_get_dynamic_range();
    ...
    i2_clr_idx = 0;
    i2_20_point_gain_num = 0;
    DBG_LOG_PRINT(("###ke_test %s Line: %d\n", __FUNCTION__, __LINE__));  //ke_test
    ...
    c_memset(w2s_string, 0, sizeof(w2s_string));  // c_memset(w2s_string, 0, 15);
...
/*----------------------------------------------------------------------------
 * Name: Foxconn_fac_color_tuner_menu_hide_v2
 *
 * Description:
 *
 * Inputs:
 ...
 *
 ----------------------------------------------------------------------------*/
INT32 Foxconn_fac_color_tuner_menu_hide_v2(BOOL b_repaint)
{
...
//	UINT8	ui1_play_content = acfg_check_play_content();
    ...
    i4_ret = a_cfg_eep_raw_read(
            ui4_dynamic_address + ui1_Foxconn_color_eep_offset[i2_clr_temp][ui1_play_content] * COLOR_TUNER_FAC_PIECE_NUM + ui2_rec_idx,
            (VOID *)&i1_vid_eq_val,
            1,
            &ui4_read); 
...
//	UINT8	ui1_play_content = acfg_check_play_content();
    ...
    DBG_LOG_PRINT(("eep_idx : 0x%x\n", ui4_dynamic_address + (ui1_Foxconn_color_eep_offset[i2_clr_temp][ui1_play_content]) * COLOR_TUNER_FAC_PIECE_NUM + ui2_idx));
...
/*----------------------------------------------------------------------------
 * Name: _Foxconn_fac_clr_tuner_20p_range_unit_proc
 *
 * Description:
 *
 * Inputs:
...
//	UINT8 ui1_play_content = acfg_check_play_content();
    ...
    {
        i4_ret = a_cfg_eep_raw_read(
                    ui4_dynamic_address + ui1_Foxconn_color_eep_offset[i2_clr_temp][ui1_play_content] * COLOR_TUNER_FAC_PIECE_NUM + COLOR_TUNER_FAC_ADDRESS_OFFSET_HUE_R,
                    (VOID *)&i1_val,
                    1,
                    &ui4_read);
        Foxconn_LOG_ON_FAIL(i4_ret);
        i4_ret = Foxconn_fac_menu_range_set_val(h_clr_tuner_Hue_v2, (INT32)i1_val);
        Foxconn_LOG_ON_FAIL(i4_ret);

        i4_ret = a_cfg_eep_raw_read(
                    ui4_dynamic_address + ui1_Foxconn_color_eep_offset[i2_clr_temp][ui1_play_content] * COLOR_TUNER_FAC_PIECE_NUM + COLOR_TUNER_FAC_ADDRESS_OFFSET_SAT_R,
                    (VOID *)&i1_val,
                    1,
                    &ui4_read);
        Foxconn_LOG_ON_FAIL(i4_ret);
        i4_ret = Foxconn_fac_menu_range_set_val(h_clr_tuner_Saturation_v2, (INT32)i1_val);
        Foxconn_LOG_ON_FAIL(i4_ret);

        i4_ret = a_cfg_eep_raw_read(
                    ui4_dynamic_address + ui1_Foxconn_color_eep_offset[i2_clr_temp][ui1_play_content] * COLOR_TUNER_FAC_PIECE_NUM + COLOR_TUNER_FAC_ADDRESS_OFFSET_BRI_R,
                    (VOID *)&i1_val,
                    1,
                    &ui4_read);
        Foxconn_LOG_ON_FAIL(i4_ret);
        i4_ret = Foxconn_fac_menu_range_set_val(h_clr_tuner_Brightness_v2, (INT32)i1_val);
        Foxconn_LOG_ON_FAIL(i4_ret);
        ...
        i4_ret = a_cfg_eep_raw_read(
                    ...
                    &ui4_read);
        Foxconn_LOG_ON_FAIL(i4_ret);
        i4_ret = Foxconn_fac_menu_range_set_val(h_clr_tuner_Offset_v2, (INT32)i1_val);
        Foxconn_LOG_ON_FAIL(i4_ret);
        ...
        i4_ret = a_cfg_eep_raw_read(
                    ...
                    &ui4_read);
        Foxconn_LOG_ON_FAIL(i4_ret);
        i4_ret = Foxconn_fac_menu_range_set_val(h_clr_tuner_Gain_v2, (INT32)i1_val);
        Foxconn_LOG_ON_FAIL(i4_ret);
    }
    else if(i2_idx == COL_GREEN)
    {
        i4_ret = a_cfg_eep_raw_read(
                    ui4_dynamic_address + ui1_Foxconn_color_eep_offset[i2_clr_temp][ui1_play_content] * COLOR_TUNER_FAC_PIECE_NUM + COLOR_TUNER_FAC_ADDRESS_OFFSET_HUE_G,
                    (VOID *)&i1_val,
                    1,
                    &ui4_read); 
        Foxconn_LOG_ON_FAIL(i4_ret);
        ...
        i4_ret = a_cfg_eep_raw_read(
                    ui4_dynamic_address + ui1_Foxconn_color_eep_offset[i2_clr_temp][ui1_play_content] * COLOR_TUNER_FAC_PIECE_NUM + COLOR_TUNER_FAC_ADDRESS_OFFSET_SAT_G,
                    (VOID *)&i1_val,
                    1,
                    &ui4_read); 
        Foxconn_LOG_ON_FAIL(i4_ret);
        ...
        i4_ret = a_cfg_eep_raw_read(
                    ui4_dynamic_address + ui1_Foxconn_color_eep_offset[i2_clr_temp][ui1_play_content] * COLOR_TUNER_FAC_PIECE_NUM + COLOR_TUNER_FAC_ADDRESS_OFFSET_BRI_G,
                    (VOID *)&i1_val,
                    1,
                    &ui4_read); 
        Foxconn_LOG_ON_FAIL(i4_ret);
    ...
    {
        i4_ret = a_cfg_eep_raw_read(
                    ui4_dynamic_address + ui1_Foxconn_color_eep_offset[i2_clr_temp][ui1_play_content] * COLOR_TUNER_FAC_PIECE_NUM + COLOR_TUNER_FAC_ADDRESS_OFFSET_HUE_B,
                    (VOID *)&i1_val,
                    1,
                    &ui4_read); 
        Foxconn_LOG_ON_FAIL(i4_ret);
        ...
        i4_ret = a_cfg_eep_raw_read(
                    ui4_dynamic_address + ui1_Foxconn_color_eep_offset[i2_clr_temp][ui1_play_content] * COLOR_TUNER_FAC_PIECE_NUM + COLOR_TUNER_FAC_ADDRESS_OFFSET_SAT_B,
                    (VOID *)&i1_val,
                    1,
                    &ui4_read); 
        Foxconn_LOG_ON_FAIL(i4_ret);
        ...
        i4_ret = a_cfg_eep_raw_read(
                    ui4_dynamic_address + ui1_Foxconn_color_eep_offset[i2_clr_temp][ui1_play_content] * COLOR_TUNER_FAC_PIECE_NUM + COLOR_TUNER_FAC_ADDRESS_OFFSET_BRI_B,
                    (VOID *)&i1_val,
                    1,
                    &ui4_read); 
        Foxconn_LOG_ON_FAIL(i4_ret);
    ...
    {
        i4_ret = a_cfg_eep_raw_read(
                    ui4_dynamic_address + ui1_Foxconn_color_eep_offset[i2_clr_temp][ui1_play_content] * COLOR_TUNER_FAC_PIECE_NUM + COLOR_TUNER_FAC_ADDRESS_OFFSET_HUE_C,
                    (VOID *)&i1_val,
                    1,
                    &ui4_read); 
        Foxconn_LOG_ON_FAIL(i4_ret);
        ...
        i4_ret = a_cfg_eep_raw_read(
                    ui4_dynamic_address + ui1_Foxconn_color_eep_offset[i2_clr_temp][ui1_play_content] * COLOR_TUNER_FAC_PIECE_NUM + COLOR_TUNER_FAC_ADDRESS_OFFSET_SAT_C,
                    (VOID *)&i1_val,
                    1,
                    &ui4_read); 
        Foxconn_LOG_ON_FAIL(i4_ret);
        ...
        i4_ret = a_cfg_eep_raw_read(
                    ui4_dynamic_address + ui1_Foxconn_color_eep_offset[i2_clr_temp][ui1_play_content] * COLOR_TUNER_FAC_PIECE_NUM + COLOR_TUNER_FAC_ADDRESS_OFFSET_BRI_C,
                    (VOID *)&i1_val,
                    1,
                    &ui4_read); 
        Foxconn_LOG_ON_FAIL(i4_ret);
        ...
        i4_ret = Foxconn_fac_menu_range_set_val(h_clr_tuner_Offset_v2, 0);
        Foxconn_LOG_ON_FAIL(i4_ret);
        i4_ret = Foxconn_fac_menu_range_set_val(h_clr_tuner_Gain_v2, 0);
        Foxconn_LOG_ON_FAIL(i4_ret);
    }
    else if(i2_idx == COL_MAGENTA)
    {
        ...
        i4_ret = a_cfg_eep_raw_read(
                    ui4_dynamic_address + ui1_Foxconn_color_eep_offset[i2_clr_temp][ui1_play_content] * COLOR_TUNER_FAC_PIECE_NUM + COLOR_TUNER_FAC_ADDRESS_OFFSET_HUE_M,
                    (VOID *)&i1_val,
                    1,
                    &ui4_read); 
        Foxconn_LOG_ON_FAIL(i4_ret);
        ...
        i4_ret = a_cfg_eep_raw_read(
                    ui4_dynamic_address + ui1_Foxconn_color_eep_offset[i2_clr_temp][ui1_play_content] * COLOR_TUNER_FAC_PIECE_NUM + COLOR_TUNER_FAC_ADDRESS_OFFSET_SAT_M,
                    (VOID *)&i1_val,
                    1,
                    &ui4_read);
        Foxconn_LOG_ON_FAIL(i4_ret);
        ...
        i4_ret = a_cfg_eep_raw_read(
                    ui4_dynamic_address + ui1_Foxconn_color_eep_offset[i2_clr_temp][ui1_play_content] * COLOR_TUNER_FAC_PIECE_NUM + COLOR_TUNER_FAC_ADDRESS_OFFSET_BRI_M,
                    (VOID *)&i1_val,
                    1,
                    &ui4_read);
        Foxconn_LOG_ON_FAIL(i4_ret);
    ...
    {
        i4_ret = a_cfg_eep_raw_read(
                    ui4_dynamic_address + ui1_Foxconn_color_eep_offset[i2_clr_temp][ui1_play_content] * COLOR_TUNER_FAC_PIECE_NUM + COLOR_TUNER_FAC_ADDRESS_OFFSET_SAT_Y,
                    (VOID *)&i1_val,
                    1,
                    &ui4_read);
        Foxconn_LOG_ON_FAIL(i4_ret);
        ...
        i4_ret = a_cfg_eep_raw_read(
                    ui4_dynamic_address + ui1_Foxconn_color_eep_offset[i2_clr_temp][ui1_play_content] * COLOR_TUNER_FAC_PIECE_NUM + COLOR_TUNER_FAC_ADDRESS_OFFSET_BRI_Y,
                    (VOID *)&i1_val,
                    1,
                    &ui4_read);
        Foxconn_LOG_ON_FAIL(i4_ret);
...
#endif
/*----------------------------------------------------------------------------
 * Name: _Foxconn_fac_20_point_page_get_values
 *
 * Description:
 *
 * Inputs:
...
static INT32 _Foxconn_fac_20_point_page_get_values(VOID)
{
    ...
    DBG_LOG_PRINT(("###Tommy_test %s dynamic_address: 0x%x\n", __FUNCTION__, ui4_dynamic_address));  //ke_test
    DBG_LOG_PRINT(("###Tommy_test %s play_content: %d\n", __FUNCTION__, ui1_play_content));  //ke_test
    DBG_LOG_PRINT(("###Tommy_test %s last eep address: %d\n", __FUNCTION__, ui4_dynamic_address + (i2_clr_temp *ui1_play_content) * COLOR_TUNER_FAC_PIECE_NUM + COLOR_TUNER_FAC_ADDRESS_OFFSET_20_POINT_B+20));  //ke_test
    
    i4_ret = a_cfg_eep_raw_read(
            ui4_dynamic_address + ui1_Foxconn_color_eep_offset[i2_clr_temp][ui1_play_content] * COLOR_TUNER_FAC_PIECE_NUM + COLOR_TUNER_FAC_ADDRESS_OFFSET_20_POINT_R,
            (VOID *)&i1_R,
            COLOR_TUNER_FAC_20POINT_NUM, //COLOR_TUNER_FAC_11POINT_NUM,
            &ui4_read); 
    Foxconn_LOG_ON_FAIL(i4_ret);
    ...
    i4_ret = a_cfg_eep_raw_read(
            ui4_dynamic_address + ui1_Foxconn_color_eep_offset[i2_clr_temp][ui1_play_content] * COLOR_TUNER_FAC_PIECE_NUM + COLOR_TUNER_FAC_ADDRESS_OFFSET_20_POINT_G,
            (VOID *)&i1_G,
            COLOR_TUNER_FAC_20POINT_NUM, //COLOR_TUNER_FAC_11POINT_NUM,
            &ui4_read); 
    Foxconn_LOG_ON_FAIL(i4_ret);
    ...
    i4_ret = a_cfg_eep_raw_read(
            ui4_dynamic_address + ui1_Foxconn_color_eep_offset[i2_clr_temp][ui1_play_content] * COLOR_TUNER_FAC_PIECE_NUM + COLOR_TUNER_FAC_ADDRESS_OFFSET_20_POINT_B,
            (VOID *)&i1_B,
            COLOR_TUNER_FAC_20POINT_NUM, //COLOR_TUNER_FAC_11POINT_NUM,
            &ui4_read); 
    Foxconn_LOG_ON_FAIL(i4_ret);
    ...
    for (ui1_i = 0; ui1_i < 20; ui1_i++)
    {
        ...
        DBG_LOG_PRINT(("###Tommy_test 20_point_value[0][%d]: %d\n", ui1_i, ai1_20_point_values[0][ui1_i]));  //ke_test
        DBG_LOG_PRINT(("###Tommy_test 20_point_value[1][%d]: %d\n", ui1_i, ai1_20_point_values[1][ui1_i]));  //ke_test
        DBG_LOG_PRINT(("###Tommy_test 20_point_value[2][%d]: %d\n", ui1_i, ai1_20_point_values[2][ui1_i]));  //ke_test
    }
    
    return 0;
}
/*----------------------------------------------------------------------------
 * Name: _Foxconn_fac_20_point_page_set_values
 *
 * Description:
 *
 * Inputs:
...
//	UINT8	ui1_play_content = acfg_check_play_content();
    ...
    #if 0
    for (ui1_i = _Foxconn_fac_20_POINT_GAIN_COL_GAIN; ui1_i < _Foxconn_fac_11_POINT_GAIN_COL_BLUE; ui1_i++)
    {
