...
#include "Foxconn_factory/Foxconn_fac_urc/Foxconn_fac_urc.h"
...
#define Foxconn_FAC_DEFAULT_CH         {BTN_MENU, BTN_DIGIT_1, BTN_DIGIT_9, BTN_DIGIT_9, BTN_DIGIT_7};       //"1997"  //ke_vizio_20110131
#define Foxconn_FAC_DEFAULT_CH_POL     {BTN_MENU, BTN_DIGIT_1, BTN_DIGIT_9, BTN_DIGIT_9, BTN_DIGIT_8};     //"1998"  //ke_vizio_20110131

#if 0
//ke_vizio_20110131
/* FAC Password default, the master password is 1999 */
#define NAV_FAC_KEY_STACK2_NUM   ((SIZE_T) 6)
#define Foxconn_FAC_PASSWORD_DEF     {BTN_MENU, BTN_DIGIT_1, BTN_DIGIT_9, BTN_DIGIT_9, BTN_DIGIT_9, BTN_PREV_PRG};  // "Menu"+""1999" + "recall"
#else
//Frankie_20160506
/* FAC Password default, the master password is 4210 */
#define NAV_FAC_KEY_STACK2_NUM   ((SIZE_T) 5)
#define Foxconn_FAC_PASSWORD_DEF     {BTN_MENU, BTN_DIGIT_4, BTN_DIGIT_2, BTN_DIGIT_1, BTN_DIGIT_0};  // "Menu"+""4210"
#endif


#if 1	//sam 120207 add MENU+1+9+1+9 to dump EEPROM data
#define NAV_FAC_KEY_STACK3_NUM   ((SIZE_T) 5)
#define Foxconn_FAC_PASSWORD_DEF_EEPROM     {BTN_MENU, BTN_DIGIT_1, BTN_DIGIT_9, BTN_DIGIT_1, BTN_DIGIT_9};  // "Menu"+""1919" 
#endif
...
typedef enum
{
	...
	NAV_FAC_MENU_RJ45_MAC,	//mind 20160809
	NAV_FAC_MENU_WIFI_MAC,
#ifdef APP_BLUETOOTH_SUPPORT
#ifdef FAC_BLUETOOTH_SUPPORT // Tommy 20191009 Ben 20180126
	NAV_FAC_MENU_BT_MAC,
#endif
#endif
	NAV_FAC_MENU_SN,		//mind 20160812
	NAV_FAC_MENU_ULPK_ID,
	...
	NAV_FAC_MENU_BACKLIGHT_CHECK,
#endif
#ifdef FAC_WB_DATA  // Tommy 20191009 Ben 20180411
    NAV_FAC_MENU_FAC_WB_DATA,
#endif
#ifdef PQ_BYPASS	// Tommy 20191009
    NAV_FAC_MENU_PQ_BYPASS,
#endif
#ifdef FAC_PANEL_NITS // Tommy 20191009 Ben 20180629
    NAV_FAC_MENU_PANEL_NITS,
#endif

#ifdef FAC_AUD_SRS_BYPASS
	NAV_FAC_MENU_AUD_SRS_BYPASS,	//Tommy 20200722
#endif
#ifdef Foxconn_HDMI_CERT			//Tommy 20200722
    NAV_FAC_MENU_EARC_MUTE,
    NAV_FAC_MENU_EARC_WORD_LENGTH,
    NAV_FAC_MENU_EARC_LAYOUT,
#endif
    NAV_FAC_MENU_BACK_LIT_TIME,		//Tommy 20200722
    NAV_FAC_MENU_CPU_TEMP,			//Tommy 20200722
    
    
#ifdef FAC_DUMP_CH_INFO
	NAV_FAC_MENU_DUMP_CH_INFO,
#endif
    NAV_FAC_MENU_HDCP_DEF_WRITE,	//Tommy 20200722	
    NAV_COPY_QDA_LOG,				//Tommy 20200722
    NAV_COPY_EMBEDDED_DEMO,			//Tommy 20200722
    /* Don't remove this */
    NAV_FAC_MENU_MAX
...
extern INT32 a_Foxconn_fac_dialog_register(VOID);
