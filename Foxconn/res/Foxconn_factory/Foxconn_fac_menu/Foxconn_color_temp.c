...
#else
const CHAR *ps_clr_temp_str[4] = {"Custom", "Cool", "Computer", "Normal"};
#define Foxconn_Fac_clr_temp_Cool     1
#define Foxconn_Fac_clr_temp_Computer 2
#define Foxconn_Fac_clr_temp_Normal   3
#endif
 ...
 *
 ----------------------------------------------------------------------------*/
INT32 Foxconn_fac_color_temp_view_init(HANDLE_T h_parent, INT32 i4_frame_x_offset, INT32 i4_frame_y_offset)
{
    INT32 i4_ret = 0;
        ...
        case WGL_MSG_KEY_DOWN:
        {
            ...
            switch (ui4_keycode)
            {
                ...
                case BTN_CURSOR_RIGHT:
                {
                    ...
                    Foxconn_fac_menu_range_set_val(h_focus, (INT32)i2_val);
...
/*----------------------------------------------------------------------------
 * Name: Foxconn_fac_color_temp_menu_show
 *
 * Description:
 *
 * Inputs:
 ...
 *
 ----------------------------------------------------------------------------*/
INT32 Foxconn_fac_color_temp_menu_show(BOOL b_repaint)
{
    UTF16_T w2s_string[10]={0};
    INT16 i2_val = 0;
 ...
 *
 ----------------------------------------------------------------------------*/
INT32 Foxconn_fac_color_temp_menu_hide(BOOL b_repaint)
{
