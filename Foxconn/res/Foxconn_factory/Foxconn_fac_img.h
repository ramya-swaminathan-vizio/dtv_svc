...
extern INT32 Foxconn_fac_img_create_T_img_tpl(
                    WGL_HIMG_TPL_T*             ph_img_tpl
                    );

extern INT32 Foxconn_fac_img_create_menu_bk_img_tpl(
                    WGL_HIMG_TPL_T*             ph_img_tpl
                    );

extern INT32 Foxconn_fac_img_create_menu_hilight_img_tpl(
                    WGL_HIMG_TPL_T*             ph_img_tpl
                    );

//ke_vizio_20160912 add
extern INT32 Foxconn_fac_img_create_urc_bk_img_tpl(
                    WGL_HIMG_TPL_T*             ph_img_tpl
                    );                    

extern INT32 Foxconn_fac_img_color_tuner_tpl(VOID);
