...
#include "Foxconn_factory/Foxconn_d_factory.h"  //ke_vizio_20160908 add

#include "Foxconn_factory/Foxconn_fac_menu/Foxconn_fac.h"	// Ben 20170412
...
extern INT32 acfg_custom_Foxconn_fac_post_init(VOID)
{
    ...
    //ke_vizio_20110420
    /*i4_ret = _acfg_custom_Foxconn_check_eep();
...
#if 0 //20180518 call menu_clear_memory_ex to do	//TPV disable Tommy 20191216 1 > 0
...
#ifdef APP_FAC_TUNER_SELECTION //sam 091229 //TPV disable
...
extern INT32 a_cfg_fac_eep_init(VOID)  //ke_vizio_20160908 add
{
	...
	//	UINT8 aui1_faccmd_ret_val_EEP_SN[CMD_LEN_Maximum] = {0};	//TPV disable
...
#if 0	//TPV disable
	//ke_vizio_20121218
	UINT32 ui4_read_EEP_SN;	//TPV disable
	a_cfg_eep_raw_read(EEP_SERIAL_NUMBER, aui1_faccmd_ret_val_EEP_SN, 16, &ui4_read_EEP_SN);//TPV disable
#endif
...
#if 0	//def APP_BLUETOOTH_SUPPORT
	UINT32 ui4_read_BT;
	...
	i4_ret =  a_cfg_custom_set_odm_index(4);
	ACFG_LOG_ON_FAIL(i4_ret);
