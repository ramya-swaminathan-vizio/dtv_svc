...
#define     ACFG_FAC_CLR_GAIN_ELEM_NUM    4*ACFG_CLR_TEMP_NUM		//Jiulan 20191211 2020 new request
#define     ACFG_FAC_CLR_OFFSET_ELEM_NUM  4*ACFG_CLR_TEMP_NUM
...
extern INT32 a_cfg_cust_get_cpu_tempature(INT16 * i2_temp);
/*------------------------------------------------------------------------------
                    external functions declarations
------------------------------------------------------------------------------*/

// yuan vvvvv
extern INT32 a_cfg_custom_get_fac_reserv_FFA (UINT8*  pui1_val, SIZE_T z_size);
extern INT32 a_cfg_custom_set_fac_reserv_FFA (UINT8*  pui2_val, SIZE_T z_size);
// yuan ^^^^^
