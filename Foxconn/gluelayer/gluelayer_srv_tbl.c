...
//#include "res/app_util/config/acfg_cust_Foxconn.h"
...
// FXC Jim 2018 0423 remove #include "nav_flicker.h"
...
// FXC Jim 2018 0423 remove extern INT32 a_nav_flicker_register (FLICKER_HDLR_T* pt_flicker_hdlr);
#endif
...
T_CMD_DATA_MAP_A at_a_cmd_map[GLUELAYER_CMD_A_END+1] = 
{
    ...
    {GLUELAYER_CMD_A_FACTORY_SET_REGISTRATION,  a_Foxconn_factory_set_registration},
    {GLUELAYER_CMD_A_FACT_PARSER_INIT,  a_Foxconn_fact_parser_init},
    ...
    {GLUELAYER_CMD_A_CFG_CUSTOM_GET_FAC_RESERV,  a_cfg_custom_get_fac_reserv_FFA},
    {GLUELAYER_CMD_A_CFG_CUSTOM_SET_FAC_RESERV,  a_cfg_custom_set_fac_reserv_FFA},
    // FXC_Jim 20180328 ^^^^^
...
#endif
#endif 
    {GLUELAYER_CMD_A_FAC_DYNAMIC_RGB_RANGE, a_cfg_custom_plf_opt_get_color_tuner_dynamic_address},//FXN_PQ_180724
    {0,0}
};
...
T_CMD_DATA_MAP_S at_s_cmd_map[GLUELAYER_CMD_S_END+1] = 
{
    ...
    {GLUELAYER_CMD_S_HDR_HLG_PQ_DFT_TBL, (VOID*)&at_pq_hdr_hlg_def_tbl[0], sizeof(at_pq_hdr_hlg_def_tbl[0])},
    {GLUELAYER_CMD_S_DOBLY_VERSION_PQ_DFT_TBL, (VOID*)&at_pq_dobly_version_def_tbl[0], sizeof(at_pq_dobly_version_def_tbl[0])},
    {GLUELAYER_CMD_S_HLG_PQ_DFT_TBL, (VOID*)&at_pq_hlg_def_tbl[0], sizeof(at_pq_hlg_def_tbl[0])},
    {0,0}
};
