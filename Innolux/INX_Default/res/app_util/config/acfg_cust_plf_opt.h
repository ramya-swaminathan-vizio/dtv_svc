...
#define    EEP_MODEL_NAME              (EEP_OFFSET_PLF_OPT_11+1)   //0x59a,    /* 16 bytes */     // Denny 2009/11/02 //0x7C0
#define    EEP_MODEL_NAME_END          (EEP_MODEL_NAME+0x10-1)  //0x5a9,
    // Top Denny 2009/01/17 modify - end

    /* Serial Number */
#define    EEP_SERIAL_NUMBER           (EEP_MODEL_NAME_END + 1) //0x5aa,      /* 16 bytes */    // Denny 2009/11/02 //0x7D0  //Emerson 2009-01-13 : store 16 bytes serial number in EEPROM
...
#define    EEP_WIFI_STATUS             (EEP_EEPROM_VER_SUB + 1)  //0x5bc  /* 1 byte */  //ke_vizio_20170523
#define    EEP_WIFI_SSID_ON			   (EEP_WIFI_STATUS + 1)	
#endif

#else // no APP_LARGE_EEPROM_SUPPORT
...
#define    EEP_INX_AS382X_SHORT_PROTECTION_SWITCH_FLAG 0x1A021
