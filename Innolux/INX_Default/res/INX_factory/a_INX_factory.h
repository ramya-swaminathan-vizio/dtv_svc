...
#define CMD_INX_GET_DOWNLOAD_SPEED          0x2525
...
{
	INX_FACTORY_ACK = 0,		
	INX_FACTORY_NOT_SUPPORT,				
	INX_FACTORY_HEADER_ERROR,				
	INX_FACTORY_LEN_ERROR,				
	INX_FACTORY_LEN_MISMATCH_ERROR,				
	INX_FACTORY_CHECKSUM_ERROR,				
	INX_FACTORY_ERROR_MAX=255				
} INX_FACTORY_ACK_TYPE;
typedef enum
{
...
extern VOID INX_ERROR_ACK(INX_FACTORY_ACK_TYPE error); //zlhuang
