...
#include "INX_factory/INX_fac_urc/INX_fac_urc.h"
...
typedef enum
{
	   NAV_FAC_MENU_BRAND = 0,
		...
		NAV_FAC_MENU_INX_QRE,
		NAV_FAC_MENU_SN,
		NAV_FAC_MENU_BUILD_TIME, //truedano 20190128
		NAV_FAC_MENU_MODEL_INDEX,
		NAV_FAC_MENU_PANEL_NAME,
		NAV_FAC_MENU_HSY_VER,
		NAV_FAC_MENU_MAIN_VER,
		NAV_FAC_MENU_TMO_VER,
		NAV_FAC_MENU_PANEL_VER,
		NAV_FAC_MENU_DOLBY_VER,
		NAV_FAC_MENU_AQ_VER,  //ke_vizio_20130606 add
		NAV_FAC_MENU_POWER_VER, //truedano 20181113
		NAV_FAC_MENU_TCON_VER,
		NAV_FAC_MENU_DEMO_FILE, //truedano 20181008
		NAV_FAC_MENU_GET_LED_INFO,
		NAV_FAC_MENU_RESET,
		NAV_FAC_MNEU_DEBUG,
		NAV_FAC_MENU_EEP_INIT,
		...
		NAV_FAC_MENU_SHORT_PROTECTION,   //yshu add the switch of short potection.
		NAV_FAC_MENU_PQ_BYPASS,
		NAV_FAC_MENU_AQ_BYPASS,
		NAV_FAC_MENU_TFTPS,

		NAV_FAC_MENU_ZZZ_TEST,
		NAV_FAC_MENU_PANEL_NITS,
		NAV_FAC_MENU_ZZZ_TEST3,

		NAV_FAC_MENU_GAMMA_STATUS,
		//HDMI Cert 
		NAV_FAC_MENU_EARC_MUTE,
		NAV_FAC_MENU_EARC_WORD_LEN,
		NAV_FAC_MENU_EARC_LAYOUT,
		
	    NAV_FAC_MENU_MAX,      /* Don't remove this */
		NAV_FAC_MENU_DATE,
...
#ifdef INX_FAC_WINDOW_PATTERN  //ke_vizio_20150522
...
typedef struct _NAV_CUSTOM_FAC_T
{
    ...
    UINT32     at_key_stack2[NAV_FAC_KEY_STACK_NUM+1];  /* Key Stack2 */
...
-----------------------------------------------------------------------------*/
extern INT32 nav_fac_get_led_driver_info(UINT8 devid); //yshu add led driver info .
...
extern INT32 nav_inx_fac_set_setup_value(
                    UINT16              ui2_idx,
                    INT32              ui4_val,
                    UINT32				pv_param1
                    );
...
extern INT32 a_INX_fac_dialog_register(VOID);
...
extern INT32 INX_nav_fac_urc_dialog_show(UINT16 str_msg);
#if defined(FAC_MENU_MODEL_NAME_SELECT) && defined(APP_READ_MODEL_NAME_FROM_EEPROM) //Denny 2009/12/11 add
...
extern INT32 _nav_fac_get_pq_raw(UINT32 address,CHAR *bin_file,UINT32 size,void *buf);
extern void _nav_fac_get_dolby_ver(char *version, UINT32 version_size);
extern void _nav_fac_get_tcon_ver(char *version, UINT32 version_size);
