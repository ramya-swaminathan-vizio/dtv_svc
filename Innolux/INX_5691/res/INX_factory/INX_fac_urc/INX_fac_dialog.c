...
#if 1 //added to check panel border, 20211015
static NAV_FAC_DIALOG_T t_g_nav_fac_panel_border = {0};
static NAV_FAC_DIALOG_VIEW_T   t_g_nav_fac_panel_border_view = {0};
static NAV_FAC_DIALOG_SHOW_INIT_T     t_g_nav_fac_panel_border_init = {0};
#endif
                                ...
                                HANDLE_T*                nav_fac_dialog)              /* Out */
{
    ...
    {
        /* Content Frame */
        i4_ret =  _nav_fac_dialog_create_frm(pt_nav_fac_dialog_show,
        ...
        /* txtinfo */
        i4_ret =  _nav_fac_dialog_create_txtinfo(pt_nav_fac_dialog_show,
                                                     pt_nav_fac_dialog_init->pt_rect,
...
#if 1 //added to check panel border, 20211015
static INT32  _nav_fac_panel_border_create_frm(NAV_FAC_DIALOG_VIEW_T*    pt_nav_fac_dialog_show,
                                          wgl_widget_proc_fct pf_wdgt_proc,
                                          HANDLE_T            h_parent,
                                          GL_RECT_T*          pt_rect,
                                          GL_POINT_T*         pt_begin_offset)
...
static INT32  _nav_fac_panel_border_create(NAV_FAC_DIALOG_SHOW_INIT_T*    pt_nav_fac_dialog_init,   /* In  */
                                HANDLE_T*                nav_fac_dialog)              /* Out */
{
    INT32 i4_ret;
    NAV_FAC_DIALOG_VIEW_T* pt_nav_fac_panel_border_show= &t_g_nav_fac_panel_border_view;

    DBG_LOG_PRINT(("%s(), %d\n", __func__, __LINE__));

    pt_nav_fac_panel_border_show = (NAV_FAC_DIALOG_VIEW_T *) c_mem_alloc(sizeof(NAV_FAC_DIALOG_VIEW_T));

    if(pt_nav_fac_panel_border_show == NULL)
    {
        return APP_UIR_OUT_OF_MEMORY;
    }
    ...
    {
        /* Content Frame */
        i4_ret =  _nav_fac_panel_border_create_frm(pt_nav_fac_panel_border_show,
                                                 pt_nav_fac_dialog_init->pf_wdgt_proc,       /* App assigns the pf_wdgt_proc */
                                                 pt_nav_fac_dialog_init->h_parent,
                                                 pt_nav_fac_dialog_init->pt_rect,
                                                 pt_nav_fac_dialog_init->pt_begin_offset);
        ...
        // set position and range of text area
        GL_RECT_T         t_rect;
        SET_RECT_BY_SIZE(&t_rect,
                         0,
                         UI_DISPLAY_HEIGHT/3,
        ...
        i4_ret =  _nav_fac_dialog_create_txtinfo(pt_nav_fac_panel_border_show,
                                                     &t_rect,
                                                     /*pt_nav_fac_dialog_init->pt_rect,*/
                                                     pt_nav_fac_dialog_init->ui2_txt_align_type);
        ...
        /*set all non-visible */
        c_wgl_set_visibility(pt_nav_fac_panel_border_show->h_frm_simple_dialog, WGL_SW_HIDE_RECURSIVE);  //ke_vizio_20141118 modify

        /* Return the h_simple_dialog handle */
        *nav_fac_dialog = pt_nav_fac_panel_border_show->h_frm_simple_dialog;

        /* Done */
        i4_ret = _nav_fac_dialog_set_attach_data(pt_nav_fac_panel_border_show->h_frm_simple_dialog,
                                          pt_nav_fac_panel_border_show);
    ...
    if(i4_ret != APP_UIR_OK)
    {
        ...
        if(pt_nav_fac_panel_border_show->h_txt_txtinfo != NULL_HANDLE)
        {
            c_wgl_destroy_widget(pt_nav_fac_panel_border_show->h_txt_txtinfo);
        }

        /* Release childs*/
        if(pt_nav_fac_panel_border_show->h_txt_txtinfo_2 != NULL_HANDLE)
        {
            c_wgl_destroy_widget(pt_nav_fac_panel_border_show->h_txt_txtinfo_2);
        }

        /* Release parent */
        if(pt_nav_fac_panel_border_show->h_frm_simple_dialog != NULL_HANDLE)
        {
            c_wgl_destroy_widget(pt_nav_fac_panel_border_show->h_frm_simple_dialog);
        }

        /* Release template images */

        if(pt_nav_fac_panel_border_show->h_ui_simple_dialog_bk0 != NULL_HANDLE)
        {
            c_wgl_destroy_widget(pt_nav_fac_panel_border_show->h_ui_simple_dialog_bk0);
        }
        /* Release the structure */
        c_mem_free(pt_nav_fac_panel_border_show);
...
//border_width: it should be 1~3 pixels according to INX_RS232_20211117_81408B80.xlsx
INT32 _nav_fac_panel_border_prompt_msg_dialog(
    NAV_FAC_DIALOG_ID_T     e_dialog_id,
    UTF16_T*            pw2s_msg,
    wgl_widget_proc_fct pf_wdgt_proc,
    INT8 border_width)
{
    ...
    NAV_FAC_DIALOG_T*  pt_this = &t_g_nav_fac_panel_border;
	DBG_LOG_PRINT(("%s, %d, h_dialog = %d\n",__FUNCTION__,__LINE__,pt_this->h_dialog));
    ...
    // set various background img according to 'border_width'
    NAV_FAC_DIALOG_VIEW_T *pt_nav_fac_dialog_show;
    i4_ret = _nav_fac_dialog_get_attach_data(pt_this->h_dialog,
                                               &pt_nav_fac_dialog_show);
    if(i4_ret != APP_UIR_OK)
    {
        DBG_LOG_PRINT(("%s(), %d\n", __func__, __LINE__));
    ...
    i4_ret = INX_fac_img_create_panel_border_img_tpl(&pt_nav_fac_dialog_show->h_ui_simple_dialog_bk0, border_width);
    if(i4_ret != APP_UIR_OK)
    {
        DBG_LOG_PRINT(("%s(), %d\n", __func__, __LINE__));
        return NAVR_FAIL;
    ...
    /* restart the timer */
    t_g_nav_fac_panel_border.ui4_timer_delay = BKLIGHT_TIMER_DELAY_1MIN;
    _nav_fac_dialog_hide_timer_start(t_g_nav_fac_panel_border.ui4_timer_delay);
    DBG_LOG_PRINT(("%s(), %d\n", __func__, __LINE__));

    return 0;
}

extern INT32 INX_nav_fac_dialog_show_panel_border_flag(UINT8 show_flag, INT8 border_width)
{
    INT32 i4_ret = NAVR_OK;

    DBG_LOG_PRINT(("%s, %d, show_flag=%d, border_width=%d\n", __func__, __LINE__, show_flag, border_width));
    if (show_flag == 1)
    {
        // show
        UTF16_T pw2s_string[128] = {0};
        CHAR prompt_string[]="Check panel border";
        c_uc_ps_to_w2s(prompt_string, pw2s_string, strlen(prompt_string));
        i4_ret = _nav_fac_panel_border_prompt_msg_dialog(NAV_FAC_DIALOG_ID_TEST_MODE_ON, pw2s_string, NULL, border_width);
        DBG_LOG_PRINT(("%s, %d, i4_ret=%d\n", __func__, __LINE__, i4_ret));
    }
    else
    {
                    ...
                    )
{
    ...
    i4_ret = c_timer_create(&t_g_nav_fac_dialog.h_hide_timer);
	if(i4_ret != APP_UIR_OK)
    {
        return NAVR_FAIL;
    }
    ...
    #ifdef APP_DFT_LSR_TEST //ke_vizio_20131220 add
    i4_ret = c_timer_create(&t_g_nav_fac_dialog.h_LSR_timer);
	if(i4_ret != APP_UIR_OK)
    {
        return NAVR_FAIL;
    }
...
#if 1 //added to check panel border, 20211015
    DBG_LOG_PRINT(("%s(), %d\n", __func__, __LINE__));
    NAV_FAC_DIALOG_SHOW_INIT_T *t_nav_fac_panel_border_init = &t_g_nav_fac_panel_border_init;

    c_memset(&t_g_nav_fac_panel_border, 0, sizeof(NAV_FAC_DIALOG_T));
    t_g_nav_fac_panel_border.h_canvas = pt_ctx->t_gui_res.h_canvas;
    t_g_nav_fac_panel_border.ui4_timer_delay = NAV_FAC_DIALOG_DEFAULT_TIMER_DELAY;
    i4_ret = c_timer_create(&t_g_nav_fac_dialog.h_hide_timer);
    if(i4_ret != APP_UIR_OK)
    {
        DBG_LOG_PRINT(("%s(), %d\n", __func__, __LINE__));
    ...
    c_memset(t_nav_fac_panel_border_init, 0, sizeof(NAV_FAC_DIALOG_SHOW_INIT_T));
    t_nav_fac_panel_border_init->h_parent                       = t_g_nav_fac_panel_border.h_canvas;
    t_nav_fac_panel_border_init->pf_wdgt_proc                   = NULL;
    t_nav_fac_panel_border_init->ui2_txt_align_type             = WGL_AS_CENTER_CENTER;
    t_nav_fac_panel_border_init->pt_rect                        = NULL;

    i4_ret = _nav_fac_panel_border_create(t_nav_fac_panel_border_init,
                              &t_g_nav_fac_panel_border.h_dialog);
    if(i4_ret != APP_UIR_OK)
    {
        DBG_LOG_PRINT(("%s(), %d\n", __func__, __LINE__));
        return NAVR_FAIL;
...
#if 1 //added to check panel border, 20211015
    NAV_FAC_DIALOG_T*  pt2 = &t_g_nav_fac_panel_border;
    _nav_fac_dialog_destory(pt2->h_dialog);

    if (c_handle_valid(pt2->h_hide_timer)) {
        c_timer_delete(pt2->h_hide_timer);
    }

    pt2->h_canvas = NULL_HANDLE;
    pt2->h_dialog = NULL_HANDLE;
    pt2->h_hide_timer = NULL_HANDLE;
#endif
...
extern VOID nav_fac_urc_key_pre_handler(UINT32 ui4_keystatus, UINT32* pt_ui4_keycode)
{
    ...
    {
        if (CVTE_MTK_GetBurningModeFlag())
        {
            if (ui4_keycode == BTN_PANEL_POWER_INPUT || ui4_keycode == BTN_FAC_KEYPAD_POWER || ui4_keycode == BTN_INPUT_SRC)
            {
                cvt_fac_burnning_mode_run(FALSE);
        ...
        if(ui4_keystatus == WGL_MSG_KEY_DOWN)
        {
            ...
            switch(ui4_keycode)
            {
                ...
                case BTN_FAC_KEYPAD_MENU: //BTN_CUSTOM_11:     /* Menu*/
                    ...
                    break;
				case BTN_PANEL_POWER_INPUT: //Group Keypad --> Power
					a_cfg_cust_fac_set_keypad_status_read(ACFG_FAC_KEYPAD_POWER);	
					break;
                default:
                    break;
...
INT32 inx_connect_wifi(CHAR* a_ssid,CHAR* a_password)
{
	...
	if(pt_associate == NULL)
	{
		DBG_LOG_PRINT(("%s() pt_associate is NULL\n", __func__));
		return INX_FACTORY_COND_FAIL;
	}
    ...
    if (i4_ret != NWR_OK)
    {
        DBG_LOG_PRINT(("%s(): a_nw_wlan_associate() Failed(%d)\n", __func__, i4_ret));
        return INX_FACTORY_COND_FAIL;
    }
