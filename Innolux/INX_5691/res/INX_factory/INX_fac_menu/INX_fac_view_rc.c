...
/*-----------------------------------------------------------------------------
 ...
 ----------------------------------------------------------------------------*/
GL_COLOR_T inx_g_fac_menu_color_white    = { 255, { 255 }, { 255 }, { 255 }};
GL_COLOR_T inx_g_fac_menu_color_gray     = { 255, {  88 }, {  88 }, {  88 }};
GL_COLOR_T inx_g_fa_cmenu_color_orange   = { 255, { 255 }, {  69 }, {   0 }};

WGL_FONT_INFO_T  inx_title_font_info    = {FE_FNT_SIZE_SMALL,  FE_FNT_STYLE_REGULAR,
                                                FE_CMAP_ENC_UNICODE, NAV_FONT_NORMAL};
#ifndef APP_C4TV_SUPPORT
WGL_FONT_INFO_T  inx_elem_font_info     = {FE_FNT_SIZE_MEDIUM, FE_FNT_STYLE_REGULAR,
                                                FE_CMAP_ENC_UNICODE, SN_FONT_DEFAULT_SMALL};
#else
WGL_FONT_INFO_T  inx_elem_font_info     = {FE_FNT_SIZE_SMALL, FE_FNT_STYLE_REGULAR,			//FE_FNT_SIZE_MEDIUM		//mind 20160810
 ...
 *  -1- Failed
 ----------------------------------------------------------------------------*/
INT32 inx_nav_fac_view_init_rc(
                    NAV_FAC_VIEW_RC_T*            pt_rc
                    )
{
    INT32 i4_ret;

    i4_ret = INX_fac_img_create_menu_bk_img_tpl(&pt_rc->h_fac_menu_img_bk);
    if (i4_ret != NAVR_OK) {
        return NAVR_FAIL;
    }

    i4_ret = INX_fac_img_create_menu_hilight_img_tpl(&pt_rc->h_fac_hlt_img_bk);
    if(NAVR_OK != i4_ret){
        return NAVR_FAIL;
    }
 ...
 *  -1- Failed
 ----------------------------------------------------------------------------*/
INT32 inx_nav_fac_view_deinit_rc(
                    NAV_FAC_VIEW_RC_T*            pt_rc
                    )
{
