 ...
 *
 *---------------------------------------------------------------------------*/
#ifndef _CVT_FAC_VIEW_RC_H_
#define _CVT_FAC_VIEW_RC_H_
 ...
 *---------------------------------------------------------------------------*/
#define ON_PAGE_ELEM_NUM_OF_FAC_SETUP_MENU      32
...
#else
#define ELEM_HEIGHT_OF_FAC_MENU                 27	//19 //NAV_HEIGHT(27) //ELEM_HEIGHT_OF_FAV_CH_LIST
#define ELEM_DTANCE_OF_FAC_MENU                 5	// 4	//6	// 2 //NAV_HEIGHT(2) //ELEM_DTANCE_OF_FAV_CH_LIST
#endif
...
#define NAV_FAC_MENU_TEXT0_LEN                  35
...
#define NAV_FAC_MENU_TEXT1_LEN                  35
...
#ifndef APP_C4TV_SUPPORT
#define NAV_FAC_MENU_TEXT1_WIDTH                150
#else
#define NAV_FAC_MENU_TEXT1_WIDTH                300
#endif
