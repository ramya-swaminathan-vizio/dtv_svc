...
//yshu create 4 tables 20200817
#define PQ_CONFIG_PATH  "/config/PQ_Tables/" 
#define HDR_HLG_DEF_TBL "pq_hdr_hlg_def_tbl.ini"
#define HLG_DEF_TBL     "pq_hlg_def_tbl.ini"
#define PQ_DEF_TBL      "pq_def_tbl.ini"
#define PRO_PQ_DEF_TBL  "pro_pq_def_tbl.ini"
#define DV_DEF_TBL      "pq_dobly_version_def_tbl.ini"
...
#define PIC_MODE_LEN 256
#define OPTION_LEN 256
	
typedef struct PIC_MAP_OBJ_T
{
	ACFG_CUST_PIC_MODE_T ui1_pic_mode;
	CHAR c_pic[PIC_MODE_LEN+1];
}PIC_MAP_OBJ_T;

typedef struct OPTION_OBJ_T
{
	UINT32 ui1_option_idx;
	CHAR c_option[OPTION_LEN+1];
}OPTION_OBJ_T;
...
-----------------------------------------------------------------------------*/
#define PQ_DFT_TBL_MAX_NUM          (126) //6*21, add 'IDX_CUSTOM_VARIABLE_REFRESH_RATE' since 20210712
//#define PQ_DFT_TBL_MAX_NUM          (120) //6*20
//#define PQ_DFT_TBL_MAX_NUM          (108) //6*18
...
//yshu add hdr dobly tables 20180614
#ifdef APP_CFG_CUSTOM_PQ_DEF_TBL
