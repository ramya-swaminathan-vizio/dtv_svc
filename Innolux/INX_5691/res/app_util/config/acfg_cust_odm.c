...
{
{
    ...
    {ACFG_CUST_PIC_MODE_VIVID,  IDX_CUSTOM_VARIABLE_REFRESH_RATE,           P_OFF}, /*VRR*/
    ...
    {ACFG_CUST_PIC_MODE_BRIGHT,  IDX_CUSTOM_VARIABLE_REFRESH_RATE,           P_OFF}, /*VRR*/
    ...
    {ACFG_CUST_PIC_MODE_BRIGHT_ROOM,  IDX_CUSTOM_VARIABLE_REFRESH_RATE,           P_OFF}, /*VRR*/
    ...
    {ACFG_CUST_PIC_MODE_DARK_ROOM,  IDX_CUSTOM_VARIABLE_REFRESH_RATE,           P_OFF}, /*VRR*/
    ...
    {ACFG_CUST_PIC_MODE_GAME,  IDX_CUSTOM_VARIABLE_REFRESH_RATE,           P_ON}, /*VRR*/
    ...
    {ACFG_CUST_PIC_MODE_SPORT,  IDX_CUSTOM_VARIABLE_REFRESH_RATE,           P_OFF}, /*VRR*/
