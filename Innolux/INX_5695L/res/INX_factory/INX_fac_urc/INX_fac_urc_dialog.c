...
#if 0 //remarked because it's Logically dead code (according to VIZIO_Coverity_0223_INX.xlsx)	
    if(ui2_align == 0)
    {
       ui2_align = WGL_AS_LEFT_TOP;
    }
                                ...
                                HANDLE_T*                nav_fac_dialog)              /* Out */
{
    ...
    do
    {
        ...
        *nav_fac_dialog = pt_nav_fac_dialog_show->h_frm_simple_dialog;
        ...
        /* Done */
        i4_result = _nav_fac_urc_dialog_set_attach_data(pt_nav_fac_dialog_show->h_frm_simple_dialog,
                                          pt_nav_fac_dialog_show);
        i4_ret = APP_UIR_OK;
