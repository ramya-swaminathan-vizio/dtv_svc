 ...
 *---------------------------------------------------------------------------*/
#define MAX_ELEM_OF_FAC_MENU  NAV_FAC_MENU_MAX // NAV_FAC_MENU_MAX
...
/* fac menu color */
extern GL_COLOR_T inx_g_fac_menu_color_white;
extern GL_COLOR_T inx_g_fac_menu_color_gray;
extern GL_COLOR_T inx_g_fa_cmenu_color_orange;

#define FAC_MENU_COL_N_FG_COLOR(__color_type)   inx_g_fac_menu_color_white
#define FAC_MENU_COL_D_FG_COLOR(__color_type)   inx_g_fac_menu_color_gray
#define FAC_MENU_COL_H_FG_COLOR(__color_type)   inx_g_fac_menu_color_white
#define FAC_MENU_COL_H_FG_COLOR_1(__color_type) inx_g_fac_menu_color_gray
#define FAC_MENU_COL_HU_FG_COLOR(__color_type)  inx_g_fac_menu_color_white
#define FAC_MENU_COL_P_FG_COLOR(__color_type)   inx_g_fac_menu_color_white
#define FAC_MENU_COL_S_FG_COLOR(__color_type)   inx_g_fac_menu_color_white
#define FAC_MENU_COL_SD_FG_COLOR(__color_type)  inx_g_fac_menu_color_white
#define FAC_MENU_TITLE_FG_COLOR(__color_type)   inx_g_fa_cmenu_color_orange
#define FAC_MENU_TITLE_BK_COLOR(__color_type)   inx_g_fa_cmenu_color_orange

extern WGL_FONT_INFO_T  inx_title_font_info;
extern WGL_FONT_INFO_T  inx_elem_font_info;
...
extern INT32 inx_nav_fac_view_init_rc(
                    NAV_FAC_VIEW_RC_T*            pt_rc
                    );
extern INT32 inx_nav_fac_view_deinit_rc(
                    NAV_FAC_VIEW_RC_T*            pt_rc
                    );
