...
/*isp info page*/
extern UTF16_T  inx_fac_isp_info_page_title[INX_FAC_MENU_TITLE_MAX][INX_FAC_MENU_TITLE_LENS];
extern inx_page_entry inx_fac_isp_info_page_entry[INX_FAC_MENU_TITLE_MAX][INX_FAC_MENU_ITEM_CNT];
...
inx_fac_menu_page t_g_nav_fac_items[INX_FAC_PAGE_MAX+1] = {
    ...
    {
        NULL_HANDLE,
        inx_fac_isp_info_page_title,
        inx_fac_isp_info_page_entry,
