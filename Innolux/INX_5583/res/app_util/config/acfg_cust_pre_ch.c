...
static _ACFG_PRE_CH_ANA_INFO at_ana_table_default_air[] = 
{
    ...
    {7340160  , 55250     , "", TV_SYS_MASK_NONE, SB_VNET_ALL|SB_VNET_ACTIVE|SB_VNET_EPG|SB_VNET_VISIBLE}   //yshu 20180604
};
...
static _ACFG_PRE_CH_DIG_INFO at_dig_table_default_air[] = 
{
    ...
    {3670272 , 213000    , 13  ,        "ATSC-1",BW_UNKNOWN, MOD_VSB_8, 0x0   , 0xd  , 0x1 , 0x1   , SB_VNET_ALL|SB_VNET_ACTIVE|SB_VNET_EPG|SB_VNET_VISIBLE},
    {3670272 , 213000    , 13  ,        "RF13-3",BW_UNKNOWN, MOD_VSB_8, 0x0   , 0xd  , 0x1 , 0x1   , SB_VNET_ALL|SB_VNET_ACTIVE|SB_VNET_EPG|SB_VNET_VISIBLE}
};
...
static _ACFG_PRE_CH_ANA_INFO at_ana_table_default_cable[] = 
{
    /* channel number / frequency / channel name / tv system / network mask */
    /* this item is not a correct one ,just for passing compair warning ,please replace it with actual data */   
    {7340160 , 247250    , "", TV_SYS_MASK_NONE, SB_VNET_ALL|SB_VNET_ACTIVE|SB_VNET_BACKUP1|SB_VNET_FAKE} //joe.zy add 20200115
} ;
...
static _ACFG_PRE_CH_DIG_INFO at_dig_table_default_cable[] = 
{
    /* ch num / requency / tsl rec id / ch name / bandwidth / e_mod / nw id / on id / ts id / prog id / network mask */
    /* this item is not a correct one ,just for passing compair warning ,please replace it with actual data */
    {83886400, 79754    , 5   ,  "RF5-1" ,BW_UNKNOWN, MOD_QAM_256 , 0x0   , 0x5  , 0x1 , 0x1   , SB_VNET_ALL|SB_VNET_ACTIVE|SB_VNET_EPG|SB_VNET_VISIBLE},//joe.zy add 20200115
    {3670272 , 213000   , 13  ,  "ATSC-1",BW_UNKNOWN, MOD_VSB_8   , 0x0   , 0xd  , 0x1 , 0x1   , SB_VNET_ALL|SB_VNET_ACTIVE|SB_VNET_EPG|SB_VNET_VISIBLE},
    {3670272 , 213000   , 13  ,  "RF13-3",BW_UNKNOWN, MOD_VSB_8   , 0x0   , 0xd  , 0x1 , 0x1   , SB_VNET_ALL|SB_VNET_ACTIVE|SB_VNET_EPG|SB_VNET_VISIBLE},
    {3670272 , 79750    , 5   ,  "ATSC-1",BW_UNKNOWN, MOD_QAM_64  , 0x0   , 0x5  , 0x1 , 0x1   , SB_VNET_ALL|SB_VNET_ACTIVE|SB_VNET_EPG|SB_VNET_VISIBLE},
    {3670528 , 79750    , 5   ,  "ATSC-2",BW_UNKNOWN, MOD_QAM_64  , 0x0   , 0x5  , 0x1 , 0x2   , SB_VNET_ALL|SB_VNET_ACTIVE|SB_VNET_EPG|SB_VNET_VISIBLE},
    {3670784 , 79750    , 5   ,  "ATSC-3",BW_UNKNOWN, MOD_QAM_64  , 0x0   , 0x5  , 0x1 , 0x3   , SB_VNET_ALL|SB_VNET_ACTIVE|SB_VNET_EPG|SB_VNET_VISIBLE}
} ;
    ...
    if (!ps_area)
    {
        ...
        {   
            ...
            *pui2_svl_id   = ATSC_CABLE_SVL_ID ;
            ...
            {
                if ((sizeof(at_ana_table_default_cable) > 0) && (at_ana_table_default_cable[0].ui4_ch_val > 0))
                {
                ...
                if ((sizeof(at_dig_table_default_cable) > 0) && (at_dig_table_default_cable[0].ui4_ch_val >0))
                {
        ...
        {   
            ...
            *pui2_svl_id   = ATSC_TRSTRL_SVL_ID ;
            ...
            {
                if ((sizeof(at_ana_table_default_air) > 0) && (at_ana_table_default_air[0].ui4_ch_val > 0))
                {
                ...
                if ((sizeof(at_dig_table_default_air) > 0) && (at_dig_table_default_air[0].ui4_ch_val > 0))
                {
    ...
    if (!ps_area)
    {
        if (b_cable)
        {
            ...
            *pui2_svl_id   = ATSC_CABLE_SVL_ID ;
            ...
            {
                if ((sizeof(cvt_at_ana_table_default_cable) > 0) && (cvt_at_ana_table_default_cable[0].ui4_ch_val > 0))
                {
                ...
                if ((sizeof(cvt_at_dig_table_default_cable) > 0) && (cvt_at_dig_table_default_cable[0].ui4_ch_val > 0))
                {
        ...
        else
        {
            ...
            *pui2_svl_id   = ATSC_TRSTRL_SVL_ID ;
            ...
            {
                if ((sizeof(cvt_at_ana_table_default_air) > 0) && (cvt_at_ana_table_default_air[0].ui4_ch_val > 0))
                {
                ...
                if ((sizeof(cvt_at_dig_table_default_air) > 0) && (cvt_at_dig_table_default_air[0].ui4_ch_val > 0))
                {
    ...
    )
{
    ...
    for( ui2_i = 0; ui2_i < ui2_ana_size; ui2_i++ ,pt_ana_info ++)
    {
        ...
        t_svl_rec.u_data.t_analog.ui4_audio_sys   = TV_SYS_MASK_NONE;
