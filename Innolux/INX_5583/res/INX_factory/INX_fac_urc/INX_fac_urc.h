...
#define BTN_FAC_IR_KEY_MENU     BTN_CUSTOM_200
#define BTN_FAC_IR_KEY_POWER	BTN_CUSTOM_201


// support both INX and CVTE factory UI, 20190910, zl
#define BTN_PESUDO_FAC_MENU    ((UINT32)(PSEUDO_BTN_IDLE+2))
...
extern INT32 a_INX_fac_urc_dialog_register(VOID);

extern VOID INX_custom_rcu_key_pre_handler(NAV_MODEL_T * pt_this,NAV_EVN_T * pt_event);   //ke_vizio_20160429 add
extern BOOL INX_custom_system_key_cb(UINT32     ui4_evt_code);  //ke_vizio_20160429 add

#ifdef APP_INX_DFT_WIFI_AUTO_DETECTION
extern VOID INX_fac_set_WIFI_status(BOOL b_connect);
extern BOOL INX_fac_get_WIFI_status(VOID);
#endif
