...
typedef enum
{
    ...
    NAV_INX_FAC_INX_TOOLS_PAGE_HDCP_BACKUP_TO_USB,
    NAV_INX_FAC_INX_TOOLS_PAGE_HDCP2_BACKUP_TO_USB,
    ...
    NAV_INX_FAC_INX_TOOLS_PAGE_GET_BT_MAC,
    NAV_INX_FAC_INX_TOOLS_PAGE_GET_BT_RSSI,
    NAV_INX_FAC_INX_TOOLS_PAGE_SSCG,
    NAV_INX_FAC_INX_TOOLS_PAGE_CLEAR_DEMURA_PARTITION,
    NAV_INX_FAC_INX_TOOLS_PAGE_DEMURA_SWITCH,
    NAV_INX_FAC_INX_TOOLS_PAGE_SHOW_PANEL_BORDER,
    NAV_INX_FAC_INX_TOOLS_PAGE_POWER_LED_LIGHT,
    /* Don't remove this */
    NAV_INX_FAC_INX_TOOLS_PAGE_MAX
} NAV_INX_FAC_INX_TOOLS_PAGE_ITEM_ENUM_T;

enum{
    NAV_INX_TO_FAC_INX_TOOLS_PAGE_GET_BT_MAC,
    NAV_INX_TO_FAC_INX_TOOLS_PAGE_GET_BT_RSSI
};
