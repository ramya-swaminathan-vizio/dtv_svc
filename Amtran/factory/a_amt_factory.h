 ...
 *
 *---------------------------------------------------------------------------*/
#ifndef _A_AMT_FACTORY_H_
#define _A_AMT_FACTORY_H_
...
typedef enum
{
    ...
    FACTORY_SET_CMD_DUMP_GAIN_OFFSET, // Added by david.
    FACTORY_SET_CMD_COPY_GAIN_OFFSET_TO_COLOR_TEMP, // Added by david.
    ...
    FACTORY_SET_CMD_SET_WIDE_MODE, // David 20181210, set wide mode
    FACTORY_SET_CMD_SET_LOCAL_DIMMING, // David 20190617, set local dimming
