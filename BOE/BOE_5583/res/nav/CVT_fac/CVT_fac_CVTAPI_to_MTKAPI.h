...
typedef enum
{
    ...
    CVT_APP_CFG_RECID_CLR_GAIN_B,
    CVT_APP_CFG_RECID_CLR_GAIN_G,
    CVT_APP_CFG_GRPID_FACTORY,
    CVT_APP_CFG_RECID_VID_CONTRAST_EN,
    CVT_APP_CFG_RECID_VID_LOCAL_CONTRAST,
}CVT_APP_CFG;
...
extern INT32 CVTE_MTK_Get_AQ_ver(CHAR *aq_ver);
extern INT32 CVTE_MTK_Get_PQ_ver(CHAR *pq_ver);
