...
#ifdef APP_CFG_FAC_CLR_TEMP  //ke_vizio_20130620 modify
#define     ACFG_FAC_CLR_GAIN_ELEM_NUM    2*ACFG_CLR_TEMP_NUM
#define     ACFG_FAC_CLR_OFFSET_ELEM_NUM  2*ACFG_CLR_TEMP_NUM
#ifndef APP_LARGE_EEPROM_SUPPORT
//if define APP_LARGE_EEPROM_SUPPORT, these all move to a_cfg_custom.h
#define     EEP_OFFSET_FAC_CLR_GAIN_R    0x718
#define     EEP_OFFSET_FAC_CLR_GAIN_G    0x720
#define     EEP_OFFSET_FAC_CLR_GAIN_B    0x728
    
#define     EEP_OFFSET_FAC_CLR_OFFSET_R  0x730
#define     EEP_OFFSET_FAC_CLR_OFFSET_G  0x738
#define     EEP_OFFSET_FAC_CLR_OFFSET_B  0x740
    
    /* All Other Settings starts here. */
#define     EEP_OFFSET_ACFG_MISC         0x820
#endif
