...
#include "nav/CVT_fac/CVT_fac_color_tuner_v2_page.h"
...
#define     EEP_CVTE_CUS_BURNING_MODE_FLAG        (0x1A039)                             // 0x1A039
...
#define     EEP_BOE_BORCODE                     (EEP_CVTE_BURNING_MODE_TIME_END + 1)    // 0x1A03F
#define     EEP_BOE_BORCODE_END                 (EEP_BOE_BORCODE + 20)                  // 0x1A053
#define     EEP_CVTE_HDCP_1_X_FILE_ID           (EEP_BOE_BORCODE_END + 1)               // 0x1A054
...
#define     EEP_CVTE_BOE_AT_FLAG                (EEP_CVTE_POWER_MODE_FLAG + 1)          // 0x1A05F
#define     EEP_COLOR_TUNER_VALUE_BEGIN         (EEP_CVTE_BOE_AT_FLAG + 1)              // 0x1A060
#define     EEP_COLOR_TUNER_VALUE_END           (EEP_COLOR_TUNER_VALUE_BEGIN + 1008)     // 0x1A450
