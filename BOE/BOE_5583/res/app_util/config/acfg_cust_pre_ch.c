...
extern INT32 ocl_reinstall(VOID);
...
static _ACFG_PRE_CH_ANA_INFO at_ana_table_default_air[] = 
{
    ...
    {18088064   ,   801250  ,   ""  ,   TV_SYS_MASK_NONE,   SB_VNET_ALL|SB_VNET_ACTIVE|SB_VNET_EPG|SB_VNET_VISIBLE}
};

/* air digital channel table for preset channel */
static _ACFG_PRE_CH_DIG_INFO at_dig_table_default_air[] = 
{
    /* ch num / frequency / tsl rec id / ch name / bandwidth / e_mod / nw id / on id / ts id / prog id / network mask */
    /* this item is not a correct one ,just for passing compair warning ,please replace it with actual data */
    {1573120    ,   785000  ,   66  ,   "SBS"       ,   BW_UNKNOWN, MOD_VSB_8, 0x0, 0x42, 0x1, 0x1, SB_VNET_ALL|SB_VNET_ACTIVE|SB_VNET_EPG|SB_VNET_VISIBLE},
    {285212992  ,   491000  ,   17  ,   "RF17-1"    ,   BW_UNKNOWN, MOD_VSB_8, 0x0, 0x11, 0x1, 0x1, SB_VNET_ALL|SB_VNET_ACTIVE|SB_VNET_EPG|SB_VNET_VISIBLE},
    {2883840    ,   85000   ,   6   ,   "KNTV-HD"   ,   BW_UNKNOWN, MOD_VSB_8, 0x0, 0x6 , 0x1, 0x4, SB_VNET_ALL|SB_VNET_ACTIVE|SB_VNET_EPG|SB_VNET_VISIBLE} ,
    {2884096    ,   85000   ,   6   ,   "NBC Wea"   ,   BW_UNKNOWN, MOD_VSB_8, 0x0, 0x6 , 0x1, 0x5, SB_VNET_ALL|SB_VNET_ACTIVE|SB_VNET_EPG|SB_VNET_VISIBLE}
};
...
static _ACFG_PRE_CH_ANA_INFO at_ana_table_default_cable[] = 
{
    ...
    /* this item is not a correct one ,just for passing compair warning ,please replace it with actual data */   
    {524416     ,   55250   ,   ""  ,   TV_SYS_MASK_NONE,   SB_VNET_ALL|SB_VNET_ACTIVE|SB_VNET_EPG|SB_VNET_VISIBLE} ,
    {32768128   ,   801250  ,   ""  ,   TV_SYS_MASK_NONE,   SB_VNET_ALL|SB_VNET_ACTIVE|SB_VNET_EPG|SB_VNET_VISIBLE}
} ;
...
static _ACFG_PRE_CH_DIG_INFO at_dig_table_default_cable[] = 
{
    /* ch num / frequency / tsl rec id / ch name / bandwidth / e_mod / nw id / on id / ts id / prog id / network mask */
    /* this item is not a correct one ,just for passing compair warning ,please replace it with actual data */   
    {7864576    ,   79000   ,   5   ,   "KPXN DT"   ,   BW_UNKNOWN, MOD_QAM_64  , 0x0   , 0x5   , 0x2 , 0x3   , SB_VNET_ALL|SB_VNET_ACTIVE|SB_VNET_EPG|SB_VNET_VISIBLE} ,
    {7864832    ,   79000   ,   5   ,   "PaxEast"   ,   BW_UNKNOWN, MOD_QAM_64  , 0x0   , 0x5   , 0x2 , 0x4   , SB_VNET_ALL|SB_VNET_ACTIVE|SB_VNET_EPG|SB_VNET_VISIBLE} ,
    {7865088    ,   79000   ,   5   ,   "Worship"   ,   BW_UNKNOWN, MOD_QAM_64  , 0x0   , 0x5   , 0x2 , 0x5   , SB_VNET_ALL|SB_VNET_ACTIVE|SB_VNET_EPG|SB_VNET_VISIBLE} ,
    {7865344    ,   79000   ,   5   ,   "Faith"     ,   BW_UNKNOWN, MOD_QAM_64  , 0x0   , 0x5   , 0x2 , 0x6   , SB_VNET_ALL|SB_VNET_ACTIVE|SB_VNET_EPG|SB_VNET_VISIBLE} ,
    {1929380672 ,   741000  ,   115 ,   "RF115-3"   ,   BW_UNKNOWN, MOD_QAM_256 , 0x0   , 0x73  , 0x2 , 0x3   , SB_VNET_ALL|SB_VNET_ACTIVE|SB_VNET_EPG|SB_VNET_VISIBLE} ,
    {1929380928 ,   741000  ,   115 ,   "RF115-4"   ,   BW_UNKNOWN, MOD_QAM_256 , 0x0   , 0x73  , 0x2 , 0x4   , SB_VNET_ALL|SB_VNET_ACTIVE|SB_VNET_EPG|SB_VNET_VISIBLE} ,
    {1929381184 ,   741000  ,   115 ,   "RF115-5"   ,   BW_UNKNOWN, MOD_QAM_256 , 0x0   , 0x73  , 0x2 , 0x5   , SB_VNET_ALL|SB_VNET_ACTIVE|SB_VNET_EPG|SB_VNET_VISIBLE} ,
    {1929381440 ,   741000  ,   115 ,   "RF115-6"   ,   BW_UNKNOWN, MOD_QAM_256 , 0x0   , 0x73  , 0x2 , 0x6   , SB_VNET_ALL|SB_VNET_ACTIVE|SB_VNET_EPG|SB_VNET_VISIBLE} ,
    {1929381696 ,   741000  ,   115 ,   "RF115-7"   ,   BW_UNKNOWN, MOD_QAM_256 , 0x0   , 0x73  , 0x2 , 0x7   , SB_VNET_ALL|SB_VNET_ACTIVE|SB_VNET_EPG|SB_VNET_VISIBLE} ,
    {1929381952 ,   741000  ,   115 ,   "RF115-8"   ,   BW_UNKNOWN, MOD_QAM_256 , 0x0   , 0x73  , 0x2 , 0x8   , SB_VNET_ALL|SB_VNET_ACTIVE|SB_VNET_EPG|SB_VNET_VISIBLE} ,
    {1929382208 ,   741000  ,   115 ,   "RF115-9"   ,   BW_UNKNOWN, MOD_QAM_256 , 0x0   , 0x73  , 0x2 , 0x9   , SB_VNET_ALL|SB_VNET_ACTIVE|SB_VNET_EPG|SB_VNET_VISIBLE}
} ;


/* air analog channel table for preset channel */
static _ACFG_PRE_CH_ANA_INFO cvt_at_ana_table_default_air[] =
{
    /* channel number / frequency / channel name / tv system / network mask */
    {1572992    ,   83250   ,   ""  ,   TV_SYS_MASK_NONE,   SB_VNET_ALL|SB_VNET_ACTIVE|SB_VNET_EPG|SB_VNET_VISIBLE} ,
    {2883712    ,   199250  ,   ""  ,   TV_SYS_MASK_NONE,   SB_VNET_ALL|SB_VNET_ACTIVE|SB_VNET_EPG|SB_VNET_VISIBLE} ,
    {18088064   ,   801250  ,   ""  ,   TV_SYS_MASK_NONE,   SB_VNET_ALL|SB_VNET_ACTIVE|SB_VNET_EPG|SB_VNET_VISIBLE}
};

/* air digital channel table for preset channel */
static _ACFG_PRE_CH_DIG_INFO cvt_at_dig_table_default_air[] =
{
    /* ch num / frequency / tsl rec id / ch name / bandwidth / e_mod / nw id / on id / ts id / prog id / network mask */
    /* this item is not a correct one ,just for passing compair warning ,please replace it with actual data */
    {7602432    ,   563000  ,   29  ,   "RF29-1"    ,   BW_UNKNOWN, MOD_VSB_8, 0x0, 0x1D, 0x1, 0x1, SB_VNET_ALL|SB_VNET_ACTIVE|SB_VNET_EPG|SB_VNET_VISIBLE},
    {7602688    ,   563000  ,   29  ,   "RF29-2"    ,   BW_UNKNOWN, MOD_VSB_8, 0x0, 0x11, 0x1, 0x2, SB_VNET_ALL|SB_VNET_ACTIVE|SB_VNET_EPG|SB_VNET_VISIBLE}
};

/* cable analog channel table for preset channel */
static _ACFG_PRE_CH_ANA_INFO cvt_at_ana_table_default_cable[] =
{
    /* channel number / frequency / channel name / tv system / network mask */
    /* this item is not a correct one ,just for passing compair warning ,please replace it with actual data */
    {35127424   ,   855200   ,   ""  ,   TV_SYS_MASK_NONE,   SB_VNET_ALL|SB_VNET_ACTIVE|SB_VNET_EPG|SB_VNET_VISIBLE}
} ;

/* cable digital channel table for preset channel */
static _ACFG_PRE_CH_DIG_INFO cvt_at_dig_table_default_cable[] =
{
    /* ch num / frequency / tsl rec id / ch name / bandwidth / e_mod / nw id / on id / ts id / prog id / network mask */
    /* this item is not a correct one ,just for passing compair warning ,please replace it with actual data */
    {3670272    ,   213000  ,   13  ,   "ATSC-1"    ,   BW_UNKNOWN, MOD_QAM_64  , 0x0   , 0xD   , 0x2 , 0x1   , SB_VNET_ALL|SB_VNET_ACTIVE|SB_VNET_EPG|SB_VNET_VISIBLE} ,
    {3670528    ,   213000  ,   13  ,   "ATSC-2"    ,   BW_UNKNOWN, MOD_QAM_64  , 0x0   , 0xD   , 0x2 , 0x2   , SB_VNET_ALL|SB_VNET_ACTIVE|SB_VNET_EPG|SB_VNET_VISIBLE} ,
    {3670784    ,   213000  ,   13  ,   "ATSC-3"    ,   BW_UNKNOWN, MOD_QAM_64  , 0x0   , 0xD   , 0x2 , 0x3   , SB_VNET_ALL|SB_VNET_ACTIVE|SB_VNET_EPG|SB_VNET_VISIBLE} ,
    {218104128  ,   213000  ,   13  ,   "RF13-1"    ,   BW_UNKNOWN, MOD_QAM_64  , 0x0   , 0xD   , 0x2 , 0x1   , SB_VNET_ALL|SB_VNET_ACTIVE|SB_VNET_EPG|SB_VNET_VISIBLE} ,
    {218104384  ,   213000  ,   13  ,   "RF13-2"    ,   BW_UNKNOWN, MOD_QAM_64  , 0x0   , 0xD   , 0x2 , 0x2   , SB_VNET_ALL|SB_VNET_ACTIVE|SB_VNET_EPG|SB_VNET_VISIBLE}
} ;
...
static INT32 _prepare_data_cvte (
    CHAR*                       ps_area ,
    BOOL                        b_cable ,
    HANDLE_T*                   ph_tsl ,
    HANDLE_T*                   ph_svl ,
    ...
    if (!ps_area)
    {
        if (b_cable)
        {
            ...
            *pui2_svl_id   = ATSC_CABLE_SVL_ID ;
            ...
            {
                if (sizeof(cvt_at_ana_table_default_cable) && cvt_at_ana_table_default_cable[0].ui4_ch_val)
                {
                    *pui2_ana_size = (UINT16)(sizeof(cvt_at_ana_table_default_cable)/sizeof(cvt_at_ana_table_default_cable[0])) ;
                }
                else
                {
                    *pui2_ana_size = 0 ;
                ...
                if (sizeof(cvt_at_dig_table_default_cable) && cvt_at_dig_table_default_cable[0].ui4_ch_val)
                {
                    *pui2_dig_size = (UINT16)(sizeof(cvt_at_dig_table_default_cable)/sizeof(cvt_at_dig_table_default_cable[0])) ;
                }
                else
                {
                    *pui2_dig_size = 0 ;
            ...
            *ppt_ana_data  = cvt_at_ana_table_default_cable ;
            *ppt_dig_data  = cvt_at_dig_table_default_cable ;
        }
#else
            if (sizeof(cvt_at_ana_table_default_cable) && cvt_at_ana_table_default_cable[0].ui4_ch_val)
            {
        ...
        else
        {
            ...
            *pui2_svl_id   = ATSC_TRSTRL_SVL_ID ;
            ...
            {
                if (sizeof(cvt_at_ana_table_default_air) && cvt_at_ana_table_default_air[0].ui4_ch_val)
                {
                    *pui2_ana_size = (UINT16)(sizeof(cvt_at_ana_table_default_air)/sizeof(cvt_at_ana_table_default_air[0])) ;
                }
                else
                {
                    *pui2_ana_size = 0 ;
                ...
                if (sizeof(cvt_at_dig_table_default_air) && cvt_at_dig_table_default_air[0].ui4_ch_val)
                {
                    *pui2_dig_size = (UINT16)(sizeof(cvt_at_dig_table_default_air)/sizeof(cvt_at_dig_table_default_air[0])) ;
                }
                else
                {
                    *pui2_dig_size = 0 ;
                ...
                *ppt_ana_data  = cvt_at_ana_table_default_air ;
                *ppt_dig_data  = cvt_at_dig_table_default_air ;
            }
#else
            if (sizeof(cvt_at_ana_table_default_air) && cvt_at_ana_table_default_air[0].ui4_ch_val)
            {
    ...
    )
{
    ...
    {
        RET_ON_ERR (_prepare_data_cvte ( ps_area ,
                                    b_cable ,
                                    &h_tsl ,
                                    &h_svl ,
                                    &ps_tsl_path ,
    ...
    for( ui2_i = 0; ui2_i < ui2_ana_size; ui2_i++ ,pt_ana_info ++)
    {
        ...
        t_svl_rec.u_data.t_analog.ui4_audio_sys   = AUDIO_SYS_MASK_NONE;
