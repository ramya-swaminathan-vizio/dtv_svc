...
#include "res/nav/CVT_fac/CVT_fac.h"
...
T_CMD_DATA_MAP_A at_a_cmd_map[GLUELAYER_CMD_A_END+1] = 
{
    ...
    {GLUELAYER_CMD_A_FACTORY_SET_REGISTRATION,  a_CVT_factory_set_registration},
    ...
    {GLUELAYER_CMD_A_NAV_CUSTOM_REGISTER_COMPONENTS_ODM,  a_nav_cvt_fac_register},
#if 0
