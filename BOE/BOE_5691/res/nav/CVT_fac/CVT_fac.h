...
#define BTN_FAC_KEYPAD_MENU     CVTE_MTK_Get_Btn_Val(CVT_BTN_CUSTOM_118)
#define BTN_FAC_KEYPAD_POWER    CVTE_MTK_Get_Btn_Val(CVT_BTN_CUSTOM_119)


#define BTN_FAC_IR_INIT         CVTE_MTK_Get_Btn_Val(CVT_BTN_CUSTOM_300)
#define BTN_FAC_IR_PRESET_CH    CVTE_MTK_Get_Btn_Val(CVT_BTN_CUSTOM_301)
#define BTN_FAC_IR_AGING_OFF    CVTE_MTK_Get_Btn_Val(CVT_BTN_CUSTOM_302)
#define BTN_FAC_IR_FAC_MENU     CVTE_MTK_Get_Btn_Val(CVT_BTN_CUSTOM_303)
#define BTN_FAC_IR_HDMI1        CVTE_MTK_Get_Btn_Val(CVT_BTN_CUSTOM_304)
#define BTN_FAC_IR_HDMI2        CVTE_MTK_Get_Btn_Val(CVT_BTN_CUSTOM_305)
#define BTN_FAC_IR_HDMI3        CVTE_MTK_Get_Btn_Val(CVT_BTN_CUSTOM_306)
#define BTN_FAC_IR_AV1          CVTE_MTK_Get_Btn_Val(CVT_BTN_CUSTOM_307)
#define BTN_FAC_IR_AV2          CVTE_MTK_Get_Btn_Val(CVT_BTN_CUSTOM_308)
#define BTN_FAC_IR_USB          CVTE_MTK_Get_Btn_Val(CVT_BTN_CUSTOM_309)
#define BTN_FAC_IR_YP1          CVTE_MTK_Get_Btn_Val(CVT_BTN_CUSTOM_310)
#define BTN_FAC_IR_YP2          CVTE_MTK_Get_Btn_Val(CVT_BTN_CUSTOM_311)
#define BTN_FAC_IR_VGA          CVTE_MTK_Get_Btn_Val(CVT_BTN_CUSTOM_312)
#define BTN_FAC_IR_TV           CVTE_MTK_Get_Btn_Val(CVT_BTN_CUSTOM_313)
#define BTN_FAC_IR_VER          CVTE_MTK_Get_Btn_Val(CVT_BTN_CUSTOM_314)
#define BTN_FAC_IR_ADC          CVTE_MTK_Get_Btn_Val(CVT_BTN_CUSTOM_315)
#define BTN_FAC_IR_RESET        CVTE_MTK_Get_Btn_Val(CVT_BTN_CUSTOM_316)
#define BTN_FAC_IR_AGING_ON     CVTE_MTK_Get_Btn_Val(CVT_BTN_CUSTOM_317)
#define BTN_FAC_IR_RESERVE1     CVTE_MTK_Get_Btn_Val(CVT_BTN_CUSTOM_318)
#define BTN_FAC_IR_RESERVE2     CVTE_MTK_Get_Btn_Val(CVT_BTN_CUSTOM_319)
#define BTN_FAC_IR_RESERVE3     CVTE_MTK_Get_Btn_Val(CVT_BTN_CUSTOM_320)
#define BTN_FAC_IR_RESERVE4     CVTE_MTK_Get_Btn_Val(CVT_BTN_CUSTOM_321)
#define BTN_FAC_IR_RESERVE5     CVTE_MTK_Get_Btn_Val(CVT_BTN_CUSTOM_322)
