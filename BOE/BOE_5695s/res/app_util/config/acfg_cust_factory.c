...
INT32 acfg_cust_factory_pre_init(VOID)
{
    ...
    i4_ret = acfg_custom_boe_fac_pre_init();
...
//#ifdef APP_TPV_FAC
    i4_ret = acfg_custom_boe_fac_post_init();
    ACFG_LOG_ON_FAIL(i4_ret);  
//#endif

#if 0  //ke_vizio_20130620 modify
...
static void cvt_App_Cfg_Recid_Cust_Fac_11_Point_handle(clr_reccid_data* clr_data)
{
    UINT32 ui4_read = 0;
    UINT32 ui4_offset = 0;
    ...
    ui4_offset = clr_data->ui4_dynamic_address + ui1_cvt_color_eep_offset[clr_data->i2_clr_temp][clr_data->ui1_play_content] * COLOR_TUNER_FAC_PIECE_NUM + ui4_color_tuner_idx;
    ...
    c_memcpy((VOID *)(clr_data->pi2_val), (VOID *)&i2_array, sizeof(i2_array));
}
static void cvt_App_Cfg_Recid_Cust_Fac_Clr_Tuner_handle(clr_reccid_data* clr_data)
{
    UINT32 ui4_read = 0;
    INT8 i1_val = 0;
    UINT32 ui4_offset = 0;
    ...
    ui4_offset = clr_data->ui4_dynamic_address + ui1_cvt_color_eep_offset[clr_data->i2_clr_temp][clr_data->ui1_play_content] * COLOR_TUNER_FAC_PIECE_NUM + ui4_color_tuner_idx;
    i4_ret = a_cfg_eep_raw_read(ui4_offset,(VOID *)&i1_val,1,&ui4_read);
    *(clr_data->pi2_val) = (INT16)i1_val;
}

static void cvt_App_Cfg_Recid_Vid_Fac_Gain_handle(clr_reccid_data* clr_data,UINT16 ui2_rec_idx,UINT16 ui2_elem_idx)
{
    UINT32 ui4_read = 0;
    INT8 i1_idx = 0;
    INT8 i1_val = 0;
    ...
    if(clr_data->ui4_dynamic_address == 0)
    {
        i4_ret = acfg_get_int16_by_idx(ui2_rec_idx,ui2_elem_idx,clr_data->pi2_val);
        ACFG_CHK_FAIL(i4_ret, i4_ret);
    }
    else
    {
        if(clr_data->ui2_cfg_rec == APP_CFG_RECID_VID_FAC_GAIN_R){
            i1_idx = COLOR_TUNER_FAC_ADDRESS_OFFSET_R_GAIN;
        }
        else if(clr_data->ui2_cfg_rec == APP_CFG_RECID_VID_FAC_GAIN_G){
            i1_idx = COLOR_TUNER_FAC_ADDRESS_OFFSET_G_GAIN;
        }
        else if(clr_data->ui2_cfg_rec == APP_CFG_RECID_VID_FAC_GAIN_B){
            i1_idx = COLOR_TUNER_FAC_ADDRESS_OFFSET_B_GAIN;
        }

        ui4_offset = clr_data->ui4_dynamic_address + ui1_cvt_color_eep_offset[clr_data->i2_clr_temp][clr_data->ui1_play_content] * COLOR_TUNER_FAC_PIECE_NUM + i1_idx;
        i4_ret = a_cfg_eep_raw_read(ui4_offset,(VOID *)&i1_val,1,&ui4_read);
        *(clr_data->pi2_val) = (INT16)i1_val;
    }
}
static void cvt_App_Cfg_Recid_Vid_Fac_Offset_handle(clr_reccid_data* clr_data,UINT16 ui2_rec_idx,UINT16 ui2_elem_idx)
{
    UINT32 ui4_read = 0;
    INT8 i1_idx = 0;
    INT8 i1_val = 0;
    ...
    {
        if(clr_data->ui2_cfg_rec == APP_CFG_RECID_VID_FAC_OFFSET_R){
            i1_idx = COLOR_TUNER_FAC_ADDRESS_OFFSET_R_OFFSET;
        }
        else if(clr_data->ui2_cfg_rec == APP_CFG_RECID_VID_FAC_OFFSET_G){
            i1_idx = COLOR_TUNER_FAC_ADDRESS_OFFSET_G_OFFSET;
        }
        else if(clr_data->ui2_cfg_rec == APP_CFG_RECID_VID_FAC_OFFSET_B){
        ...
        case APP_CFG_GRPID_FACTORY:
        {
            ...
            switch(ui2_cfg_rec)
            {
                ...
                case APP_CFG_RECID_VID_FAC_GAIN_B:
                {
                    ...
                    clr_reccid_data clr_vid_fac_gain;
                    clr_vid_fac_gain.ui2_cfg_rec = ui2_cfg_rec;
                    clr_vid_fac_gain.pi2_val = pi2_val;
                    clr_vid_fac_gain.ui4_dynamic_address = ui4_dynamic_address;
                    clr_vid_fac_gain.i2_clr_temp = i2_clr_temp;
                    clr_vid_fac_gain.ui1_play_content = ui1_play_content;
                    cvt_App_Cfg_Recid_Vid_Fac_Gain_handle(&clr_vid_fac_gain,ui2_rec_idx,ui2_elem_idx);
                    break;
                }
                case APP_CFG_RECID_VID_FAC_OFFSET_R:
                case APP_CFG_RECID_VID_FAC_OFFSET_G:
                case APP_CFG_RECID_VID_FAC_OFFSET_B:
                {
                    ...
                    clr_reccid_data clr_vid_fac_offset;
                    clr_vid_fac_offset.ui2_cfg_rec = ui2_cfg_rec;
                    clr_vid_fac_offset.pi2_val = pi2_val;
                    clr_vid_fac_offset.ui4_dynamic_address = ui4_dynamic_address;
                    clr_vid_fac_offset.i2_clr_temp = i2_clr_temp;
                    clr_vid_fac_offset.ui1_play_content = ui1_play_content;
                    cvt_App_Cfg_Recid_Vid_Fac_Offset_handle(&clr_vid_fac_offset,ui2_rec_idx,ui2_elem_idx);
                    break;
                }
                case APP_CFG_RECID_CUST_FAC_CLR_TUNER_HUE_R:
                case APP_CFG_RECID_CUST_FAC_CLR_TUNER_HUE_G:
                ...
                case APP_CFG_RECID_CUST_FAC_CLR_TUNER_BRI_Y:
                {
                    clr_reccid_data clr_tuner;
                    clr_tuner.ui2_cfg_rec = ui2_cfg_rec;
                    clr_tuner.pi2_val = pi2_val;
                    clr_tuner.ui4_dynamic_address = ui4_dynamic_address;
                    clr_tuner.i2_clr_temp = i2_clr_temp;
                    clr_tuner.ui1_play_content = ui1_play_content;
                    cvt_App_Cfg_Recid_Cust_Fac_Clr_Tuner_handle(&clr_tuner);
                    break;
                }
                case APP_CFG_RECID_CUST_FAC_11_POINT_RED:
                case APP_CFG_RECID_CUST_FAC_11_POINT_GREEN:
                case APP_CFG_RECID_CUST_FAC_11_POINT_BLUE:
                {
                    clr_reccid_data clr_11_point;
                    clr_11_point.ui2_cfg_rec = ui2_cfg_rec;
                    clr_11_point.pi2_val = pi2_val;
                    clr_11_point.ui4_dynamic_address = ui4_dynamic_address;
                    clr_11_point.i2_clr_temp = i2_clr_temp;
                    clr_11_point.ui1_play_content = ui1_play_content;
                    cvt_App_Cfg_Recid_Cust_Fac_11_Point_handle(&clr_11_point);
                    break;
                }
                default:
                    i4_ret = APP_CFGR_NO_ACTION;
...
INT32	a_cfg_custom_reset_factory_colortemp(VOID)
{
	...
	for (ui1_input=0; ui1_input<ACFG_CUST_INPUT_GRP_MAX; ui1_input++)
    {
    	...
    	{
    		acfg_get_int16_by_idx(IDX_CLR_FAC_GAIN_R, ui1_clr_temp, &i2_value);
		...
		for(ui1_clr_temp=0; ui1_clr_temp<(UINT8)ACFG_CLR_TEMP_NUM; ui1_clr_temp++)
    	{    	
        	acfg_get_int16_by_idx(IDX_CLR_FAC_GAIN_G, ui1_clr_temp, &i2_value);
		...
		for(ui1_clr_temp=0; ui1_clr_temp<(UINT8)ACFG_CLR_TEMP_NUM; ui1_clr_temp++)
    	{
        	acfg_get_int16_by_idx(IDX_CLR_FAC_GAIN_B, ui1_clr_temp, &i2_value);
		...
		for(ui1_clr_temp=0; ui1_clr_temp<(UINT8)ACFG_CLR_TEMP_NUM; ui1_clr_temp++)
    	{
        	acfg_get_int16_by_idx(IDX_CLR_FAC_OFFSET_R, ui1_clr_temp, &i2_value);
		...
		for(ui1_clr_temp=0; ui1_clr_temp<(UINT8)ACFG_CLR_TEMP_NUM; ui1_clr_temp++)
    	{
        	acfg_get_int16_by_idx(IDX_CLR_FAC_OFFSET_G, ui1_clr_temp, &i2_value);
		...
		for(ui1_clr_temp=0; ui1_clr_temp<(UINT8)ACFG_CLR_TEMP_NUM; ui1_clr_temp++)
    	{
        	acfg_get_int16_by_idx(IDX_CLR_FAC_OFFSET_B, ui1_clr_temp, &i2_value);
