...
----------------------------------------------------------------------------*/
INT32 menu_network_init(VOID)
{
    INT32     i4_ret = MENUR_OK;

    i4_ret = menu_common_page_network_init();
    MENU_CHK_FAIL(i4_ret);

    i4_ret = menu_common_page_nw_pwd_init();
    MENU_CHK_FAIL(i4_ret);

    i4_ret = menu_common_page_nw_input_ssid();
    MENU_CHK_FAIL(i4_ret);

    i4_ret = menu_common_page_nw_ap_list_init();
    MENU_CHK_FAIL(i4_ret);

    i4_ret = menu_common_page_ip_setting_init();
    MENU_CHK_FAIL(i4_ret);

    i4_ret = menu_common_page_nw_test_init();
    MENU_CHK_FAIL(i4_ret);

    i4_ret = menu_common_page_terms_init();
    MENU_CHK_FAIL(i4_ret);

    //jundi add for network UI.
    i4_ret = menu_common_page_nw_info_init();
    MENU_CHK_FAIL(i4_ret);
