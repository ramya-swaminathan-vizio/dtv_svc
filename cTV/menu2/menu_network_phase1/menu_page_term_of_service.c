...
#ifndef APP_DYNAMIC_TOS_SUPPORT
...
#define TERMS_TOS_TEXT_Y                      (0)
#define TERMS_TOS_TEXT_W                      (MENU_ITEM_V_WIDE)
#define TERMS_TOS_TEXT_H                      (99*4/3)
...
#define MENU_TERMS_LEFT_INSET                   10
/*-----------------------------------------------------------------------------
                            ...
                            const VOID*                 pv_data)
{
    ...
    switch(e_event)
    {
        case TXT_ASYNC_COND_SCANING:
            DBG_INFO(("scanning,b_not_to_show_from_begin=%d\n",
            ...
            case BTN_SELECT:
            {
                if(pt_page_data->b_list_state == FALSE)
                {
                     if(h_widget == pt_page_data->t_terms_text.h_widget)
                     {
                        ...
                        c_wgl_set_focus(pt_page_data->t_terms_text.h_text_widget,WGL_ASYNC_AUTO_REPAINT);
                     ...
                     else if(h_widget == pt_page_data->t_policy_text.h_widget)
                     {
                        ...
                        c_wgl_set_focus(pt_page_data->t_policy_text.h_text_widget,WGL_ASYNC_AUTO_REPAINT);
						pt_page_data->b_is_pre_focus_txt = TRUE;

                        i4_ret = _text_show_start_scan(&pt_page_data->t_policy_text.h_text);
                        if (i4_ret != MENUR_OK)
                        {
                            c_wgl_set_focus(pt_page_data->t_policy_text.h_text_widget,WGL_SYNC_AUTO_REPAINT);
                        }
                        pt_page_data->b_list_state = TRUE;
                                     ...
                                     HANDLE_T*    ph_widget)
{
    ...
    t_inset.i4_left     = 10*4/3;
    t_inset.i4_right    = 10*4/3;
    t_inset.i4_top      = 0;
    t_inset.i4_bottom   = 0;
    i4_ret = c_wgl_do_cmd(*ph_widget,
                                         ...
                                         HANDLE_T* ph_widget)
{
    ...
    t_inset_border.i4_left     = MENU_TERMS_LEFT_INSET;
    t_inset_border.i4_right    = TERMS_TOS_CB_W - 24*4/3 - MENU_TERMS_LEFT_INSET;
    ...
    t_img_info.u_img_data.t_extend.t_highlight          = h_g_menu_checkbox_board;
    t_img_info.u_img_data.t_extend.t_disable            = NULL_HANDLE;
    t_img_info.u_img_data.t_extend.t_highlight_inactive = NULL_HANDLE;
    t_img_info.u_img_data.t_extend.t_push               = h_g_menu_checkbox_board;
    ...
    c_memset(&t_img_info, 0, sizeof(WGL_IMG_INFO_T));
    t_img_info.e_type = WGL_IMG_SET_EXTEND;
    t_img_info.u_img_data.t_extend.t_enable             = h_g_menu_checkbox_off;
    t_img_info.u_img_data.t_extend.t_disable            = h_g_menu_checkbox_off;
    t_img_info.u_img_data.t_extend.t_highlight          = h_g_menu_checkbox_on_hlt;
    t_img_info.u_img_data.t_extend.t_highlight_inactive = h_g_menu_checkbox_on_hlt;
    t_img_info.u_img_data.t_extend.t_push               = h_g_menu_checkbox_on_hlt_check;
    t_img_info.u_img_data.t_extend.t_push_unhighlight   = h_g_menu_checkbox_on;
    i4_ret = c_wgl_do_cmd(*ph_widget,
                          WGL_CMD_GL_SET_IMAGE,
                          WGL_PACK(WGL_IMG_FG),
                          WGL_PACK(&t_img_info) );
    ...
    )
{
    ...
    if (WGL_MSG_KEY_DOWN == ui4_msg)
    {
        ...
        case BTN_RETURN:
            ...
            return MENUR_OK;
        case BTN_CURSOR_DOWN:
            c_wgl_set_focus(pt_page_data->h_terms_checkbox, WGL_SYNC_AUTO_REPAINT);
            break ;
        case BTN_CURSOR_UP:
    ...
    VOID*  pv_create_data)
{
    ...
    pt_page_data->t_terms_text.ui2_msg_idx = MLM_MENU_KEY_NETWORK_TERMS_DOWNLOAD_FAILED;
    ...
    pt_page_data->t_policy_text.ui2_msg_idx = MLM_MENU_KEY_NETWORK_POLICY_DOWNLOAD_FAILED;
    ...
    UINT32 ui4_page_id)
{
    ...
    {
        i4_ret = _text_show_open("/3rd/yahoo_tos_in_spa.txt",
                        &pt_page_data->t_terms_text.h_text_widget,
                        &pt_page_data->t_terms_text.h_text);
        MENU_LOG_ON_FAIL(i4_ret);

        i4_ret = _text_show_open("/3rd/yahoo_privacy_policy_in_spa.txt",
                        &pt_page_data->t_policy_text.h_text_widget,
                        &pt_page_data->t_policy_text.h_text);
        MENU_LOG_ON_FAIL(i4_ret);

        #ifdef SUPPORT_VIZIO_PRIVACY_POLICY
        i4_ret = _text_show_open("/3rd/vizio_tos_for_mexico.txt",
                        &pt_page_data->t_acr_text.h_text_widget,
                        &pt_page_data->t_acr_text.h_text);
        MENU_LOG_ON_FAIL(i4_ret);
        #endif
    }
    else if (ui2_g_menu_curr_lang == MLM_MENU_LANG_FRE)
    {
        i4_ret = _text_show_open("/3rd/yahoo_tos_in_fre.txt",
                        &pt_page_data->t_terms_text.h_text_widget,
                        &pt_page_data->t_terms_text.h_text);
        MENU_LOG_ON_FAIL(i4_ret);

        i4_ret = _text_show_open("/3rd/yahoo_privacy_policy_in_fre.txt",
                        &pt_page_data->t_policy_text.h_text_widget,
                        &pt_page_data->t_policy_text.h_text);
        MENU_LOG_ON_FAIL(i4_ret);

        #ifdef SUPPORT_VIZIO_PRIVACY_POLICY
        i4_ret = _text_show_open("/3rd/vizio_tos_for_canada.txt",
                        &pt_page_data->t_acr_text.h_text_widget,
                        &pt_page_data->t_acr_text.h_text);
        MENU_LOG_ON_FAIL(i4_ret);
        #endif
    ...
    {
        i4_ret = _text_show_open("/3rd/yahoo_tos_in_eng.txt",
                        &pt_page_data->t_terms_text.h_text_widget,
                        &pt_page_data->t_terms_text.h_text);
        MENU_LOG_ON_FAIL(i4_ret);

        i4_ret = _text_show_open("/3rd/yahoo_privacy_policy_in_eng.txt",
                        &pt_page_data->t_policy_text.h_text_widget,
                        &pt_page_data->t_policy_text.h_text);
        MENU_LOG_ON_FAIL(i4_ret);

        #ifdef SUPPORT_VIZIO_PRIVACY_POLICY
        i4_ret = _text_show_open("/3rd/vizio_tos_for_usa.txt",
                        &pt_page_data->t_acr_text.h_text_widget,
                        &pt_page_data->t_acr_text.h_text);
        MENU_LOG_ON_FAIL(i4_ret);
        #endif
...
#else
    /* open file, for show protocol text */
    i4_ret = _text_show_open("/3rd/termsofservice.txt",
                    &pt_page_data->t_terms_text.h_text_widget,
                    &pt_page_data->t_terms_text.h_text);
    MENU_LOG_ON_FAIL(i4_ret);

    i4_ret = _text_show_open("/3rd/privacypolicy.txt",
                    &pt_page_data->t_policy_text.h_text_widget,
                    &pt_page_data->t_policy_text.h_text);
    MENU_LOG_ON_FAIL(i4_ret);

    #ifdef SUPPORT_VIZIO_PRIVACY_POLICY
    i4_ret = _text_show_open("/3rd/vizio_tos.txt",
                    &pt_page_data->t_acr_text.h_text_widget,
                    &pt_page_data->t_acr_text.h_text);
    MENU_LOG_ON_FAIL(i4_ret);
    #endif
    ...
    MENU_PAGE_HINT_T* pt_hint)
{
    ...
    c_wgl_set_focus(pt_page_data->h_terms_checkbox, WGL_NO_AUTO_REPAINT);
