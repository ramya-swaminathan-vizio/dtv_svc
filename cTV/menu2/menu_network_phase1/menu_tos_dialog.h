...
#ifndef _MENU_TOS_DIALOG_H_
#define _MENU_TOS_DIALOG_H_
...
#define SIMPLE_DIALOG_TITLE_H                     (50)//MENU_ITEM_V_HEIGHT//(64)

#define SIMPLE_DIALOG_TEXT_X                      (0)
#define SIMPLE_DIALOG_TEXT_Y                      (SIMPLE_DIALOG_TITLE_Y + SIMPLE_DIALOG_TITLE_H)//(16)
#define SIMPLE_DIALOG_TEXT_W                      (SIMPLE_DIALOG_FRAM_W)
#define SIMPLE_DIALOG_TEXT_H                      (SIMPLE_DIALOG_FRAM_H - SIMPLE_DIALOG_TEXT_Y - SIMPLE_DIALOG_BTN_H -32)
...
/*-----------------------------------------------------------------------------
 ...
 ----------------------------------------------------------------------------*/
typedef VOID (*menu_tos_dialog_cb_fct)(UINT32 ui4_key_code);

extern INT32 menu_tos_dialog_show(UINT16      ui2_msgid_title,
                                        UINT16      ui2_msgid_text,
                                        UINT16      ui2_msgid_btn,
                                        menu_tos_dialog_cb_fct  pf_back,
                                        BOOL         b_repaint);
extern INT32 menu_tos_dialog_hide(BOOL  b_repaint);

extern INT32 menu_tos_dialog_init(VOID);
