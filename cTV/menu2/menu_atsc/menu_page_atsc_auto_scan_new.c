...
/*-----------------------------------------------------------------------------
                    data declarations
-----------------------------------------------------------------------------*/
MENU_PAGE_FCT_TBL_T  t_g_menu_atsc_page_auto_scan2_new;
...
static INT32 _on_page_show(UINT32 ui4_page_id)
{
    ...
    MENU_LOG_ON_FAIL (menu_main_set_title(MLM_MENU_KEY_FIND_NEW_CHANNELS));

    i4_ret = menu_action_chg_lang(h_channel_found,
                                 MLM_MENU_KEY_SCAN_CH_FOUND_NEW,
                                 MLM_MENU_KEY_EMPTY);
    MENU_CHK_FAIL(i4_ret);
...
{
    t_g_menu_atsc_page_auto_scan2_new.pf_menu_page_create =    _on_page_create;
    t_g_menu_atsc_page_auto_scan2_new.pf_menu_page_destroy=    _on_page_destroy;
    t_g_menu_atsc_page_auto_scan2_new.pf_menu_page_show=       _on_page_show;
    t_g_menu_atsc_page_auto_scan2_new.pf_menu_page_hide=       _on_page_hide;
    t_g_menu_atsc_page_auto_scan2_new.pf_menu_page_get_focus=  _on_page_get_focus;
    t_g_menu_atsc_page_auto_scan2_new.pf_menu_page_lose_focus= _on_page_lose_focus;
    t_g_menu_atsc_page_auto_scan2_new.pf_menu_page_update=     _on_page_update;
