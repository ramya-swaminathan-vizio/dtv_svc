 ...
 *---------------------------------------------------------------------------*/
/*-----------------------------------------------------------------------------
 * $RCSfile: menu_page_vchip_ca_en.c,v $
 * $Revision: #1 $
 * $Date: 2015/05/29 $
...
/*-----------------------------------------------------------------------------
 ...
 ----------------------------------------------------------------------------*/
#define _RATING_NUM_    6

/*-----------------------------------------------------------------------------
                    data declarations
-----------------------------------------------------------------------------*/
MENU_PAGE_FCT_TBL_T  t_g_menu_atsc_page_vchip_ca_en;
...
#endif
        menu_set_and_show_help_tip(MENU_TEXT(MLM_MENU_KEY_HELP_TIP_RATE_ENG_C+ui2_idx));
        break;
    }
    ...
    case WGL_MSG_KEY_DOWN:
    {
        ...
        case BTN_CURSOR_UP:
            ...
            else
            {
                ...
                menu_set_and_show_help_tip(MENU_TEXT(MLM_MENU_KEY_HELP_TIP_RATE_ENG_C+ui2_idx-1));
            }
            break;
...
static INT32 _on_page_show(UINT32 ui4_page_id)
{
    ...
    menu_main_set_title(MLM_MENU_KEY_VCHIP_CA_EN);
                                ...
                                MENU_PAGE_HINT_T* pt_hint)
{
    ...
    menu_set_and_show_help_tip(MENU_TEXT(MLM_MENU_KEY_HELP_TIP_RATE_ENG_C));
...
{
    t_g_menu_atsc_page_vchip_ca_en.pf_menu_page_create      = _on_page_create;
    t_g_menu_atsc_page_vchip_ca_en.pf_menu_page_destroy     = _on_page_destroy;
    t_g_menu_atsc_page_vchip_ca_en.pf_menu_page_show        = _on_page_show;
    t_g_menu_atsc_page_vchip_ca_en.pf_menu_page_hide        = _on_page_hide;
    t_g_menu_atsc_page_vchip_ca_en.pf_menu_page_get_focus   = _on_page_get_focus;
    t_g_menu_atsc_page_vchip_ca_en.pf_menu_page_lose_focus  = _on_page_lose_focus;
    t_g_menu_atsc_page_vchip_ca_en.pf_menu_page_update      = _on_page_update;

    return MENUR_OK;
}

#endif /* ATSC_VCHIP_CA_EN_ENABLE */
