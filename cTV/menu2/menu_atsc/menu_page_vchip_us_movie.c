 ...
 *---------------------------------------------------------------------------*/
/*-----------------------------------------------------------------------------
 * $RCSfile: menu_page_vchip_us_movie.c,v $
 * $Revision: #1 $
 * $Date: 2015/05/29 $
 ...
 *
 * Description:
 *      This file implements the U.S VChip movie ratings.
 *---------------------------------------------------------------------------*/
...
/*-----------------------------------------------------------------------------
                    data declarations
-----------------------------------------------------------------------------*/
MENU_PAGE_FCT_TBL_T  t_g_menu_atsc_page_vchip_us_movie;
...
static  UTF16_T*    aw2s_tts_rating_str[_RATING_NUM_] =
{
    L"G ",
    L"PG ",
    L"PG-13 ",
    ...
    VOID*       pv_param2)
{
    ...
    case WGL_MSG_GET_FOCUS:
    {
        ...
        c_wgl_do_cmd(h_lb_rating,
                     ...
                     WGL_PACK(ui2_idx),
                     WGL_PACK(&b_is_sel) );
        TTS_KV_PLAY(aw2s_tts_rating_str[ui2_idx],((b_is_sel) ? L" locked" : L" unlocked"),NULL);
#endif
        menu_set_and_show_help_tip(MENU_TEXT(MLM_MENU_KEY_HELP_TIP_RATE_MV_G+ui2_idx));
        break;
    }
    ...
    case WGL_MSG_KEY_DOWN:
    {
        ...
        MENU_CHK_FAIL(c_wgl_do_cmd(h_lb_rating,
                                   WGL_CMD_LB_GET_HLT_INDEX,
                                   WGL_PACK(&ui2_idx),
                                   NULL));
...
static INT32 _on_page_show(UINT32 ui4_page_id)
{
    ...
    menu_main_set_title(MLM_MENU_KEY_VCHIP_US_MOVIE);
                                ...
                                MENU_PAGE_HINT_T* pt_hint)
{
    ...
    menu_set_and_show_help_tip(MENU_TEXT(MLM_MENU_KEY_HELP_TIP_RATE_MV_G));
...
{
    t_g_menu_atsc_page_vchip_us_movie.pf_menu_page_create       = _on_page_create;
    t_g_menu_atsc_page_vchip_us_movie.pf_menu_page_destroy      = _on_page_destroy;
    t_g_menu_atsc_page_vchip_us_movie.pf_menu_page_show         = _on_page_show;
    t_g_menu_atsc_page_vchip_us_movie.pf_menu_page_hide         = _on_page_hide;
    t_g_menu_atsc_page_vchip_us_movie.pf_menu_page_get_focus    = _on_page_get_focus;
    t_g_menu_atsc_page_vchip_us_movie.pf_menu_page_lose_focus   = _on_page_lose_focus;
    t_g_menu_atsc_page_vchip_us_movie.pf_menu_page_update       = _on_page_update;

    return MENUR_OK;
}

#endif /* ATSC_VCHIP_US_MOVIE_ENABLE */
