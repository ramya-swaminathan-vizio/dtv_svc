...
#ifndef _MENU_PAGE_DEVICE_SETTING_NO_WIFI_REMOTE_H_
#define _MENU_PAGE_DEVICE_SETTING_NO_WIFI_REMOTE_H_
...
#define MENU_DEVICE_SETTING_DEV_USER_NAME_COLUMN_WIDTH (MENU_ITEM_V_WIDE   \
                                                        -MENU_DEVICE_SETTING_DEV_DISP_NAME_COL_WIDTH + 70)
...
#define MENU_DEVICE_SETTING_DEV_LIST_H           (MENU_DEVICE_SETTING_DEV_LIST_ELEM_HEIGHT*8)

#define MENU_DEVICE_SETTING_LB_INSET_LEFT           (FRAME_LEFT_RIGHT_INTV-8)
#define MENU_DEVICE_SETTING_LB_INSET_RIGHT          (FRAME_LEFT_RIGHT_INTV)
#define MENU_DEVICE_SETTING_DEV_LIST_ELEM_HEIGHT    (MENU_ITEM_V_HEIGHT)
...
#define MENU_DEVICE_SETTING_CEC_DEVICE_NUM   (16)

#define MENU_DEVICE_SETTING_MIRACAST_DEVICE_NAME_LEN (DEVICE_INFO_MAX_NAME_LEN)

#define MENU_DEVICE_SETTING_CEC_DEVICE_NAME_LEN (16)

typedef struct _MENU_DEVICE_SETTING_CEC_DEV_DATA_T
{
	UTF16_T w2s_dev_osd_name[MENU_DEVICE_SETTING_CEC_DEVICE_NUM][MENU_DEVICE_SETTING_INPUT_DISP_NAME_LEN];
	UINT8   dev_num;
...
#endif /* _MENU_PAGE_DEVICE_SETTING_NO_WIFI_REMOTE_H_ */
