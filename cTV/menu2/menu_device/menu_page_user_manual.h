...
#define USER_MANUAL_MSG_TEXT_X                      (0)
#define USER_MANUAL_MSG_TEXT_Y                      (0)
#define USER_MANUAL_MSG_TEXT_W                      (MENU_ITEM_V_WIDE)
#define USER_MANUAL_MSG_TEXT_H                      (550)//500

#define USER_MANUAL_SHADOW_HEIGHT                   2 * MENU_ITEM_V_HEIGHT + CONTENT_Y - 40
