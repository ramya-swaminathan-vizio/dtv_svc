 ...
 *---------------------------------------------------------------------------*/
/*-----------------------------------------------------------------------------
 * $RCSfile: menu_page_hide_from_input_list.h,v $
 * $Revision: #1 $
 * $Date: 2010/10/10 $
 * $Author: fs_yuwenhan $
 ...
 *---------------------------------------------------------------------------*/
#ifndef __MENU_PAGE_HIDE_FROM_INPUT_LIST_H_
#define __MENU_PAGE_HIDE_FROM_INPUT_LIST_H_

#include <stdio.h>
#include "menu2/menu_page_tree.h"
#include "res/menu2/menu_mlm.h"

extern INT32 hide_from_inp_init(UINT16 ui2_parent);
#endif
