...
/*add animation*/
#define WZD_SB_BTN_SCALE_UP_W              (463 * WZD_UI_RATIO_W)
#define WZD_SB_BTN_SCALE_UP_H              (436 * WZD_UI_RATIO_W)

#define WZD_SB_BTN_SCALE_DOWN_W            (295 * WZD_UI_RATIO_W)
#define WZD_SB_BTN_SCALE_DOWN_H            (278 * WZD_UI_RATIO_W)
...
static INT32 _wzd_time_zone_set_frm_bg_img(
    HANDLE_T            h_widget,
 ...
 *
 ----------------------------------------------------------------------------*/
static INT32 _wzd_time_zone_sb_losed_foucs_box_txt_initial(UINT8 ui1_sb_idx)
{
    WZD_TIME_ZONE_PAGE_DATA_T*	pt_this = &t_g_wzd_time_zone_page_data;
    ...
    h_txt_handle = pt_this->t_sb_btn[ui1_sb_idx].h_sb_text;
    ...
    i4_ret = c_wgl_move(pt_this->t_sb_btn[ui1_sb_idx].h_sb_text,
                        &t_rect,
                        WGL_NO_AUTO_REPAINT);
    RET_ON_ERR (i4_ret);
    ...
    i4_ret = c_wgl_do_cmd((pt_this->t_sb_btn[ui1_sb_idx]).h_sb_icon_1,
...
/*----------------------------------------------------------------------------
 * Name: _wzd_time_zone_set_frm_bg_img
 *
 * Description: 
 *
 * Inputs:  -
...
/*----------------------------------------------------------------------------
 * Name: _wzd_time_zone_scale_cond_cb_handler
 *
 * Description: 
 *
 * Inputs:  -
 ...
 * Any other values            Failed.
 ----------------------------------------------------------------------------*/
static VOID _wzd_time_zone_scale_cond_cb_handler(
    VOID*               pv_data,
    SIZE_T              z_data_size)
{
    ...
    do
    {
        ...
        DBG_INFO( ("[WZD][TIMEZONE]ANIM end:0x%x, param:%d, index:%d\n",
        ...
        if (WZD_CALLBACK_PARAM_SCALE_DOWN == param)
        {
            ...
            if ((pt_anim_cb_data->ui4_index >= WZD_SB_BTN_01) && (pt_anim_cb_data->ui4_index <= WZD_SB_BTN_05))
            {
                _wzd_time_zone_set_frm_bg_img(pt_anim_cb_data->h_anim_handle, h_g_wzd_img_selectbox_small);
            }
            else if ((pt_anim_cb_data->ui4_index >= WZD_SB_BTN_06) && (pt_anim_cb_data->ui4_index <= WZD_SB_BTN_10))
            {
                _wzd_time_zone_set_frm_bg_img(pt_anim_cb_data->h_anim_handle, h_g_wzd_img_selectbox_small_1);
            }
            else
            {
            ...
            _wzd_time_zone_sb_losed_foucs_box_txt_initial(pt_anim_cb_data->ui4_index);
        ...
        {
            /*change image for the lose get box*/
            _wzd_time_zone_set_frm_bg_img(pt_anim_cb_data->h_anim_handle, h_g_wzd_img_selectbox_small_hlt); 
...
/*----------------------------------------------------------------------------
 * Name: _wzd_time_zone_scale_cb_fct
 *
 * Description: 
 *
 * Inputs:  -
 ...
 * Any other values            Failed.
 ----------------------------------------------------------------------------*/
static INT32 _wzd_time_zone_scale_cb_fct(
    HANDLE_T            h_widget,
    ...
    VOID*               pv_tag)
{
    ...
    {
        DBG_INFO( ("[WZD][TIMEZONE] ANIM_TOTAL_END Line@%d.\n", __LINE__));

        /* Async invoke callback handler function */        
        wzd_async_invoke(
                _wzd_time_zone_scale_cond_cb_handler, 
                pv_tag, 
...
/*----------------------------------------------------------------------------
 * Name: _wzd_time_zone_get_focus_scale_up
 *
...
static INT32 _wzd_time_zone_get_focus_scale_up(HANDLE_T h_widget)
{
    ...
    {   
        ...
        pt_anim_data_scale->ui2_frame_interval = 40;
        pt_anim_data_scale->ui4_start_tick = 0;

        
        pt_anim_data_scale->ui8_start_w = WZD_SB_BTN_W;
        pt_anim_data_scale->ui8_start_h = WZD_SB_BTN_W;
        pt_anim_data_scale->ui8_end_w = WZD_SB_BTN_SCALE_UP_W;
        pt_anim_data_scale->ui8_end_h = WZD_SB_BTN_SCALE_UP_H;
...
#if 0
/*----------------------------------------------------------------------------
 * Name: _wzd_time_zone_lose_focus_scale_down
 *
...
static INT32 _wzd_time_zone_lose_focus_scale_down(HANDLE_T h_widget)
{
    ...
    {   
        ...
        pt_anim_data_scale->ui8_start_w = WZD_SB_BTN_W;
        pt_anim_data_scale->ui8_start_h = WZD_SB_BTN_W;
        pt_anim_data_scale->ui8_end_w = WZD_SB_BTN_SCALE_DOWN_W;
        pt_anim_data_scale->ui8_end_h = WZD_SB_BTN_SCALE_DOWN_H;
...
#endif
/*----------------------------------------------------------------------------
* Name:_wzd_time_zone_sb_set_checkmark
*
* Description: set the sel box checkmark and add move animation for the text on the sel box.
*
* Inputs:
*
* Outputs:
...
*
----------------------------------------------------------------------------*/
static INT32 _wzd_time_zone_sb_set_checkmark(VOID)
{
    WZD_TIME_ZONE_PAGE_DATA_T*  pt_this = &t_g_wzd_time_zone_page_data;
    ...
    /* move icon position */
    RET_ON_ERR (c_wgl_do_cmd(pt_this->t_sb_btn[pt_this->ui1_sb_idx].h_sb_icon_1,
                      WGL_CMD_ICON_SET_ALIGN,
                      WGL_PACK(WGL_AS_CENTER_CENTER),
                      NULL));
    ...
    RET_ON_ERR (c_wgl_move(pt_this->t_sb_btn[pt_this->ui1_sb_idx].h_sb_icon_1,
                      &t_rect,
                      WGL_NO_AUTO_REPAINT));
    ...
    RET_ON_ERR (c_wgl_repaint(pt_this->t_sb_btn[pt_this->ui1_sb_idx].h_sb_icon_1,NULL,TRUE));

    /* start text move animation */
    t_anim_data.ui2_total_steps = 6;
    t_anim_data.ui2_frame_interval = 50;

    t_anim_data.i2_start_x = 0;
    t_anim_data.i2_start_y =  (10 + 125 + (140 - 80)/2) * WZD_UI_RATIO_W;
    t_anim_data.i2_end_x   = 0;
    t_anim_data.i2_end_y   = (10 + 125 + (140 - 80)/2 + 10) * WZD_UI_RATIO_W;

    a_wzd_anim_move(pt_this->t_sb_btn[pt_this->ui1_sb_idx].h_sb_text, &t_anim_data, TRUE);
    a_wzd_anim_end(pt_this->t_sb_btn[pt_this->ui1_sb_idx].h_sb_text);
...
/*----------------------------------------------------------------------------
* Name:_wzd_time_zone_sb_update_checkmark
*
* Description: update the sel box checkmark when the sel box's focus changed.
*
* Inputs:
*
* Outputs:
...
*
----------------------------------------------------------------------------*/
static INT32 _wzd_time_zone_sb_update_checkmark(VOID)
{
    WZD_TIME_ZONE_PAGE_DATA_T*  pt_this = &t_g_wzd_time_zone_page_data;
    INT32                       i4_ret = 0;
    ...
    if(1 == ui2_tz_select_status)
    {
        a_cfg_custom_get_timezone_idx(&ui1_time_zone_idx);
        ui1_time_zone_idx = _wzd_time_zone_remap_acfg(ui1_time_zone_idx);

        if (ui1_time_zone_idx == pt_this->ui1_sb_idx)
        {
            h_checkmark_icon = h_g_wzd_img_checkmark_green_small;
        }
        else
    ...
    /* update select box text position*/  
    if ((1 == ui2_tz_select_status))
    {
        if (pt_this->b_show_checkbox)
        {
            SET_RECT_BY_SIZE(&t_rect,
                            0,
                            (125 + (140 - 80)/2 + 10) * WZD_UI_RATIO_W,
                            WZD_SB_BTN_W,
                            80 * WZD_UI_RATIO_W);
        ...
        if (ui1_time_zone_idx >= WZD_SB_BTN_COUNT)
        {
            DBG_ERROR( ("%s(%d) ui1_time_zone_idx(%d) overflow\n", __func__,
                        __LINE__, ui1_time_zone_idx));
            return WZDR_FAIL;
        }
        i4_ret = c_wgl_move(pt_this->t_sb_btn[ui1_time_zone_idx].h_sb_text,
                            &t_rect,
                            WGL_NO_AUTO_REPAINT);
        RET_ON_ERR (i4_ret);
    }
    ...
    if (pt_this->b_show_checkbox)
    {
        ...
        RET_ON_ERR (c_wgl_move(pt_this->t_sb_btn[ui1_time_zone_idx].h_sb_icon_1,
                           &t_rect,
                           WGL_NO_AUTO_REPAINT));
    }
    
    RET_ON_ERR (c_wgl_do_cmd(pt_this->t_sb_btn[ui1_time_zone_idx].h_sb_icon_1,
                  WGL_CMD_ICON_SET_ALIGN,
                  WGL_PACK(WGL_AS_CENTER_CENTER),
                  NULL));
    ...
    i4_ret = c_wgl_do_cmd((pt_this->t_sb_btn[ui1_time_zone_idx]).h_sb_icon_1,
                           WGL_CMD_GL_SET_IMAGE,
                           WGL_PACK(WGL_IMG_FG),
                           WGL_PACK(&t_img_info));                 
    RET_ON_ERR(i4_ret);
...
/*----------------------------------------------------------------------------
 * Name: _wzd_time_zone_all_widget_anim_finish
 *
 ...
 *          FALSE                 at least one widget's anim is not finish.
 ----------------------------------------------------------------------------*/
static BOOL _wzd_time_zone_all_widget_anim_finish (VOID)
{
                    ...
                    )
{
    ...
    case WGL_MSG_KEY_DOWN:
        {
            DBG_INFO( ("[WZD][TIMEZONE] --- KEY value: %d  @LINE: %d.\n", (UINT32)pv_param1, __LINE__));

            /* if sel box scale animation is NOT finish, just return */
            if (!_wzd_time_zone_all_widget_anim_finish())
            {
                return WZDR_OK;
            }
            ...
            case BTN_SELECT:
                ...
                if (!pt_this->b_show_checkbox)
                {
                    ...
                    _wzd_time_zone_sb_set_checkmark();
                }
            ...
            case BTN_CURSOR_UP:
                if (pt_this->ui1_sb_idx >= WZD_SB_BTN_06 && pt_this->ui1_sb_idx <= WZD_SB_BTN_10) 
                {
    				...
    				_wzd_time_zone_set_frm_bg_img(pt_this->t_sb_btn[pt_this->ui1_sb_idx- WZD_SB_BTN_06].h_sb_btn_frm, h_g_wzd_img_selectbox_small_hlt_small);
                    ...
                    pt_data->b_used = TRUE;
                    pt_data->h_anim_handle = pt_this->t_sb_btn[pt_this->ui1_sb_idx].h_sb_btn_frm;
                    pt_data->ui4_index = pt_this->ui1_sb_idx;
                    pt_data->e_param = WZD_CALLBACK_PARAM_SCALE_DOWN;
                    
                    /* set scale down callback */
                    a_wzd_anim_set_cb(
                               pt_this->t_sb_btn[pt_this->ui1_sb_idx].h_sb_btn_frm,
                               _wzd_time_zone_scale_cb_fct,
                               (void *)pt_data);
                    ...
                    c_memset(pt_data, 0, sizeof(WZD_ANIM_COND_CB_DATA_T));
                    pt_data->b_used = TRUE;
                    pt_data->h_anim_handle = pt_this->t_sb_btn[pt_this->ui1_sb_idx- WZD_SB_BTN_06].h_sb_btn_frm;
                    pt_data->ui4_index = pt_this->ui1_sb_idx - WZD_SB_BTN_06;
                    pt_data->e_param = WZD_CALLBACK_PARAM_SCALE_UP;
                    
                    /* set scale up callback */
                    a_wzd_anim_set_cb(
                               pt_this->t_sb_btn[pt_this->ui1_sb_idx- WZD_SB_BTN_06].h_sb_btn_frm,
                               _wzd_time_zone_scale_cb_fct,
                               (void *)pt_data);

                    /* start scale down anim for lose focus box*/
                    wzd_anim_small_sb_scale_down(pt_this->t_sb_btn[pt_this->ui1_sb_idx].h_sb_btn_frm);

                    /* start scale up anim for get focus box*/
                    _wzd_time_zone_get_focus_scale_up(pt_this->t_sb_btn[pt_this->ui1_sb_idx- WZD_SB_BTN_06].h_sb_btn_frm);
                    ...
                    _wzd_time_zone_sb_update_checkmark();
                }
                break;
            ...
            case BTN_CURSOR_DOWN:
                ...
                {
                    /* set image for the get focus box */
    				_wzd_time_zone_set_frm_bg_img(pt_this->t_sb_btn[pt_this->ui1_sb_idx+WZD_SB_BTN_06].h_sb_btn_frm, h_g_wzd_img_selectbox_small_hlt_small);
                ...
                {
                    /* change image for the lose focus box */
    				_wzd_time_zone_set_frm_bg_img(pt_this->t_sb_btn[pt_this->ui1_sb_idx].h_sb_btn_frm, h_g_wzd_img_selectbox_small_hlt_small);
            ...
            case BTN_CURSOR_RIGHT:
                ...
                {
                    /* change image for get focus box */
    				_wzd_time_zone_set_frm_bg_img(pt_this->t_sb_btn[pt_this->ui1_sb_idx+1].h_sb_btn_frm, h_g_wzd_img_selectbox_small_hlt_small);
                    ...
                    c_memset(pt_data, 0, sizeof(WZD_ANIM_COND_CB_DATA_T));
                    pt_data->b_used = TRUE;
                    pt_data->h_anim_handle = pt_this->t_sb_btn[pt_this->ui1_sb_idx+1].h_sb_btn_frm;
                    pt_data->ui4_index = pt_this->ui1_sb_idx + 1;
                    pt_data->e_param = WZD_CALLBACK_PARAM_SCALE_UP;
                    
                    /* set scale up callback */
                    a_wzd_anim_set_cb(
                               pt_this->t_sb_btn[pt_this->ui1_sb_idx+1].h_sb_btn_frm,
                               _wzd_time_zone_scale_cb_fct,
                               (void *)pt_data);
                    ...
                    /* start scale up anim for get focus box*/
                    _wzd_time_zone_get_focus_scale_up(pt_this->t_sb_btn[pt_this->ui1_sb_idx+1].h_sb_btn_frm);
            ...
            case BTN_CURSOR_LEFT:
                if (pt_this->ui1_sb_idx >= WZD_SB_BTN_02 && pt_this->ui1_sb_idx <= WZD_SB_BTN_10) 
                {
                    ...
                    /* start scale down anim for the lose focus box*/
                    wzd_anim_small_sb_scale_down(pt_this->t_sb_btn[pt_this->ui1_sb_idx].h_sb_btn_frm);

                    /* start scale up anim for the get focus box */
                    _wzd_time_zone_get_focus_scale_up(pt_this->t_sb_btn[pt_this->ui1_sb_idx-1].h_sb_btn_frm);
        ...
        case WZD_FOOTER_MSG_KEY_INPUT:
            switch((UINT32)pv_param1)
            {
				...
				case BTN_CURSOR_UP:
                    ...
                    if (!_wzd_time_zone_all_widget_anim_finish())
                    {
                        DBG_INFO( ("####[WZD][TIMEZONE]get focus @LINE: %d.just return\n", (UINT32)__LINE__));
                        return;
                    }
                    ...
                    /* start scale up anim for the get focus box*/
                    _wzd_time_zone_get_focus_scale_up(pt_this->t_sb_btn[pt_this->ui1_sb_idx].h_sb_btn_frm);
...
static INT32 _wzd_time_zone_page_show (UINT32 ui4_page_id)
{
    ...
    for (ui1_i = WZD_SB_BTN_01; ui1_i <= WZD_SB_BTN_05; ui1_i++)
    {
        t_img_info.e_type = WGL_IMG_SET_STANDARD;
        t_img_info.u_img_data.t_standard.t_enable    = h_g_wzd_img_selectbox_small;
        t_img_info.u_img_data.t_standard.t_disable   = h_g_wzd_img_selectbox_small;
        ...
        RET_ON_ERR (c_wgl_do_cmd (pt_this->t_sb_btn[ui1_i].h_sb_btn_frm,
                               WGL_CMD_GL_SET_IMAGE,
                               WGL_PACK (WGL_IMG_BK), /* background image */
                               WGL_PACK (&t_img_info)));
    }
	...
	RET_ON_ERR (_wzd_time_zone_sb_losed_foucs_box_txt_initial(pt_this->ui1_sb_idx));
