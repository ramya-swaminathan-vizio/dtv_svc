...
#define  COUNTRY_HELP_HPR_TXT_X                      (0 * WZD_UI_RATIO_W)
#define  COUNTRY_HELP_HPR_TXT_Y                      (460 * WZD_UI_RATIO_W)
#define  COUNTRY_HELP_HPR_TXT_W                      (MAIN_FRM_W)
#define  COUNTRY_HELP_HPR_TXT_H                      (80 * WZD_UI_RATIO_W)

 typedef struct _WZD_COUNTRY_SETTING_PAGE_DATA_T
 {
    HANDLE_T                    h_hypetext_help;
    UINT8                       ui1_sel_box_idx;
    BOOL                        b_show_checkbox;
 }WZD_COUNTRY_SETTING_PAGE_DATA_T;


static WZD_COUNTRY_SETTING_PAGE_DATA_T t_g_wzd_country_setting_page_data;

static INT32 _wzd_country_setting_page_help_update(UTF16_T* pw2s_text,
                                              WGL_HIMG_TPL_T h_img);
static INT32 _wzd_country_setting_page_update(BOOL b_repaint);
static VOID _wzd_page_country_sel_box_nfy(
                    UINT32          ui4_msg,
                    VOID*           pv_param1,
                    VOID*           pv_param2);
...
*
----------------------------------------------------------------------------*/
static INT32 _wzd_country_setting_page_sel_box_set_position(VOID)
{
...
static INT32 _wzd_country_setting_page_sel_box_set_align(VOID)
{
    HANDLE_T    h_text_0 = NULL_HANDLE;
    HANDLE_T    h_text_1 = NULL_HANDLE;
    HANDLE_T    h_text_2 = NULL_HANDLE;
...
static INT32 _wzd_country_setting_page_sel_box_set_color(VOID)
{
	WZD_COUNTRY_SETTING_PAGE_DATA_T*   pt_this = &t_g_wzd_country_setting_page_data;
...
static INT32 _wzd_country_setting_page_sel_box_set_font(VOID)
{
    WZD_COUNTRY_SETTING_PAGE_DATA_T*   pt_this = &t_g_wzd_country_setting_page_data;
    HANDLE_T    h_text_0 = NULL_HANDLE;
    HANDLE_T    h_text_1 = NULL_HANDLE;
...
/*----------------------------------------------------------------------------
 * Name: _wzd_country_setting_page_sel_box_hl_theme
 *
 * Description:
 *
 ...
 *
 ----------------------------------------------------------------------------*/
static INT32 _wzd_country_setting_page_sel_box_hl_theme (const UINT32 ui4_btn_idx)
{
...
/*----------------------------------------------------------------------------
 * Name: _wzd_country_setting_page_sel_box_initial_theme
 *
 * Description:
 *
 * Inputs:  ui4_btn_idx		Select box button index
 ...
 *
 ----------------------------------------------------------------------------*/
static INT32 _wzd_country_setting_page_sel_box_initial_theme (const UINT32 ui4_btn_idx)
{
    HANDLE_T                    h_sb_txt = NULL_HANDLE;
	WGL_COLOR_INFO_T  	        t_color_txt;
	WGL_FONT_INFO_T    			t_fnt_info;
...
*
----------------------------------------------------------------------------*/
static INT32 _wzd_country_setting_page_sel_box_update_checkmark(VOID)
{
    WZD_COUNTRY_SETTING_PAGE_DATA_T*	pt_this = &t_g_wzd_country_setting_page_data;
	ACFG_COUNTRY_CODE_T                 e_country_code = ACFG_COUNTRY_CODE_LAST_ENTRY;
    HANDLE_T       						h_icon = NULL_HANDLE;
	HANDLE_T    						h_text = NULL_HANDLE;
    WGL_IMG_INFO_T 						t_img_info = {0};
    UINT16         						ui2_country_select_status = 0;
    GL_RECT_T      						t_rect = {0};
	...
	a_cfg_custom_get_country_select(&ui2_country_select_status);

	if (1 == ui2_country_select_status)
	{
		a_cfg_custom_get_country_code(&e_country_code);
		if (e_country_code == ACFG_COUNTRY_CODE_US)
        {
            ui4_idx = 0;
        }
        else if (e_country_code == ACFG_COUNTRY_CODE_CA)
        {
            ui4_idx = 1;
        }
        else if (e_country_code == ACFG_COUNTRY_CODE_MEX)
        {
            ui4_idx = 2;
        }
...
*
----------------------------------------------------------------------------*/
static INT32 _wzd_country_setting_page_sel_box_set_checkmark(VOID)
{
    WZD_COUNTRY_SETTING_PAGE_DATA_T*	pt_this = &t_g_wzd_country_setting_page_data;
    HANDLE_T       						h_icon = NULL_HANDLE;
	HANDLE_T    						h_text = NULL_HANDLE;
...
static INT32 _wzd_country_setting_page_set_sel_box(VOID)
{
    WZD_COUNTRY_SETTING_PAGE_DATA_T*	pt_this = &t_g_wzd_country_setting_page_data;
    ...
    t_info_data.pf_data_chg_nfy = _wzd_page_country_sel_box_nfy;
    wzd_view_sel_box_set_info_data(&t_info_data);

	/* initialization content */
    a_cfg_custom_get_country_select(&ui2_country_select_status);

    if (0 == ui2_country_select_status)
    {
	...
	_wzd_country_setting_page_sel_box_set_align();
    _wzd_country_setting_page_sel_box_set_position();
	_wzd_country_setting_page_sel_box_set_color();
    _wzd_country_setting_page_sel_box_set_font();
	_wzd_country_setting_page_sel_box_update_checkmark();
...
static INT32 _wzd_country_setting_page_update(BOOL b_repaint)
{
    ...
    _wzd_country_setting_page_set_sel_box();
    ...
    RET_ON_ERR(_wzd_country_setting_page_help_update(WZD_TEXT(MLM_WZD_KEY_COUNTRY_HELP), 
 ...
 /*----------------------------------------------------------------------------
 * Name: _wzd_country_setting_page_help_txt_create
 *
 * Description:
 *
 * Inputs:  -
 ...
 *
 ----------------------------------------------------------------------------*/
static INT32 _wzd_country_setting_page_help_txt_create(VOID)
{
    GL_RECT_T                   t_rect;
    ...
    SET_RECT_BY_SIZE(&t_rect,
                      (INT32)COUNTRY_HELP_HPR_TXT_X,
                      (INT32)COUNTRY_HELP_HPR_TXT_Y,
                      (INT32)COUNTRY_HELP_HPR_TXT_W,
                      (INT32)COUNTRY_HELP_HPR_TXT_H);
...
static UTF16_T* _wzd_country_setting_w2s_sch(UTF16_T*        pw2s_text,
...
/*----------------------------------------------------------------------------
* Name: _wzd_country_setting_page_help_update
*
* Description:
*
* Inputs:  -
                                              ...
                                              WGL_HIMG_TPL_T h_img)
{
    ...
    pw2s_next = _wzd_country_setting_w2s_sch(pw2s_temp, w2s_pic_flag);
    while(pw2s_next)
    {
...
static INT32 _wzd_country_select_proc(VOID)
{
    WZD_COUNTRY_SETTING_PAGE_DATA_T*        pt_this = &t_g_wzd_country_setting_page_data;
    ...
    {
        pt_this->b_show_checkbox = TRUE;
        _wzd_country_setting_page_sel_box_set_checkmark();
    }
    ...
    a_cfg_custom_set_country_select(1);
                     ...
                     VOID*           pv_param2)
{
    ...
    switch(ui4_msg)
    {
        case WZD_SEL_BOX_MSG_ITEM_FOCUSED:
        {
            ...
            _wzd_country_setting_page_sel_box_hl_theme((UINT32)pv_param1);
            _wzd_country_setting_page_sel_box_update_checkmark();
        }
            break;
        ...
        {
            _wzd_country_setting_page_sel_box_initial_theme((UINT32)pv_param1);
        }
            break;
 ...
 *          
 ----------------------------------------------------------------------------*/
static VOID _wzd_page_country_setting_return_nfy_cb(VOID)
{
 ...
 *
 ----------------------------------------------------------------------------*/
static INT32 _wzd_country_setting_page_create(VOID)
{
    c_memset(&t_g_wzd_country_setting_page_data, 0, sizeof(WZD_COUNTRY_SETTING_PAGE_DATA_T));

    RET_ON_ERR(_wzd_country_setting_page_help_txt_create());
 ...
 *
 ----------------------------------------------------------------------------*/
static INT32 _wzd_country_setting_page_dsty(VOID)
{
    WZD_COUNTRY_SETTING_PAGE_DATA_T*        pt_this = &t_g_wzd_country_setting_page_data;
 ...
 *
 ----------------------------------------------------------------------------*/
static INT32 _wzd_country_setting_page_show(
    UINT32                      ui4_page_id
   )
{
    RET_ON_ERR(_wzd_country_setting_page_update(FALSE));
 ...
 *
 ----------------------------------------------------------------------------*/
static INT32 _wzd_country_setting_page_hide(UINT32 ui4_page_id)
{
    return WZDR_OK;
}
 ...
 *
 ----------------------------------------------------------------------------*/
INT32 wzd_country_setting_page_get_page_info_data(WZD_PAGE_INFO_DATA_T* pt_info_data)
{
	...
	pt_info_data->pf_return_nfy_fct        = _wzd_page_country_setting_return_nfy_cb;

    pt_info_data->t_cust_page_fct_tab.pf_wzd_cust_page_create = _wzd_country_setting_page_create;
    pt_info_data->t_cust_page_fct_tab.pf_wzd_cust_page_destory = _wzd_country_setting_page_dsty;
    pt_info_data->t_cust_page_fct_tab.pf_wzd_cust_page_show = _wzd_country_setting_page_show;
    pt_info_data->t_cust_page_fct_tab.pf_wzd_cust_page_hide = _wzd_country_setting_page_hide;
 ...
 *
 ----------------------------------------------------------------------------*/
INT32 wzd_country_setting_page_nfy_sel(UINT16               ui2_sel_idx,
                                  VOID*                 pv_data,
