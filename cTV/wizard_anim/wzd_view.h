...
/* Enum the show type of the select box frm */
typedef enum _WZD_SEL_BOX_SHOW_TYPE_T
{
    WZD_SEL_BOX_SHOW_TYPE_HIDE = 0,
    WZD_SEL_BOX_SHOW_TYPE_NORMAL,
    WZD_SEL_BOX_SHOW_TYPE_ANIM
}WZD_SEL_BOX_SHOW_TYPE_T;
...
extern INT32 wzd_view_main_frm_show_bg_only (VOID);
...
extern INT32 wzd_view_reset_base_frm_rect (VOID);
...
/* Select box widget */
extern BOOL  wzd_view_sel_box_show_finish (VOID);
extern INT32 wzd_view_sel_box_show (WZD_SEL_BOX_SHOW_TYPE_T e_type);
...
extern INT32 wzd_view_sel_box_set_focus (UINT32 ui4_idx, BOOL b_repaint);
extern INT32 wzd_view_sel_box_lose_focus (UINT32 ui4_idx, BOOL b_repaint);
...
extern INT32 wzd_view_sel_box_set_order (HANDLE_T h_handle);
extern INT32 wzd_view_sel_box_flip_order (HANDLE_T h_handle, BOOL b_reverse);
