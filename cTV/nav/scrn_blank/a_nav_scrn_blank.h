 ...
 *
 *---------------------------------------------------------------------------*/
#ifndef _A_SCRN_BLANK_H_
#define _A_SCRN_BLANK_H_
/*-----------------------------------------------------------------------------
                    include files
-----------------------------------------------------------------------------*/
#include "u_common.h"
...
#define SCRN_BLANK_CONTEXT_SWITCH_4_ACTIVE              ((UINT32)0)
#define SCRN_BLANK_CONTEXT_SWITCH_4_RESET               ((UINT32)1)
/*-----------------------------------------------------------------------------
                    functions declarations
-----------------------------------------------------------------------------*/
extern INT32 a_scrn_blank_register(
                    VOID
                    );
extern VOID a_scrn_blank_act(
                    VOID*                       pv_tag1,
                    VOID*                       pv_tag2,
                    VOID*                       pv_tag3);
extern BOOL a_scrn_blank_is_acting(VOID);
extern INT32 a_scrn_blank_reset(VOID);
extern UINT16 a_scrn_blank_get_state(VOID);

#endif /* _A_SCRN_BLANK_H_ */
