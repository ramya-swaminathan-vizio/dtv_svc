 ...
 *
 *---------------------------------------------------------------------------*/
#ifndef _A_SCRN_SVR_H_
#define _A_SCRN_SVR_H_
/*-----------------------------------------------------------------------------
                    include files
-----------------------------------------------------------------------------*/
#include "u_common.h"
...
-----------------------------------------------------------------------------*/
extern INT32 a_scrn_svr_register(
                    VOID
                    );
/*-----------------------------------------------------------------------------
 * Name
 ...
 *---------------------------------------------------------------------------*/
extern INT32 a_scrn_svr_set_enable(
                    BOOL                        b_enable
                    );

extern INT32 a_scrn_svr_get_msgID(INT32*   pi4_msgID);
extern TOAST_STYLE_T a_scrn_svr_get_style();
extern INT32 a_scrn_svr_hide_NO_SIGNAL_1(VOID);


#endif /* _A_SCRN_SVR_H_ */
