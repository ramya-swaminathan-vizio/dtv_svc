 ...
 *---------------------------------------------------------------------------*/
/*-----------------------------------------------------------------------------
 * $RCSfile: closed_captions_view.h$
 * $Revision: #1 $
 * $Date: 2016/03/16 $
 * $Author: sin_fangyuan $
 * $CCRevision:  $
 ...
 *
 *---------------------------------------------------------------------------*/
#ifndef _CLOSED_CAPTIONS_VIEW_H_
#define _CLOSED_CAPTIONS_VIEW_H_
/*-----------------------------------------------------------------------------
                    include files
-----------------------------------------------------------------------------*/
#include "u_iom.h"
...
-----------------------------------------------------------------------------*/
#define     CC_OK                 ((INT32)  0)
#define     CC_FAIL               ((INT32) -1)

typedef struct _CC_CAP_STL_DATA_T
{
...
extern INT32 closed_captions_view_init (
    HANDLE_T            h_canvas,
    VOID*               pv_data);

extern INT32 closed_captions_view_activate(
    VOID*                       pv_data);

extern INT32 closed_captions_view_hide(
    VOID*                       pv_data);

extern INT32 closed_captions_view_deinit(
    VOID*                       pv_data);

extern VOID a_close_caption_init(VOID);

#endif /*_CLOSED_CAPTIONS_VIEW_VIEW_H_ */
