...
# $SWAuthor: Iolo Tsai $
# $MD5HEX: 653f0e1be5fbcee7e031c0bb5fb605d5 $
#
# Description:
#         Clean rules.
#
...
#
.PHONY : clean clean_custom clean_o clean_d clean_lib clean_lint clean_cfg_mak clean_force $(SUB_COMPONENTS) $(OPTIONAL_SUB_COMPONENTS)
...
clean_force : $(SUB_COMPONENTS) $(OPTIONAL_SUB_COMPONENTS)
	...
	@$(RM) $(RM_REC_FLAG) $(call path_cnvt,$(CUSTOM_LIB_DIR)) $(NULL_DEV)


clean clean_custom : clean_o clean_d clean_lint clean_cfg_mak $(SUB_COMPONENTS) $(OPTIONAL_SUB_COMPONENTS)
	$(call if_dir_exist_fct,$(call path_cnvt,$(CUSTOM_LIB_DIR)), \
	    $(RM) $(RM_FLAG) $(call path_cnvt,$(CUSTOM_LIB_DIR)/$(THIS_LIB)) $(NULL_DEV); )


clean_o : $(SUB_COMPONENTS) $(OPTIONAL_SUB_COMPONENTS)
	$(call if_dir_exist_fct,$(call path_cnvt,$(OBJ_DIR)), \
	    $(RM) $(RM_FLAG) $(call path_cnvt,$(ABS_OBJ)) $(NULL_DEV); )
...
clean_lint : $(SUB_COMPONENTS) $(OPTIONAL_SUB_COMPONENTS)
	$(call if_dir_exist_fct,$(call path_cnvt,$(LINT_DIR)), \
	    $(RM) $(RM_FLAG) $(call path_cnvt,$(ABS_LINT_OBJ)) $(call path_cnvt,$(ABS_LINT_CSV)) $(NULL_DEV); )
...
$(SUB_COMPONENTS) $(OPTIONAL_SUB_COMPONENTS) :
	$(call if_dir_exist_fct,$(call path_cnvt,$(call adjust_custom_comp_path,$@)), \
		$(MAKE) $(MAKE_FLAG) -C $(call adjust_custom_comp_path,$@) $(MAKECMDGOALS);)
