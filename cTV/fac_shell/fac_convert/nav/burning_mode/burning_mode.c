 ...
 *---------------------------------------------------------------------------*/
INT32 (*a_burning_mode_register_fac)(VOID);
INT32 (*a_nav_burning_mode_toggle_pattern_fac) (VOID);
/*-----------------------------------------------------------------------------
...
{
    if (a_burning_mode_register_fac != NULL)
    {
        return a_burning_mode_register_fac();
    }
    return NAVR_OK;
}
/*-----------------------------------------------------------------------------
...
{
    if (a_nav_burning_mode_toggle_pattern_fac != NULL)
    {
        return a_nav_burning_mode_toggle_pattern_fac();
    }
    return NAVR_OK;
}
