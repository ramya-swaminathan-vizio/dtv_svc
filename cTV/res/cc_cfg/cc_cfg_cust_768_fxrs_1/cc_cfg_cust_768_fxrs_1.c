 ...
 *---------------------------------------------------------------------------*/
/*-----------------------------------------------------------------------------
 * $RCSfile: cc_cfg_cust_768_fxrs_1.c,v $
 * $Revision: #1 $
 * $Date: 2015/05/29 $
...
BOOL sys_init_cc_font(VOID)
{
    ...
    if(
        (c_fe_add_mem_font(SN_FONT_MONO_SP_SERF,    &(font_file_default [4]), ui4_font_size_tiresias, 29, 32, 36) == FER_OK)  &&
        (c_fe_add_mem_font(SN_FONT_PROP_SP_SERF,    &(font_file_default [4]), ui4_font_size_tiresias, 29, 32, 36) == FER_OK)  &&
        (c_fe_add_mem_font(SN_FONT_MONO_SP_WO_SERF, &(font_file_default [4]), ui4_font_size_tiresias, 29, 32, 36) == FER_OK)  &&
        (c_fe_add_mem_font(SN_FONT_PROP_SP_WO_SERF, &(font_file_default [4]), ui4_font_size_tiresias, 29, 32, 36) == FER_OK)  &&
        (c_fe_add_mem_font(SN_FONT_CASUAL,          &(font_file_default [4]), ui4_font_size_tiresias, 29, 32, 36) == FER_OK)  &&
        (c_fe_add_mem_font(SN_FONT_CURSIVE,         &(font_file_default [4]), ui4_font_size_tiresias, 29, 32, 36) == FER_OK)  &&
        (c_fe_add_mem_font(SN_FONT_SMALL_CAPITALS,  &(font_file_default [4]), ui4_font_size_tiresias, 29, 32, 36) == FER_OK) )
    {
        b_success = TRUE;
    }
