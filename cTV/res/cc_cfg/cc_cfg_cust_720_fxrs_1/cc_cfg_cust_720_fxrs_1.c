 ...
 *---------------------------------------------------------------------------*/
/*-----------------------------------------------------------------------------
 * $RCSfile: cc_cfg_cust_720_fxrs_1.c,v $
 * $Revision: #1 $
 * $Date: 2015/05/29 $
...
BOOL sys_init_cc_font(VOID)
{
    ...
    ( // This is new cfg for as broadcast.
        (c_fe_add_mem_font(SN_FONT_MONO_SP_SERF,    &(font_file_courier10 [4]),    ui4_font_size_courier,        19, 34, 38) == FER_OK)  &&
        (c_fe_add_mem_font(SN_FONT_PROP_SP_SERF,    &(font_file_oranda [4]),       ui4_font_size_oranda,         14, 26, 29) == FER_OK)  &&
        (c_fe_add_mem_font(SN_FONT_MONO_SP_WO_SERF, &(font_file_lettergothic [4]), ui4_font_size_lettergothic,   19, 34, 38) == FER_OK)  &&
        (c_fe_add_mem_font(SN_FONT_PROP_SP_WO_SERF, &(font_file_default [4]),     ui4_font_size_tiresias,       14, 26, 29) == FER_OK)  &&
        (c_fe_add_mem_font(SN_FONT_CASUAL,          &(font_file_misterearl [4]),   ui4_font_size_misterearl,     19, 34, 38) == FER_OK)  &&
        (c_fe_add_mem_font(SN_FONT_CURSIVE,         &(font_file_kaufman [4]),      ui4_font_size_kaufman,        14, 26, 29) == FER_OK)  &&
        (c_fe_add_mem_font(SN_FONT_SMALL_CAPITALS,  &(font_file_copperplate [4]),  ui4_font_size_copperplate,    14, 26, 29) == FER_OK) &&

        // This is new cfg for custom.
        (c_fe_add_mem_font(SN_FONT_MONO_SP_SERF_CUSTOM,    &(font_file_courier10 [4]),    ui4_font_size_courier,         30, 34, 38) == FER_OK)  &&
        (c_fe_add_mem_font(SN_FONT_PROP_SP_SERF_CUSTOM,    &(font_file_oranda [4]),       ui4_font_size_oranda,          23, 26, 29) == FER_OK)  &&
        (c_fe_add_mem_font(SN_FONT_MONO_SP_WO_SERF_CUSTOM, &(font_file_lettergothic [4]), ui4_font_size_lettergothic,    30, 34, 38) == FER_OK)  &&
        (c_fe_add_mem_font(SN_FONT_PROP_SP_WO_SERF_CUSTOM, &(font_file_default [4]),     ui4_font_size_tiresias,        23, 26, 29) == FER_OK)  &&
        (c_fe_add_mem_font(SN_FONT_CASUAL_CUSTOM,          &(font_file_misterearl [4]),   ui4_font_size_misterearl,      30, 34, 38) == FER_OK)  &&
        (c_fe_add_mem_font(SN_FONT_CURSIVE_CUSTOM,         &(font_file_kaufman [4]),      ui4_font_size_kaufman,         23, 26, 29) == FER_OK)  &&
        (c_fe_add_mem_font(SN_FONT_SMALL_CAPITALS_CUSTOM,  &(font_file_copperplate [4]),  ui4_font_size_copperplate,     23, 26, 29) == FER_OK)         
    )  
#else
   
    if(
        (c_fe_add_mem_font(SN_FONT_MONO_SP_SERF,    &(font_file_courier10 [4]),    ui4_font_size_courier,      31, 32, 34) == FER_OK)  &&
        (c_fe_add_mem_font(SN_FONT_PROP_SP_SERF,    &(font_file_oranda [4]),       ui4_font_size_oranda,       33, 34, 36) == FER_OK)  &&
        (c_fe_add_mem_font(SN_FONT_MONO_SP_WO_SERF, &(font_file_lettergothic [4]), ui4_font_size_lettergothic, 31, 32, 34) == FER_OK)  &&
        (c_fe_add_mem_font(SN_FONT_PROP_SP_WO_SERF, &(font_file_default [4]),      ui4_font_size_tiresias,     28, 31, 34) == FER_OK)  &&
        (c_fe_add_mem_font(SN_FONT_CASUAL,          &(font_file_misterearl [4]),   ui4_font_size_misterearl,   31, 32, 33) == FER_OK)  &&
        (c_fe_add_mem_font(SN_FONT_CURSIVE,         &(font_file_kaufman [4]),      ui4_font_size_kaufman,      30, 31, 32) == FER_OK)  &&
        (c_fe_add_mem_font(SN_FONT_SMALL_CAPITALS,  &(font_file_copperplate [4]),  ui4_font_size_copperplate,  35, 36, 38) == FER_OK) )
#endif
    {
        b_success = TRUE;
    }
