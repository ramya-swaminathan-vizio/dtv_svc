...
#ifdef SYS_KOREAN_CC_SUPPORT    
    UINT32 ui4_font_size_koreac_cc_1  = GET_UINT32_FROM_PTR_BIG_END (&(font_file_kr_dotum [0]));
    UINT32 ui4_font_size_koreac_cc_2  = GET_UINT32_FROM_PTR_BIG_END (&(font_file_kr_dotum [0]));
    UINT32 ui4_font_size_koreac_cc_3  = GET_UINT32_FROM_PTR_BIG_END (&(font_file_kr_dotum [0]));
    UINT32 ui4_font_size_koreac_cc_4  = GET_UINT32_FROM_PTR_BIG_END (&(font_file_kr_dotum [0]));
    UINT32 ui4_font_size_koreac_cc_5  = GET_UINT32_FROM_PTR_BIG_END (&(font_file_kr_dotum [0]));
    UINT32 ui4_font_size_koreac_cc_6  = GET_UINT32_FROM_PTR_BIG_END (&(font_file_kr_dotum [0]));
    UINT32 ui4_font_size_koreac_cc_7  = GET_UINT32_FROM_PTR_BIG_END (&(font_file_kr_dotum [0]));
    

    /* font sizes for: 1280 x 720 */
    if(
        (c_fe_add_mem_font(SN_FONT_KOREAN_CC_1,     &(font_file_kr_dotum [4]),      ui4_font_size_koreac_cc_1,  31, 32, 34) == FER_OK)  &&
        (c_fe_add_mem_font(SN_FONT_KOREAN_CC_2,     &(font_file_kr_dotum [4]),      ui4_font_size_koreac_cc_2,  33, 34, 36) == FER_OK)  &&
        (c_fe_add_mem_font(SN_FONT_KOREAN_CC_3,     &(font_file_kr_dotum [4]),      ui4_font_size_koreac_cc_3,  31, 32, 34) == FER_OK)  &&
        (c_fe_add_mem_font(SN_FONT_KOREAN_CC_4,     &(font_file_kr_dotum [4]),      ui4_font_size_koreac_cc_4,  28, 31, 34) == FER_OK)  &&
        (c_fe_add_mem_font(SN_FONT_KOREAN_CC_5,     &(font_file_kr_dotum [4]),      ui4_font_size_koreac_cc_5,  31, 32, 33) == FER_OK)  &&
        (c_fe_add_mem_font(SN_FONT_KOREAN_CC_6,     &(font_file_kr_dotum [4]),      ui4_font_size_koreac_cc_6,  30, 31, 32) == FER_OK)  &&
        (c_fe_add_mem_font(SN_FONT_KOREAN_CC_7,     &(font_file_kr_dotum [4]),      ui4_font_size_koreac_cc_7,  35, 36, 38) == FER_OK)
       )
    {
        b_success = TRUE;
    }
