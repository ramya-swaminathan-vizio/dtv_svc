 ...
 *---------------------------------------------------------------------------*/
/*-----------------------------------------------------------------------------
 * $RCSfile: cc_cfg_demo_1080_fxrs_1.c,v $
 * $Revision: #1 $
 * $Date: 2015/05/29 $
...
BOOL sys_init_cc_font(VOID)
{
    ...
    if(
        (c_fe_add_mem_font(SN_FONT_MONO_SP_SERF,    &(font_file_courier10 [4]),    ui4_font_size_courier,      47, 49, 50) == FER_OK)  &&
        (c_fe_add_mem_font(SN_FONT_PROP_SP_SERF,    &(font_file_oranda [4]),       ui4_font_size_oranda,       50, 52, 53) == FER_OK)  &&
        (c_fe_add_mem_font(SN_FONT_MONO_SP_WO_SERF, &(font_file_lettergothic [4]), ui4_font_size_lettergothic, 47, 49, 50) == FER_OK)  &&
        (c_fe_add_mem_font(SN_FONT_PROP_SP_WO_SERF, &(font_file_default [4]),     ui4_font_size_tiresias,     42, 45, 49) == FER_OK)  &&
        (c_fe_add_mem_font(SN_FONT_CASUAL,          &(font_file_misterearl [4]),   ui4_font_size_misterearl,   47, 48, 49) == FER_OK)  &&
        (c_fe_add_mem_font(SN_FONT_CURSIVE,         &(font_file_kaufman [4]),      ui4_font_size_kaufman,      47, 48, 49) == FER_OK)  &&
        (c_fe_add_mem_font(SN_FONT_SMALL_CAPITALS,  &(font_file_copperplate [4]),  ui4_font_size_copperplate,  53, 54, 56) == FER_OK) )
    {
        b_success = TRUE;
    }
...
BOOL sys_init_cc_font(VOID)
{
    ...
    /* font size for 1280x720 */
    if(
        (c_fe_add_mem_font(SN_FONT_MONO_SP_SERF,    &(font_file_default [4]), ui4_font_size_tiresias, 28, 31, 34) == FER_OK)  &&
        (c_fe_add_mem_font(SN_FONT_PROP_SP_SERF,    &(font_file_default [4]), ui4_font_size_tiresias, 28, 31, 34) == FER_OK)  &&
        (c_fe_add_mem_font(SN_FONT_MONO_SP_WO_SERF, &(font_file_default [4]), ui4_font_size_tiresias, 28, 31, 34) == FER_OK)  &&
        (c_fe_add_mem_font(SN_FONT_PROP_SP_WO_SERF, &(font_file_default [4]), ui4_font_size_tiresias, 28, 31, 34) == FER_OK)  &&
        (c_fe_add_mem_font(SN_FONT_CASUAL,          &(font_file_default [4]), ui4_font_size_tiresias, 28, 31, 34) == FER_OK)  &&
        (c_fe_add_mem_font(SN_FONT_CURSIVE,         &(font_file_default [4]), ui4_font_size_tiresias, 28, 31, 34) == FER_OK)  &&
        (c_fe_add_mem_font(SN_FONT_SMALL_CAPITALS,  &(font_file_default [4]), ui4_font_size_tiresias, 28, 31, 34) == FER_OK) )
    {
        b_success = TRUE;
    }
