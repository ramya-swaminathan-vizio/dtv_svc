...
#include "wizard/page/wzd_page_connected_tv.h"
...
#include "wizard/page/wzd_page_wifi_remote_paring.h"
...
#include "wizard/page/wzd_page_connected_tv.h"
#else
#include "wizard/page/wzd_page_connected_tv_country_code.h"
#endif
...
INT32 wzd_custom_pause (VOID)
{
    ...
    if (i4_ret != APP_CFGR_OK)
    {
        DBG_LOG_PRINT(("<WZD> %s, %d update dimming Fail=%d\n",__FUNCTION__,__LINE__,i4_ret));
    }
    #if 0
