 ...
 *---------------------------------------------------------------------------*/
#ifndef _ACFG_CUST_BLEGATT_H_
#define _ACFG_CUST_BLEGATT_H_
...
-----------------------------------------------------------------------------*/
#define IDX_CUSTOM_BLEGATT_MAC_ADDR_END     (IDX_CUSTOM_BLEGATT_MAC_ADDR_69+1)

#define BLEGATT_MAC_ADDR_DEF                "000000000000"

/* b_is_IOS + ui_target_ID + c_mac_address */
#define BLEGATT_MAC_ADDR_ELEM_SIZE  (1+1+(MAC_ADDRESS_LENGTH_LEN + 1))
