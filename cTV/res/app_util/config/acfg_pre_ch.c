...
#define _ACFG_PRE_CH_ANA_INFO_FMT_          "\r\n\t{%-8d, %-10d,%-3d,%-3d,%-3d,%-3d,%-3d,%-3d,%-3d,%-3d,%-3d,%-3d,%-3d,%-3d,%-3d,%-3d,%-3d,%-3d,%-3d,%-3d,\"%s\", %s, %s} ,"

#define _ACFG_PRE_CH_DIG_INFO_FMT_          "\r\n\t{%-8d, %-10d, %-4d,\"%s\",%s, %-9s, 0x%-04x, 0x%-04x, 0x%-04x, 0x%0-4x, 0x%0-4x, %s} ,"
...
if(expr != 0) \
{ \
Printf ("<Acfg_pre_ch> ERR: file = %s, line = %d, reason = %d\n\r", __FILE__, __LINE__, expr); \
return -1; \
} \
}

#define BREAK_ON_ERR(_expr) \
{ \
INT32 expr = _expr; \
if(expr != 0) \
{ \
...
{   
        ...
        BRDCST_TYPE_ANALOG == pt_svl_rec->uheader.t_rec_hdr.e_brdcst_type)
    {
        ...
        c_snprintf (s_buff ,MAX_OUTPUT_LEN -1 ,_ACFG_PRE_CH_ANA_INFO_FMT_ ,
                    ...
                    b_cable ? t_tsl_rec.udata.t_cab_ana.ui4_tv_sys_mask : t_tsl_rec.udata.t_ter_ana.ui4_tv_sys_mask,
                    b_cable ? t_tsl_rec.udata.t_cab_ana.e_mod : t_tsl_rec.udata.t_ter_ana.e_mod ,
                    b_cable ? t_tsl_rec.udata.t_cab_ana.b_no_disc_nfy : t_tsl_rec.udata.t_ter_ana.b_no_disc_nfy ,
                    b_cable ? t_tsl_rec.udata.t_cab_ana.ui4_central_freq : t_tsl_rec.udata.t_ter_ana.ui4_central_freq ,
                    ...
                    pt_svl_rec->uheader.t_rec_hdr.e_serv_type,
