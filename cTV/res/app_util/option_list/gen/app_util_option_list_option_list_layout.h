 ...
 *---------------------------------------------------------------------------*/
#ifndef __APP_UTIL_OPTION_LIST_OPTION_LIST_LAYOUT_H__
#define __APP_UTIL_OPTION_LIST_OPTION_LIST_LAYOUT_H__
...
#include "app_util_option_list_gen_img.h"
#include "app_util_option_list_gen_clr.h"
#include "app_util_option_list_mlm.h"
#include "app_util_option_list_gen_font_info.h"
...
enum
{
    ...
    WID_APP_UTIL_OPTION_LIST_OPTION_LIST_TOTAL_COUNT
};

INT32 app_util_option_list_option_list_clr_wgt_cb(VOID);
INT32 app_util_option_list_option_list_reg_wgt_cb(UINT32 e_widget_id, wgl_widget_proc_fct p_cb);
...
INT32 app_util_option_list_option_list_create_ui_mi(HANDLE_T h_container, WDK_UI_MI_T *ph_mi);
HANDLE_T app_util_option_list_option_list_get_wgt_hdl_mi(UINT32 e_widget_id, WDK_UI_MI_T h_mi);
INT32 app_util_option_list_option_list_update_text_mi(UINT16 ui2_lang, WDK_UI_MI_T t_mi);
INT32 app_util_option_list_option_list_destroy_ui_mi(WDK_UI_MI_T h_mi);

#endif /* __APP_UTIL_OPTION_LIST_OPTION_LIST_LAYOUT_H__ */
