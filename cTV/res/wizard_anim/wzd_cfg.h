...
#define WZD_SB_SCALE_DOWN_BTN_W             (506 * WZD_UI_RATIO_W)
#define WZD_SB_SCALE_DOWN_BTN_H             (470 * WZD_UI_RATIO_W)

#define WZD_SB_SCALE_UP_BTN_W               (799 * WZD_UI_RATIO_W)
#define WZD_SB_SCALE_UP_BTN_H               (742 * WZD_UI_RATIO_W)

#define WZD_SMALL_SEL_BOX_BTN_W             (410 * WZD_UI_RATIO_W)
#define WZD_SMALL_SEL_BOX_BTN_H             (386 * WZD_UI_RATIO_W)

#define WZD_SMALL_SB_SCALE_DOWN_BTN_W       (295 * WZD_UI_RATIO_W)
#define WZD_SMALL_SB_SCALE_DOWN_BTN_H       (278 * WZD_UI_RATIO_W)
