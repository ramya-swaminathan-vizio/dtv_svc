...
/* image definitions */
#include "res/wizard_anim/wzd_img_2013.i"
...
WGL_HIMG_TPL_T      h_g_wzd_img_select_box_highlight_small;
...
WGL_HIMG_TPL_T      h_g_wzd_img_selectbox_small_hlt_small; /*for animation change image*/
...
INT32 wzd_image_init (VOID)
{
    ...
    RET_ON_ERR (c_wgl_img_tpl_create (WGL_IMG_ST_NO_SEGMENT,
                                      & t_g_wzd_img_select_box_highlight_small,
                                      & h_g_wzd_img_select_box_highlight_small));
    ...
    /*for animation change image*/
    RET_ON_ERR (c_wgl_img_tpl_create (WGL_IMG_ST_NO_SEGMENT,
                                      & t_g_wzd_img_selectbox_small_hlt_small,
                                      & h_g_wzd_img_selectbox_small_hlt_small)); 
