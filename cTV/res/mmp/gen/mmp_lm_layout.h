 ...
 *---------------------------------------------------------------------------*/
#ifndef __MMP_LM_LAYOUT_H__
#define __MMP_LM_LAYOUT_H__
...
enum
{
    ...
    WID_MMP_LM_TOTAL_COUNT
};

INT32 mmp_lm_clr_wgt_cb(VOID);
INT32 mmp_lm_reg_wgt_cb(UINT32 e_widget_id, wgl_widget_proc_fct p_cb);
...
INT32 mmp_lm_create_ui_mi(HANDLE_T h_container, WDK_UI_MI_T *ph_mi);
HANDLE_T mmp_lm_get_wgt_hdl_mi(UINT32 e_widget_id, WDK_UI_MI_T h_mi);
INT32 mmp_lm_update_text_mi(UINT16 ui2_lang, WDK_UI_MI_T t_mi);
INT32 mmp_lm_destroy_ui_mi(WDK_UI_MI_T h_mi);

#endif /* __MMP_LM_LAYOUT_H__ */
