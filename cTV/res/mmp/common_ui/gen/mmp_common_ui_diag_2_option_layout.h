 ...
 *---------------------------------------------------------------------------*/
#ifndef __MMP_COMMON_UI_DIAG_2_OPTION_LAYOUT_H__
#define __MMP_COMMON_UI_DIAG_2_OPTION_LAYOUT_H__
...
#include "mmp_common_ui_gen_img.h"
#include "mmp_common_ui_gen_clr.h"
#include "mmp_common_ui_mlm.h"
#include "mmp_common_ui_gen_font_info.h"
...
enum
{
    ...
    WID_MMP_COMMON_UI_DIAG_2_OPTION_TOTAL_COUNT
};

INT32 mmp_common_ui_diag_2_option_clr_wgt_cb(VOID);
INT32 mmp_common_ui_diag_2_option_reg_wgt_cb(UINT32 e_widget_id, wgl_widget_proc_fct p_cb);
...
INT32 mmp_common_ui_diag_2_option_create_ui_mi(HANDLE_T h_container, WDK_UI_MI_T *ph_mi);
HANDLE_T mmp_common_ui_diag_2_option_get_wgt_hdl_mi(UINT32 e_widget_id, WDK_UI_MI_T h_mi);
INT32 mmp_common_ui_diag_2_option_update_text_mi(UINT16 ui2_lang, WDK_UI_MI_T t_mi);
INT32 mmp_common_ui_diag_2_option_destroy_ui_mi(WDK_UI_MI_T h_mi);

#endif /* __MMP_COMMON_UI_DIAG_2_OPTION_LAYOUT_H__ */
