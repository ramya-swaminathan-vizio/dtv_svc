                    ...
                    )
{
	...
	i4_ret = nav_img_create_default_btn_hlt_bk_img_tpl(&pt_rc->h_btn_img_bk_hlt);
    if (i4_ret != NAVR_OK) {
  	  return NAVR_FAIL;
    }

	i4_ret = nav_img_create_default_btn_bk_img_tpl(&pt_rc->h_btn_img_bk);
	if (i4_ret != NAVR_OK) {
	  return NAVR_FAIL;
	}
