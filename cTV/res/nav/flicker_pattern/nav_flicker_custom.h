 ...
 *---------------------------------------------------------------------------*/
/*-----------------------------------------------------------------------------
 * $RCSfile: nav_flicker_custom.h,v $
 * $Revision: #1 $
 * $Date: 2015/05/29 $
 ...
 *
 *---------------------------------------------------------------------------*/
#ifndef _NAV_FLICKER_CUSTOM_H_
#define _NAV_FLICKER_CUSTOM_H_
...
#define BTN_INVOKE_FLICKER  BTN_FACTORY_MODE_8
#endif
/*-----------------------------------------------------------------------------
