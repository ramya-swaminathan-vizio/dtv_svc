...
/*-----------------------------------------------------------------------------
 ...
 ----------------------------------------------------------------------------*/
#define VCOM_GAMMA1_REG         0x00
#define VCOM_GAMMA2_REG         0x01
#define VCOM_GAMMA3_REG         0x02
#define VCOM_GAMMA4_REG         0x03
#define VCOM_GAMMA5_REG         0x04
#define VCOM_GAMMA6_REG         0x05
#define VCOM_GAMMA7_REG         0x06
#define VCOM_GAMMA8_REG         0x07
    
#define VCOM_REG_INVALID        0xFF
    
#define FAC_VCOM_REG           0x12
#define FAC_VCOM_MIN_REG       0x1E
#define FAC_VCOM_MAX_REG       0x1F

#define VCOM_GAIN_REG          0x1C //sam 101124
...
#define VCOM_I2C_SLV_ADDR    0xE8

/*-----------------------------------------------------------------------------
 * structure, constants, macro definitions
 *---------------------------------------------------------------------------*/
UINT16  ui2_BUF08630_VCOM_DAC_value = 0x100;
UINT16  ui2_BUF08630_VCOM_DAC_min_value = 0;
UINT16  ui2_BUF08630_VCOM_DAC_max_value = 0x1ff;
...
/*----------------------------------------------------------------------------
* Name: _nav_fac_BUF08630_check_vcom_range
* Description:
* Inputs:
* Outputs:
* Returns:
----------------------------------------------------------------------------*/
static BOOL _nav_fac_BUF08630_check_vcom_range(VOID)
{
    ...
    for(ui2_i=0; ui2_i<ui2_size_of_def_table; ui2_i++)
    {
        if(ui4_panel_id==_ar_Fac_TCON_Default_Table[ui2_i].u4PanelIndex){
            ui2_BUF08630_VCOM_DAC_min_value = _ar_Fac_TCON_Default_Table[ui2_i].ui2_vcom_min;
            ui2_BUF08630_VCOM_DAC_max_value = _ar_Fac_TCON_Default_Table[ui2_i].ui2_vcom_max;
            break;
        }
    }

    i4_ret = nav_fac_BUF08630_get_vcom_reg_val(&ui2_vcom_val);
    TCON_CHK_FAIL(i4_ret);

    if(ui2_vcom_val < ui2_BUF08630_VCOM_DAC_min_value)
    {
        return TRUE;
    }
    else if(ui2_vcom_val > ui2_BUF08630_VCOM_DAC_max_value)
    {
        return TRUE;
    }
...
/*----------------------------------------------------------------------------
* Name: _nav_fac_BUF08630_set_vcom_max_min
* Description:
* Inputs:
* Outputs:
* Returns:
----------------------------------------------------------------------------*/
static INT32 _nav_fac_BUF08630_set_vcom_max_min(VOID)
{
    INT32 i4_ret = TCON_OK;

    // Set the value to valid memory
    i4_ret = _nav_fac_set_tcon_reg_val(FAC_VCOM_MIN_REG, ui2_BUF08630_VCOM_DAC_min_value);
    TCON_CHK_FAIL(i4_ret);
    
    i4_ret = _nav_fac_set_tcon_reg_val(FAC_VCOM_MAX_REG, ui2_BUF08630_VCOM_DAC_max_value);
    TCON_CHK_FAIL(i4_ret);

    // Set the value to nonvolatile memory
    i4_ret = _nav_fac_set_tcon_mtp(FAC_VCOM_MIN_REG, ui2_BUF08630_VCOM_DAC_min_value);
    TCON_CHK_FAIL(i4_ret);
    
    i4_ret = _nav_fac_set_tcon_mtp(FAC_VCOM_MAX_REG, ui2_BUF08630_VCOM_DAC_max_value);
    TCON_CHK_FAIL(i4_ret);
...
/*----------------------------------------------------------------------------
* Name: nav_fac_BUF08630_get_tcon_gamma_reg_val
* Description: Get value from register of Gamma1/Gamma2/.../Gamma8.
* Inputs:  ui1_gamma       -    Range is from 0 to 7. Represent Gamma1 to Gamma 8.
* Outputs: *pui2_vcom_val  -    current VCOM value.
* Returns:
----------------------------------------------------------------------------*/
INT32 nav_fac_BUF08630_get_tcon_gamma_reg_val(UINT8 ui1_gamma, UINT16 *pui2_vcom_val )
{
    INT32 i4_ret = TCON_OK;
    UINT8 ui1_gamma_reg = VCOM_GAMMA1_REG;
...
/*----------------------------------------------------------------------------
* Name: nav_fac_BUF08630_set_tcon_gamma_reg_val
...
* Returns:
----------------------------------------------------------------------------*/
INT32 nav_fac_BUF08630_set_tcon_gamma_reg_val(UINT8 ui1_gamma, UINT16 ui2_gamma_val )
{
    INT32 i4_ret = TCON_OK;
    UINT8 ui1_gamma_reg = VCOM_GAMMA1_REG;
...
/*----------------------------------------------------------------------------
* Name: nav_fac_BUF08630_get_vcom_reg_val
* Description: Get the Vcom value from Vcom register.
* Inputs:
* Outputs: *pui2_vcom_val      current VCOM value
* Returns:
----------------------------------------------------------------------------*/
INT32 nav_fac_BUF08630_get_vcom_reg_val( UINT16 *pui2_vcom_val )
{
    INT32 i4_ret = TCON_OK;
    ...
    if( i4_ret == TCON_OK )
    {
        ui2_BUF08630_VCOM_DAC_value = *pui2_vcom_val;
    }

    return i4_ret;
}
/*----------------------------------------------------------------------------
* Name: nav_fac_BUF08630_get_vcom_gain_reg_val
...
----------------------------------------------------------------------------*/
//sam 101124
INT32 nav_fac_BUF08630_get_vcom_gain_reg_val( UINT16 *pui2_vcom_gain_val )
{
    INT32 i4_ret = TCON_OK;
...
/*----------------------------------------------------------------------------
* Name: nav_fac_BUF08630_set_vcom_reg_val
* Description: Set Vcom value to register.
* Inputs: ui2_vcom_val     new VCOM reg. value
* Outputs:
* Returns:
----------------------------------------------------------------------------*/
INT32 nav_fac_BUF08630_set_vcom_reg_val( UINT16 ui2_vcom_val )
{
    INT32 i4_ret = TCON_OK;
    ...
    if( i4_ret == TCON_OK )
    {
        ui2_BUF08630_VCOM_DAC_value = ui2_vcom_val;
    }
...
* Returns:
----------------------------------------------------------------------------*/
INT32 nav_fac_BUF08630_store_vcom_val ( void )
{
    INT32   i4_ret = TCON_OK;
    ...
    i4_ret = _nav_fac_set_tcon_mtp( FAC_VCOM_REG, ui2_BUF08630_VCOM_DAC_value );
    if( i4_ret != TCON_OK )
    {
...
/*----------------------------------------------------------------------------
* Name: nav_fac_BUF08630_get_def_gamma_by_panel_id
...
* Returns:
----------------------------------------------------------------------------*/
INT32 nav_fac_BUF08630_get_def_gamma_by_panel_id(UINT32 ui4_panel_id, UINT8 ui1_gamma, UINT16 *pui2_gamma_val_def)
{
    UINT16 ui2_size_of_def_table = sizeof(_ar_Fac_TCON_Default_Table)/sizeof(NAV_FAC_TCON_DEFAULT_T);
    UINT16 ui2_i;
...
/*----------------------------------------------------------------------------
* Name: nav_fac_BUF08630_get_def_vcom_by_panel_id
* Description: Get default Vcom value by panel ID.
* Inputs:
* Outputs: *pui2_vcom_def    -    default Vcom reg. value
* Returns:
----------------------------------------------------------------------------*/
INT32 nav_fac_BUF08630_get_def_vcom_by_panel_id(UINT16 *pui2_vcom_def)
{
...
/*----------------------------------------------------------------------------
* Name: nav_fac_BUF08630_get_def_vcom_gain_by_panel_id
...
----------------------------------------------------------------------------*/
//sam 101124
INT32 nav_fac_BUF08630_get_def_vcom_gain_by_panel_id(UINT16 *pui2_vcom_gain_def)
{
    UINT32 ui4_panel_id = 0;
    UINT16 ui2_size_of_def_table = sizeof(_ar_Fac_TCON_Default_Table)/sizeof(NAV_FAC_TCON_DEFAULT_T);
    UINT16 ui2_i;
...
/*----------------------------------------------------------------------------
* Name: nav_fac_BUF08630_load_def_gamma_by_panel_id
* Description: Load default value of Gamma1/Gamma2/.../Gamma8 into register. But not write into MTP.
* Inputs: ui1_gamma    -    Range is from 0 to 7. Represent Gamma1 to Gamma 8.
* Outputs:
* Returns:
----------------------------------------------------------------------------*/
INT32 nav_fac_BUF08630_load_def_gamma_by_panel_id(UINT8 ui1_gamma)
{
    INT32 i4_ret = TCON_OK;
    UINT8 ui1_gamma_reg = VCOM_GAMMA1_REG;
    ...
    i4_ret = nav_fac_BUF08630_get_def_gamma_by_panel_id(ui4_panel_id, ui1_gamma, &ui2_gamma_def);
    TCON_CHK_FAIL(i4_ret);
...
/*----------------------------------------------------------------------------
* Name: nav_fac_BUF08630_load_def_vcom_by_panel_id
* Description: Load default Vcom value to register. But not write into MTP.
* Inputs:
* Outputs:
* Returns:
----------------------------------------------------------------------------*/
INT32 nav_fac_BUF08630_load_def_vcom_by_panel_id(VOID)
{
    INT32       i4_ret = TCON_OK;
    UINT16      ui2_vcom_def= 512;

    nav_fac_BUF08630_get_def_vcom_by_panel_id(&ui2_vcom_def);
...
/*----------------------------------------------------------------------------
* Name: nav_fac_BUF08630_write_def_gamma_by_panel_id
* Description: Write default Gamma value to MTP. It's non-volatile storage.
* Inputs: ui1_gamma    -    Range is from 0 to 7. Represent Gamma1 to Gamma 8.
* Outputs:
* Returns:
----------------------------------------------------------------------------*/
INT32 nav_fac_BUF08630_write_def_gamma_by_panel_id(UINT8 ui1_gamma)
{
    INT32 i4_ret = TCON_OK;
...
/*----------------------------------------------------------------------------
* Name: nav_fac_BUF08630_tcon_write_gamma
* Description: Write to reg of Gamma1/Gamma2/../Gamma8.
* Inputs: ui1_gamma    -    Range is from 0 to 7. Represent Gamma1 to Gamma 8.
* Outputs:
* Returns:
----------------------------------------------------------------------------*/
INT32 nav_fac_BUF08630_tcon_write_gamma(UINT8 ui1_gamma)
{
    INT32 i4_ret = TCON_OK;
    UINT8 ui1_gamma_reg = VCOM_GAMMA1_REG;
...
/*----------------------------------------------------------------------------
* Name: nav_fac_BUF08630_add_vcom_reg_offset
...
* Returns:
----------------------------------------------------------------------------*/
INT32 nav_fac_BUF08630_add_vcom_reg_offset ( INT16 i2_offset_val )
{
    INT32   i4_ret;
    UINT16  ui2_val=0;
    ...
    ui2_val = (UINT16)((INT16)ui2_BUF08630_VCOM_DAC_value + i2_offset_val);
    if( ui2_val < ui2_BUF08630_VCOM_DAC_min_value )
    {
        ui2_val = ui2_BUF08630_VCOM_DAC_min_value ;
    }
    else if( ui2_val > ui2_BUF08630_VCOM_DAC_max_value )
    {
        ui2_val = ui2_BUF08630_VCOM_DAC_max_value ;
    }

    i4_ret = nav_fac_BUF08630_set_vcom_reg_val( ui2_val );
    if( i4_ret != TCON_OK )
    {
        DBG_LOG_PRINT(("nav_fac_BUF08630_set_vcom_reg_val() failed. i4_ret = %d on nav_fac_add_vcom_reg_offset() at line %d of %s.\r\n", i4_ret, __LINE__, __FILE__));
        return TCON_WRITE_FAIL;
    }
...
/*----------------------------------------------------------------------------
* Name: nav_fac_BUF08630_end_vcom_alignment
...
* Returns:
----------------------------------------------------------------------------*/
INT32 nav_fac_BUF08630_end_vcom_alignment ( void )
{
    INT32   i4_ret;
...
* Returns:
----------------------------------------------------------------------------*/
INT32 nav_fac_BUF08630_write_def_vcom_by_panel_id(VOID)
{
...
----------------------------------------------------------------------------*/
//sam 101124
INT32 nav_fac_BUF08630_write_def_vcom_gain_by_panel_id(VOID)
{
    INT32 i4_ret = APP_CFGR_INTERNAL_ERR;

    UINT16 ui2_vcom_gain_def = 1;

    nav_fac_BUF08630_get_def_vcom_gain_by_panel_id(&ui2_vcom_gain_def);
...
* Returns:
----------------------------------------------------------------------------*/
INT32 nav_fac_BUF08630_tcon_check_and_set_def_val(VOID)
{
    INT32   i4_ret = APP_CFGR_INTERNAL_ERR;
    UINT8   ui1_i;
    ...
    for(ui1_i=0; ui1_i<8; ui1_i++)
    {
        ...
        i4_ret = nav_fac_BUF08630_get_tcon_gamma_reg_val( ui1_i, &ui2_gamma_val[ui1_i] );
        TCON_CHK_FAIL(i4_ret);
 
        i4_ret = nav_fac_BUF08630_get_def_gamma_by_panel_id(ui4_panel_id, ui1_i, &ui2_gamma_def);
        TCON_CHK_FAIL(i4_ret);
    ...
    b_vcom_is_over = _nav_fac_BUF08630_check_vcom_range();

    if(b_vcom_is_over == TRUE)
    {
        //Set Vom Max & Min.
        _nav_fac_BUF08630_set_vcom_max_min();
    }
    ...
    if(b_Gamma_is_default == FALSE)
    {
        /* Vcom */
        {
            ...
            do
            {
                ...
                i4_ret = nav_fac_BUF08630_get_def_vcom_by_panel_id(&ui2_vcom_def);
                TCON_CHK_FAIL(i4_ret);
                ...
                {
                    /* Write default Vcom */
                    nav_fac_BUF08630_write_def_vcom_by_panel_id();
                    ui1_cnt++;
                }
                else
                {
        ...
        /* Vcom Gain */ //sam 101124
        {
            ...
            do
            {
                ...
                i4_ret = nav_fac_BUF08630_get_vcom_gain_reg_val(&ui2_vcom_gain_val );
                TCON_CHK_FAIL(i4_ret);
                
                i4_ret = nav_fac_BUF08630_get_def_vcom_gain_by_panel_id(&ui2_vcom_gain_def);
                TCON_CHK_FAIL(i4_ret);
                ...
                if(ui2_vcom_gain_val != ui2_vcom_gain_def)
                {
                    ...
                    nav_fac_BUF08630_write_def_vcom_gain_by_panel_id();
                    ui1_cnt++;
                }
                else
                {
        ...
        for(ui1_i=0; ui1_i<8; ui1_i++)
        {
            ...
            do
            {
                ...
                if(ui2_gamma_val[ui1_i] != ui2_gamma_def)
                {
                    /* Write default Gamma */
                    ui1_cnt++;
                    i4_ret = nav_fac_BUF08630_write_def_gamma_by_panel_id(ui1_i);
                    TCON_CHK_FAIL(i4_ret);
                }
                else
                {
...
/*----------------------------------------------------------------------------
* Name: nav_fac_BUF08630_get_vcom_max_min_val
* Description:
* Inputs:
* Outputs:
* Returns:
----------------------------------------------------------------------------*/
INT32 nav_fac_BUF08630_get_vcom_max_min_val(UINT16* i2_max, UINT16* i2_min)
{
    INT32 i4_ret = TCON_OK;
...
/*----------------------------------------------------------------------------
* Name: nav_fac_BUF08630_tcon_check_panel
* Description:
* Inputs:
* Outputs:
* Returns:
----------------------------------------------------------------------------*/
BOOL nav_fac_BUF08630_tcon_check_panel(VOID)
{
    UINT32 ui4_panel_id;
    UINT16 ui2_i;
    UINT16 ui2_size_of_def_table = sizeof(_ar_Fac_TCON_Default_Table)/sizeof(NAV_FAC_TCON_DEFAULT_T);
...
/*----------------------------------------------------------------------------
* Name: nav_fac_BUF08630_tcon_is_existed
* Description:
* Inputs:
* Outputs:
* Returns:
----------------------------------------------------------------------------*/
BOOL nav_fac_BUF08630_tcon_is_existed(VOID)
{
    UINT8   ui1_buffer[8];
    INT32 i4_ret;
