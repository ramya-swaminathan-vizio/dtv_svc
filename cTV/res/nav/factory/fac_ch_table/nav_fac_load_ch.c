...
static TSL_DATA_T    t_tsl_table_XM_antenna[] =
{
    /* tsl_rec_id, bcst_type, bcst_medium, nw_id, on_id, ts_id,   flags, freq,  bandwidth, mod */
    {0x2   ,	BRDCST_TYPE_ATSC,	BRDCST_MEDIUM_DIG_TERRESTRIAL,	0,	2,	3401,	0,	57000000,	BW_UNKNOWN,	MOD_VSB_8},
    ...
    {0x2a  ,	BRDCST_TYPE_ATSC,	BRDCST_MEDIUM_DIG_TERRESTRIAL,	0,	42,	2083,	0,	641000000,	BW_UNKNOWN,	MOD_VSB_8},
    {0x2a  ,	BRDCST_TYPE_ATSC,	BRDCST_MEDIUM_DIG_TERRESTRIAL,	0,	42,	2083,	0,	641000000,	BW_UNKNOWN,	MOD_VSB_8},
    {0x2a  ,	BRDCST_TYPE_ATSC,	BRDCST_MEDIUM_DIG_TERRESTRIAL,	0,	42,	2083,	0,	641000000,	BW_UNKNOWN,	MOD_VSB_8},
    {0x800e,	BRDCST_TYPE_ANALOG,	BRDCST_MEDIUM_ANA_TERRESTRIAL,	0,	0,	0,	0,	471250000,	BW_UNKNOWN,	MOD_PSK_8},
    {0x8010,	BRDCST_TYPE_ANALOG,	BRDCST_MEDIUM_ANA_TERRESTRIAL,	0,	0,	0,	0,	481250000,	BW_UNKNOWN,	MOD_PSK_8},
    {0x19  ,	BRDCST_TYPE_ATSC,	BRDCST_MEDIUM_DIG_TERRESTRIAL,	0,	25,	13124,	0,	539000000,	BW_UNKNOWN,	MOD_VSB_8},
    {0x19  ,	BRDCST_TYPE_ATSC,	BRDCST_MEDIUM_DIG_TERRESTRIAL,	0,	25,	13124,	0,	539000000,	BW_UNKNOWN,	MOD_VSB_8},
    {0x801e,	BRDCST_TYPE_ANALOG,	BRDCST_MEDIUM_ANA_TERRESTRIAL,	0,	0,	0,	0,	567250000,	BW_UNKNOWN,	MOD_PSK_8},
    {0x8025,	BRDCST_TYPE_ANALOG,	BRDCST_MEDIUM_ANA_TERRESTRIAL,	0,	0,	0,	0,	607250000,	BW_UNKNOWN,	MOD_PSK_8},
    {0x8026,	BRDCST_TYPE_ANALOG,	BRDCST_MEDIUM_ANA_TERRESTRIAL,	0,	0,	0,	0,	615250000,	BW_UNKNOWN,	MOD_PSK_8},
    {0x402a,	BRDCST_TYPE_ATSC,	BRDCST_MEDIUM_DIG_TERRESTRIAL,	0,	42,	2083,	0,	641000000,	BW_UNKNOWN,	MOD_VSB_8},
    {0x402a,	BRDCST_TYPE_ATSC,	BRDCST_MEDIUM_DIG_TERRESTRIAL,	0,	42,	2083,	0,	641000000,	BW_UNKNOWN,	MOD_VSB_8},
    {0x402a,	BRDCST_TYPE_ATSC,	BRDCST_MEDIUM_DIG_TERRESTRIAL,	0,	42,	2083,	0,	641000000,	BW_UNKNOWN,	MOD_VSB_8},
...
static TSL_DATA_T    t_tsl_table_XM_cable[] =
{
    /* tsl_rec_id, bcst_type, bcst_medium, nw_id, on_id, ts_id,   flags, freq,  bandwidth, mod */
    {0x2   ,	BRDCST_TYPE_ATSC,	BRDCST_MEDIUM_DIG_CABLE,	0,	2,	3401,	0,	57000000,	BW_UNKNOWN,	MOD_VSB_8},
    ...
    {0x14  ,	BRDCST_TYPE_ATSC,	BRDCST_MEDIUM_DIG_CABLE,	0,	20,	13124,	0,	159000000,	BW_UNKNOWN,	MOD_QAM_64},
    {0x4f  ,	BRDCST_TYPE_ATSC,	BRDCST_MEDIUM_DIG_CABLE,	0,	79,	2017,	0,	555000000,	BW_UNKNOWN,	MOD_QAM_256},
    {0x8041,	BRDCST_TYPE_ANALOG,	BRDCST_MEDIUM_ANA_CABLE,	0,	0,	0,	0,	471250000,	BW_UNKNOWN,	MOD_PSK_8},
...
static SVL_DATA_T    t_svl_table_XM_antenna[] =
{
    /* channel_num, nw_mask, prog_id, tsl_rec_id, brdcst_type, serv_type, ch_name, tv_sys, audio_sys, vid_color_sys*/
    {0x2000140 ,	0x200000f ,	1,	0x2   ,	BRDCST_TYPE_ATSC,	SVL_SERVICE_TYPE_TV,	"RF2-1",	TV_SYS_MASK_NONE,	AUDIO_SYS_MASK_NONE,	COLOR_SYS_NTSC},
    ...
    {0x280100  ,	0x200000f ,	3,	0x2a  ,	BRDCST_TYPE_ATSC,	SVL_SERVICE_TYPE_TV,	"KLVXHD",	TV_SYS_MASK_NONE,	AUDIO_SYS_MASK_NONE,	COLOR_SYS_NTSC},
    {0x280200  ,	0x200000f ,	4,	0x2a  ,	BRDCST_TYPE_ATSC,	SVL_SERVICE_TYPE_TV,	"KLVXSD1",	TV_SYS_MASK_NONE,	AUDIO_SYS_MASK_NONE,	COLOR_SYS_NTSC},
    {0x280300  ,	0x200000f ,	5,	0x2a  ,	BRDCST_TYPE_ATSC,	SVL_SERVICE_TYPE_TV,	"KLVXSD2",	TV_SYS_MASK_NONE,	AUDIO_SYS_MASK_NONE,	COLOR_SYS_NTSC},
    ...
    {0x400080  ,	0x200000f ,	0,	0x8010,	BRDCST_TYPE_ANALOG,	SVL_SERVICE_TYPE_TV,	"",	TV_SYS_MASK_NONE,	AUDIO_SYS_MASK_NONE,	COLOR_SYS_UNKNOWN},
    {0x19000140,	0x200000f ,	1,	0x19  ,	BRDCST_TYPE_ATSC,	SVL_SERVICE_TYPE_TV,	"RF25-1",	TV_SYS_MASK_NONE,	AUDIO_SYS_MASK_NONE,	COLOR_SYS_NTSC},
    {0x19000240,	0x200000f ,	2,	0x19  ,	BRDCST_TYPE_ATSC,	SVL_SERVICE_TYPE_TV,	"RF25-2",	TV_SYS_MASK_NONE,	AUDIO_SYS_MASK_NONE,	COLOR_SYS_NTSC},
    ...
    {0x2a000640,	0x200000f ,	6,	0x402a,	BRDCST_TYPE_ATSC,	SVL_SERVICE_TYPE_TV,	"RF42-6",	TV_SYS_MASK_NONE,	AUDIO_SYS_MASK_NONE,	COLOR_SYS_NTSC},
    {0x2a000740,	0x200000f ,	7,	0x402a,	BRDCST_TYPE_ATSC,	SVL_SERVICE_TYPE_TV,	"RF42-7",	TV_SYS_MASK_NONE,	AUDIO_SYS_MASK_NONE,	COLOR_SYS_NTSC},
    {0x2a000840,	0x200000f ,	8,	0x402a,	BRDCST_TYPE_ATSC,	SVL_SERVICE_TYPE_TV,	"RF42-8",	TV_SYS_MASK_NONE,	AUDIO_SYS_MASK_NONE,	COLOR_SYS_NTSC},
...
static SVL_DATA_T    t_svl_table_XM_cable[] =
{
    /* channel_num, nw_mask, prog_id, tsl_rec_id, brdcst_type, serv_type, ch_name, tv_sys, audio_sys, vid_color_sys*/
    {0x2000140 ,	0xf       ,	1,	0x2   ,	BRDCST_TYPE_ATSC,	SVL_SERVICE_TYPE_TV,	"RF2-1",	TV_SYS_MASK_NONE,	AUDIO_SYS_MASK_NONE,	COLOR_SYS_NTSC},
    {0xc0080   ,	0xf       ,	0,	0x8003,	BRDCST_TYPE_ANALOG,	SVL_SERVICE_TYPE_TV,	"",	TV_SYS_MASK_NONE,	AUDIO_SYS_MASK_NONE,	COLOR_SYS_UNKNOWN},
    {0x240080  ,	0xf       ,	0,	0x8009,	BRDCST_TYPE_ANALOG,	SVL_SERVICE_TYPE_TV,	"",	TV_SYS_MASK_NONE,	AUDIO_SYS_MASK_NONE,	COLOR_SYS_UNKNOWN},
    {0x14000140,	0xf       ,	1,	0x14  ,	BRDCST_TYPE_ATSC,	SVL_SERVICE_TYPE_TV,	"RF20-1",	TV_SYS_MASK_NONE,	AUDIO_SYS_MASK_NONE,	COLOR_SYS_NTSC},
    {0xa40100  ,	0xf       ,	3,	0x4f  ,	BRDCST_TYPE_ATSC,	SVL_SERVICE_TYPE_TV,	"WXTV-DT",	TV_SYS_MASK_NONE,	AUDIO_SYS_MASK_NONE,	COLOR_SYS_NTSC},
    {0x1040080 ,	0xf       ,	0,	0x8041,	BRDCST_TYPE_ANALOG,	SVL_SERVICE_TYPE_TV,	"",	TV_SYS_MASK_NONE,	AUDIO_SYS_MASK_NONE,	COLOR_SYS_UNKNOWN},
    {0x10c0080 ,	0xf       ,	0,	0x8043,	BRDCST_TYPE_ANALOG,	SVL_SERVICE_TYPE_TV,	"WGBH12",	TV_SYS_MASK_NONE,	AUDIO_SYS_MASK_NONE,	COLOR_SYS_UNKNOWN},
    {0x1440080 ,	0xf       ,	0,	0x8051,	BRDCST_TYPE_ANALOG,	SVL_SERVICE_TYPE_TV,	"",	TV_SYS_MASK_NONE,	AUDIO_SYS_MASK_NONE,	COLOR_SYS_UNKNOWN},
    {0x1600080 ,	0xf       ,	0,	0x8058,	BRDCST_TYPE_ANALOG,	SVL_SERVICE_TYPE_TV,	"",	TV_SYS_MASK_NONE,	AUDIO_SYS_MASK_NONE,	COLOR_SYS_UNKNOWN},
    {0x1640080 ,	0xf       ,	0,	0x8059,	BRDCST_TYPE_ANALOG,	SVL_SERVICE_TYPE_TV,	"",	TV_SYS_MASK_NONE,	AUDIO_SYS_MASK_NONE,	COLOR_SYS_UNKNOWN},
    {0x1880080 ,	0xf       ,	0,	0x8062,	BRDCST_TYPE_ANALOG,	SVL_SERVICE_TYPE_TV,	"",	TV_SYS_MASK_NONE,	AUDIO_SYS_MASK_NONE,	COLOR_SYS_UNKNOWN},
    {0x1dc0080 ,	0xf       ,	0,	0x8077,	BRDCST_TYPE_ANALOG,	SVL_SERVICE_TYPE_TV,	"",	TV_SYS_MASK_NONE,	AUDIO_SYS_MASK_NONE,	COLOR_SYS_UNKNOWN},
};
...
INT32 acfg_SAC_dump_channel_info(VOID)
{
    ...
    DBG_LOG_PRINT(("\n\nacfg_SAC_dump_channel_info end\n\n"));
#endif
