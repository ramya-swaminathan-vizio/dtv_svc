...
#ifndef _MMP_AUDIO_PLAYER_H_
#define _MMP_AUDIO_PLAYER_H_
...
typedef enum
{
  MMP_AP_DETAIL_PAGE_OFF = 0,
  MMP_AP_DETAIL_PAGE_ON,
} MMP_AP_DETAIL_PAGE_STATUS_T;


extern INT32 mmp_ap_cmd_do(MMP_FP_SHOW_CMD_ID_T e_cmd_id, VOID* pv_cmd_param);
extern INT32 audio_player_get_duration_and_position(UINT64 *pui8_duration,
                                                    UINT64 *pui8_position);
extern INT32 audio_player_seek(UINT64 ui8_seek_pos);
