 ...
 *---------------------------------------------------------------------------*/
/*-----------------------------------------------------------------------------
 * $RCSfile: video_engine_thumbnail.h,v $
 * $Revision: #1 $
 * $Date: 2017/08/18 $
 * $Author: sin_fangyuan $
 *
...
#ifndef _VIDEO_ENGINE_THUMBNAIL_H_
#define _VIDEO_ENGINE_THUMBNAIL_H_ 
...
*---------------------------------------------------------------------------*/
typedef struct _VIDEO_THUMBNAIL_EX_INFO
{
    UINT32  ui4_thumbnail_x;
    UINT32  ui4_thumbnail_y;
    UINT32  ui4_thumbnail_width;
    UINT32  ui4_thumbnail_height;
}VIDEO_THUMBNAIL_EX_INFO;

/*-----------------------------------------------------------------------------
 * extern
 *---------------------------------------------------------------------------*/
extern INT32 video_engine_thumb_full_stop(
                    _MMP_VE_PLAY_INST_PTR_T         pt_this           /* in  */
                    );
extern INT32 video_engine_get_meta_data(
                    _MMP_VE_PLAY_INST_PTR_T         pt_this,          /* in  */
...
extern INT32 video_engine_get_file_data(
                    _MMP_VE_PLAY_INST_PTR_T         pt_this,          /* in  */
                    FID_T                           t_elmt_fid,       /* in  */
                    MMP_VE_INFO_ID_T                e_info_id,        /* in  */
                    VOID*                           pv_buf,           /* in/out */
...
extern INT32 video_engine_get_music_cover(APPL_SPLAYER_MUSIC_COVER_T *p_tMusicCoverInfo);

#endif /* _VIDEO_ENGINE_THUMBNAIL_H_ */
