...
static INT32 _wzd_country_setting_page_sel_box_set_checkmark(VOID)
{
	...
	if (1 == ui2_country_select_status)
	{
		...
		/* highlight or not */
		h_checkmark_img = (ui4_idx == (UINT32)pt_this->ui1_sel_box_idx)?h_g_wzd_img_checkmark_green_large : h_g_wzd_img_checkmark_green_small;
	}
	else
	{
		ui4_idx = 0;
	...
	else
	{
		SET_RECT_BY_SIZE(&t_rect,
	                     WZD_SEL_BOX_BTN_ICON_1_X,
	                     WZD_SEL_BOX_BTN_ICON_1_Y  + 70 * WZD_UI_RATIO_W,
	                     WZD_SEL_BOX_BTN_ICON_1_W  + 10 * WZD_UI_RATIO_W,
	                     WZD_SEL_BOX_BTN_ICON_1_H);
	}
...
static INT32 _wzd_country_setting_page_set_sel_box(VOID)
{
    ...
    else if (1 == ui2_country_select_status)
    {
        a_cfg_custom_get_country_code(&e_country_code);
                     ...
                     VOID*           pv_param2)
{
    ...
    switch(ui4_msg)
    {
        case WZD_SEL_BOX_MSG_ITEM_FOCUSED:
        {
            ...
            _wzd_country_setting_page_sel_box_set_font();
			_wzd_country_setting_page_sel_box_set_checkmark();
            _wzd_country_setting_page_help_update(WZD_TEXT(MLM_WZD_KEY_COUNTRY_HELP), 
                       h_g_wzd_OK_key_select);
        }
            break;
