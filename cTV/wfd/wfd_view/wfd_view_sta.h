...
#ifndef WFD_VIEW_STA_H_
#define WFD_VIEW_STA_H_

#include "wfd_view.h"

#define WFD_VIEW_STA_LOADING_UPD     (1000)

typedef enum
{
    WFD_VIEW_STA_IN_CONNECT,

    WFD_VIEW_STA_P2P_START,
    WFD_VIEW_STA_START_P2P_FAIL,
    WFD_VIEW_STA_START_P2P_OK,

    WFD_VIEW_STA_RTSP_START,
    WFD_VIEW_STA_START_RTSP_OK,
    WFD_VIEW_STA_START_RTSP_FAIL,

    WFD_VIEW_STA_P2P_DISCONNECT,
    WFD_VIEW_STA_P2P_DISCONNECT_OK,
    WFD_VIEW_STA_P2P_DISCONNECT_FAIL,

    WFD_VIEW_STA_STOP_RTSP,
    WFD_VIEW_STA_STOP_RTSP_FAIL,
    WFD_VIEW_STA_STOP_RTSP_OK,
