 ...
 * $CCRevision: /main/DTV_X_HQ_int/DTV_X_0801/4 $
 * $SWAuthor: CS Kuo $
 * $MD5HEX: cedbdb40d27bde1235b27f82667dff7d $
 *
 * Description:
 *         This header file contains POD Browser's specific definitions, which
 *         are exported.
 *---------------------------------------------------------------------------*/
 
#ifndef WFD_RTSP_CONN_H_
#define WFD_RTSP_CONN_H_
