            ...
            switch(ui2_cfg_rec)
            {
                ...
                case APP_CFG_RECID_VID_FAC_GAIN_B:
                {
                    ...
                    else
                    {
                        ...
                        //a_cfg_av_get(CFG_MAKE_ID(APP_CFG_GRPID_VIDEO, APP_CFG_RECID_CLR_TEMP), &i2_clr_temp);
                        ui4_offset = ui4_dynamic_address + ui1_TPV_color_eep_offset[i2_clr_temp][ui1_play_content] * COLOR_TUNER_FAC_PIECE_NUM + i1_idx;
                ...
                case APP_CFG_RECID_CUST_FAC_CLR_TUNER_BRI_Y:
                {
                    ...
                    ui4_offset = ui4_dynamic_address + ui1_TPV_color_eep_offset[i2_clr_temp][ui1_play_content] * COLOR_TUNER_FAC_PIECE_NUM + ui4_color_tuner_idx;
...
INT32	a_cfg_custom_reset_factory_colortemp(VOID)
{
    ...
    for (ui1_input=0; ui1_input<ACFG_CUST_INPUT_GRP_MAX; ui1_input++)
    {
        ...
        for(ui1_clr_temp=0; ui1_clr_temp<(UINT8)ACFG_CLR_TEMP_NUM; ui1_clr_temp++)
        {
            ...
            i4_ret = i4_ret = a_cfg_av_update(CFG_MAKE_ID(APP_CFG_GRPID_VIDEO, APP_CFG_RECID_CLR_OFFSET_R));
            ACFG_CHK_FAIL(i4_ret, i4_ret);
        }
