...
-----------------------------------------------------------------------------*/
#ifdef MT5691_MODEL
#define PQ_DFT_TBL_MAX_NUM          (138)  //6 * 23 //6 basic picture mode x 23 picture default setting, Larry 20210604 for modify MVV-9169
#elif defined (MT5695_MODEL)
#define PQ_DFT_TBL_MAX_NUM          (150)  //6 * 25
#elif defined(MT5583_MODEL)
#define PQ_DFT_TBL_MAX_NUM          (132)  //6 * 22
#endif
