 ...
 *
 ----------------------------------------------------------------------------*/
INT32 TPV_fac_color_temp_view_init_v2(HANDLE_T h_parent, INT32 i4_frame_x_offset, INT32 i4_frame_y_offset)
{
    INT32 i4_ret = 0;
        ...
        case WGL_MSG_KEY_DOWN:
        {
            ...
            switch (ui4_keycode)
            {
                ...
                case BTN_CURSOR_RIGHT:
                {
                    ...
                    DBG_LOG_PRINT(("[TPV_FAC] %s i1_cfg_idx: %d\n", __FUNCTION__, i1_cfg_idx));
                    DBG_LOG_PRINT(("[TPV_FAC] %s i1_idx: %d\n", __FUNCTION__, i1_idx));
                    ...
                    //Printf("\033[01;31m [TPV_FAC] \033[m %s i2_min: %d\n", __FUNCTION__, i2_min);
                    //Printf("\033[01;31m [TPV_FAC] \033[m %s i2_max: %d\n", __FUNCTION__, i2_max);
                    //Printf("\033[01;31m [TPV_FAC] \033[m %s i1_val 1: %d\n", __FUNCTION__, i1_val);
                    ...
                    DBG_LOG_PRINT(("\033[01;31m [TPV_FAC] \033[m  %s i1_val: %d\n", __FUNCTION__, i1_val));
                    #if 0
...
/*----------------------------------------------------------------------------
 * Name: TPV_fac_color_temp_menu_show_v2
 *
 * Description:
 *
 * Inputs:
 ...
 *
 ----------------------------------------------------------------------------*/
INT32 TPV_fac_color_temp_menu_show_v2(BOOL b_repaint)
{
    UTF16_T w2s_string[10]={0};
    CHAR s_string[10] = {0};
    INT16 i2_val = 0;
    ...
    TPV_LOG_ON_FAIL(i4_ret);
    i4_ret = c_wgl_insert(h_color_temp_frame, NULL_HANDLE, WGL_INSERT_TOPMOST, WGL_NO_AUTO_REPAINT);
    TPV_LOG_ON_FAIL(i4_ret);
 ...
 *
 ----------------------------------------------------------------------------*/
INT32 TPV_fac_color_temp_menu_hide_v2(BOOL b_repaint)
{
...
static INT32 _TPV_fac_color_temp_menu_update(BOOL b_repaint)
{
    ...
    DBG_LOG_PRINT(("[TPV_FAC] %s ui4_dynamic_address: %d\n", __FUNCTION__, ui4_dynamic_address)); 
    DBG_LOG_PRINT(("[TPV_FAC] %s i2_clr_temp: %d\n", __FUNCTION__, i2_clr_temp));
    ...
    i4_ret = a_cfg_eep_raw_read(
                ...
                &ui4_read); 
    TPV_LOG_ON_FAIL(i4_ret);
    TPV_fac_menu_range_set_val(h_clr_temp_R_gain, (INT32)i1_vid_eq_val);
    ...
    i4_ret = a_cfg_eep_raw_read(
                ...
                &ui4_read); 
    TPV_LOG_ON_FAIL(i4_ret);
    TPV_fac_menu_range_set_val(h_clr_temp_G_gain, (INT32)i1_vid_eq_val);
    ...
    i4_ret = a_cfg_eep_raw_read(
                ...
                &ui4_read); 
    TPV_LOG_ON_FAIL(i4_ret);
    TPV_fac_menu_range_set_val(h_clr_temp_B_gain, (INT32)i1_vid_eq_val);
    ...
    i4_ret = a_cfg_eep_raw_read(
                ...
                &ui4_read); 
    TPV_LOG_ON_FAIL(i4_ret);
    TPV_fac_menu_range_set_val(h_clr_temp_R_offset, (INT32)i1_vid_eq_val);
    ...
    i4_ret = a_cfg_eep_raw_read(
                ...
                &ui4_read); 
    TPV_LOG_ON_FAIL(i4_ret);
    TPV_fac_menu_range_set_val(h_clr_temp_G_offset, (INT32)i1_vid_eq_val);
    ...
    i4_ret = a_cfg_eep_raw_read(
                ...
                &ui4_read); 
    TPV_LOG_ON_FAIL(i4_ret);
    TPV_fac_menu_range_set_val(h_clr_temp_B_offset, (INT32)i1_vid_eq_val);
