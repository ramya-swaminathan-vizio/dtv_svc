...
#include "TPV_factory/TPV_fac_urc/TPV_fac_urc.h"
...
#define TPV_FAC_PASSWORD_DEF     {BTN_MENU, BTN_DIGIT_4, BTN_DIGIT_2, BTN_DIGIT_1, BTN_DIGIT_0};  // "Menu"+""4210"
#endif
...
extern INT32 a_TPV_fac_dialog_register(VOID);
