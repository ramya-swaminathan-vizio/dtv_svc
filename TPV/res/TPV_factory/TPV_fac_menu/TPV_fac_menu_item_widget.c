/*-----------------------------------------------------------------------------
* $RCSfile: TPV_fac_menu_item_widget.c,v $
* $Revision: #3 $
* $Date: 2017/08/30 $
* $Author:  $
* $CCRevision: $
...
static GL_RECT_T   t_rect_item_border_title = {65, 0, 120, 30};

#define TPV_fac_menu_FRAME_HEIGHT 1080
#define TPV_fac_menu_ITEM_LEFT            (0)
#define TPV_fac_menu_ITEM_WIDE            (568)
#define TPV_fac_menu_ITEM_HEIGHT          (30)//(44)


/*----------------------------------------------------------------------------
 * Name: TPV_fac_menu_text_widget_create
 *
 * Description:
 *
 * Inputs:
 ...
 *
 ----------------------------------------------------------------------------*/
INT32 TPV_fac_menu_frame_widget_create(HANDLE_T h_parent,
                                                  HANDLE_T* ph_child,
                                                  ...
                                                  INT32 i4_frame_y_offset)
{
    ...
    SET_RECT_BY_SIZE(
                    ...
                    i4_frame_x_offset,
                    i4_frame_y_offset,
                    TPV_fac_menu_ITEM_WIDE,
                    TPV_fac_menu_FRAME_HEIGHT
                    );
...
/*----------------------------------------------------------------------------
 * Name: TPV_fac_menu_frame_title_widget_create
 *
 * Description:
 *
 * Inputs:
 ...
 *
 ----------------------------------------------------------------------------*/
INT32 TPV_fac_menu_frame_title_widget_create(HANDLE_T h_parent,
                                                  HANDLE_T* ph_child,
 ...
 *
 ----------------------------------------------------------------------------*/
INT32 TPV_fac_menu_text_widget_create(HANDLE_T h_parent, 
                                               UTF16_T* pw2s_string, 
                                               INT32 i4_index,
                                               ...
                                               HANDLE_T* ph_widget)
{
    ...
    SET_RECT_BY_SIZE(&t_rect,
                    0,
                    TPV_fac_menu_ITEM_HEIGHT * i4_index,
                    TPV_fac_menu_ITEM_WIDE,
                    TPV_fac_menu_ITEM_HEIGHT);
...
/*----------------------------------------------------------------------------
 * Name: TPV_fac_menu_range_widget_create
 *
 * Description:
 *
 * Inputs:
 ...
 *
 ----------------------------------------------------------------------------*/
INT32 TPV_fac_menu_range_widget_create( HANDLE_T    h_parent,
                                                    UTF16_T*    pw2s_string,
                                                    INT32       i4_index,
                                                    INT32       i4_min,
                                                    INT32       i4_max,
...
/*----------------------------------------------------------------------------
 * Name: TPV_fac_menu_range_no_pb_widget_create
 *
 * Description:
 *
 * Inputs:
 ...
 *
 ----------------------------------------------------------------------------*/
INT32 TPV_fac_menu_range_no_pb_widget_create( HANDLE_T    h_parent,
                                                    UTF16_T*    pw2s_string,
                                                    INT32       i4_index,
                                                    INT32       i4_min,
                                                    INT32       i4_max,
...
/*----------------------------------------------------------------------------
 * Name: TPV_fac_menu_list_widget_create
 *
 * Description:
 *
 * Inputs:
 ...
 *
 ----------------------------------------------------------------------------*/
INT32 TPV_fac_menu_list_widget_create(
    HANDLE_T    h_parent,
    UTF16_T*    pw2s_string,
    INT32       i4_index,
    ...
    HANDLE_T*   ph_widget)
{
    ...
    t_lb_init.ui2_elem_size     = TPV_fac_menu_ITEM_HEIGHT;
...
/*----------------------------------------------------------------------------
 * Name: TPV_fac_menu_list_set_text
 *
 * Description:
 *
 * Inputs:
 ...
 *
 ----------------------------------------------------------------------------*/
INT32 TPV_fac_menu_list_set_text(
        HANDLE_T    h_widget,
        UTF16_T*    w2s_str)
{
    INT32   i4_ret = 0;
...
/*----------------------------------------------------------------------------
 * Name:TPV_fac_menu_range_get_val
 *
 * Description:
 *
 * Inputs:
 ...
 *
 ----------------------------------------------------------------------------*/
INT32 TPV_fac_menu_range_get_val(HANDLE_T h_widget, INT32* pi4_val)
{
    INT32 i4_ret = 0;
    INT32 i4_val;
...
/*----------------------------------------------------------------------------
 * Name: TPV_fac_menu_range_set_val
 *
 * Description:
 *
 * Inputs:
 ...
 *
 ----------------------------------------------------------------------------*/
INT32 TPV_fac_menu_range_set_val(HANDLE_T h_widget, INT32 i4_val)
{
    INT32 i4_ret = 0;
