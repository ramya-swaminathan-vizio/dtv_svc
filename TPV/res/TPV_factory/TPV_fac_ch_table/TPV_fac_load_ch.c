...
static TSL_DATA_T    t_tsl_table_XM_antenna[] =	// Ben 20161206
{
    ...
    {0x8003,	BRDCST_TYPE_ANALOG,	BRDCST_MEDIUM_ANA_TERRESTRIAL,	0,	0,	0,	0,	61234375,	BW_UNKNOWN,	MOD_PSK_8},
    {0x8009,	BRDCST_TYPE_ANALOG,	BRDCST_MEDIUM_ANA_TERRESTRIAL,	0,	0,	0,	0,	187234375,	BW_UNKNOWN,	MOD_PSK_8},
    ...
    {0x2   ,	BRDCST_TYPE_ATSC,	BRDCST_MEDIUM_DIG_TERRESTRIAL,	0,	2,	1,	0,	57000000,	BW_UNKNOWN,	MOD_VSB_8},
    {0x2   ,	BRDCST_TYPE_ATSC,	BRDCST_MEDIUM_DIG_TERRESTRIAL,	0,	2,	1,	0,	57000000,	BW_UNKNOWN,	MOD_VSB_8},
    {0x801d,	BRDCST_TYPE_ANALOG,	BRDCST_MEDIUM_ANA_TERRESTRIAL,	0,	0,	0,	0,	561730000,	BW_UNKNOWN,	MOD_PSK_8},
    {0x801e,	BRDCST_TYPE_ANALOG,	BRDCST_MEDIUM_ANA_TERRESTRIAL,	0,	0,	0,	0,	567234375,	BW_UNKNOWN,	MOD_PSK_8},
    {0x8026,	BRDCST_TYPE_ANALOG,	BRDCST_MEDIUM_ANA_TERRESTRIAL,	0,	0,	0,	0,	615218750,	BW_UNKNOWN,	MOD_PSK_8},
    {0x803c,	BRDCST_TYPE_ANALOG,	BRDCST_MEDIUM_ANA_TERRESTRIAL,	0,	0,	0,	0,	748970000,	BW_UNKNOWN,	MOD_PSK_8},
    {0x803f,	BRDCST_TYPE_ANALOG,	BRDCST_MEDIUM_ANA_TERRESTRIAL,	0,	0,	0,	0,	765234375,	BW_UNKNOWN,	MOD_PSK_8},
};
...
static TSL_DATA_T    t_tsl_table_XM_cable[] =	// Ben 20161206
{
    ...
    {0x4f  ,	BRDCST_TYPE_ATSC,	BRDCST_MEDIUM_DIG_CABLE,	0,	79,	741,	0,	555000000,	BW_UNKNOWN,	MOD_QAM_256},
    {0x14  ,	BRDCST_TYPE_ATSC,	BRDCST_MEDIUM_DIG_CABLE,	0,	20,	299,	0,	159000000,	BW_UNKNOWN,	MOD_QAM_256},
    {0x8031,	BRDCST_TYPE_ANALOG,	BRDCST_MEDIUM_ANA_CABLE,	0,	0,	0,	0,	374480000,	BW_UNKNOWN,	MOD_PSK_8},
    {0x8043,	BRDCST_TYPE_ANALOG,	BRDCST_MEDIUM_ANA_CABLE,	0,	0,	0,	0,	481250000,	BW_UNKNOWN,	MOD_PSK_8},
    {0x805b,	BRDCST_TYPE_ANALOG,	BRDCST_MEDIUM_ANA_CABLE,	0,	0,	0,	0,	625234375,	BW_UNKNOWN,	MOD_PSK_8},
    {0x8062,	BRDCST_TYPE_ANALOG,	BRDCST_MEDIUM_ANA_CABLE,	0,	0,	0,	0,	109234375,	BW_UNKNOWN,	MOD_PSK_8},
};
...
static SVL_DATA_T    t_svl_table_XM_antenna[] =	// Ben 20161206
{
    ...
    {0xc0080   ,	0x200100f ,	0,	0x8003,	BRDCST_TYPE_ANALOG,	SVL_SERVICE_TYPE_TV,	"",	TV_SYS_MASK_NONE,	AUDIO_SYS_MASK_NONE,	COLOR_SYS_NTSC},
    {0x240080  ,	0x200100f ,	0,	0x8009,	BRDCST_TYPE_ANALOG,	SVL_SERVICE_TYPE_TV,	"",	TV_SYS_MASK_NONE,	AUDIO_SYS_MASK_NONE,	COLOR_SYS_NTSC},
    ...
    {0x740080  ,	0x200100f ,	0,	0x801d,	BRDCST_TYPE_ANALOG,	SVL_SERVICE_TYPE_TV,	"",	TV_SYS_MASK_NONE,	AUDIO_SYS_MASK_NONE,	COLOR_SYS_NTSC},
    {0x780080  ,	0x200100f ,	0,	0x801e,	BRDCST_TYPE_ANALOG,	SVL_SERVICE_TYPE_TV,	"",	TV_SYS_MASK_NONE,	AUDIO_SYS_MASK_NONE,	COLOR_SYS_PAL_N,},
    {0x980080  ,	0x200100f ,	0,	0x8026,	BRDCST_TYPE_ANALOG,	SVL_SERVICE_TYPE_TV,	"",	TV_SYS_MASK_NONE,	AUDIO_SYS_MASK_NONE,	COLOR_SYS_PAL},
    {0xf00080  ,	0x200100f ,	0,	0x803c,	BRDCST_TYPE_ANALOG,	SVL_SERVICE_TYPE_TV,	"",	TV_SYS_MASK_NONE,	AUDIO_SYS_MASK_NONE,	COLOR_SYS_NTSC},
    {0xfc0080  ,	0x200100f ,	0,	0x803f,	BRDCST_TYPE_ANALOG,	SVL_SERVICE_TYPE_TV,	"",	TV_SYS_MASK_NONE,	AUDIO_SYS_MASK_NONE,	COLOR_SYS_NTSC},
};
...
{
    /* channel_num, nw_mask, prog_id, tsl_rec_id, brdcst_type, serv_type, ch_name, tv_sys, audio_sys, vid_color_sys*/
    {0x140100  ,	0xf       ,	3,	0x4f  ,	BRDCST_TYPE_ATSC,	SVL_SERVICE_TYPE_TV,	"WAGA-HD",	TV_SYS_MASK_NONE,	AUDIO_SYS_MASK_NONE,	COLOR_SYS_NTSC},
    {0x140200  ,	0xf       ,	4,	0x4f  ,	BRDCST_TYPE_ATSC,	SVL_SERVICE_TYPE_TV,	"WAGA-SD",	TV_SYS_MASK_NONE,	AUDIO_SYS_MASK_NONE,	COLOR_SYS_NTSC},
    {0x2c0100  ,	0xf       ,	3,	0x14  ,	BRDCST_TYPE_ATSC,	SVL_SERVICE_TYPE_TV,	"KTTV-DT",	TV_SYS_MASK_NONE,	AUDIO_SYS_MASK_NONE,	COLOR_SYS_NTSC},
    {0xc40080  ,	0x100f    ,	0,	0x8031,	BRDCST_TYPE_ANALOG,	SVL_SERVICE_TYPE_TV,	"",	TV_SYS_MASK_NONE,	AUDIO_SYS_MASK_NONE,	COLOR_SYS_NTSC},
    {0x10c0080 ,	0x100f    ,	0,	0x8043,	BRDCST_TYPE_ANALOG,	SVL_SERVICE_TYPE_TV,	"",	TV_SYS_MASK_NONE,	AUDIO_SYS_MASK_NONE,	COLOR_SYS_PAL_M},
    {0x16c0080 ,	0x100f    ,	0,	0x805b,	BRDCST_TYPE_ANALOG,	SVL_SERVICE_TYPE_TV,	"",	TV_SYS_MASK_NONE,	AUDIO_SYS_MASK_NONE,	COLOR_SYS_PAL},
    {0x1880080 ,	0x100f    ,	0,	0x8062,	BRDCST_TYPE_ANALOG,	SVL_SERVICE_TYPE_TV,	"",	TV_SYS_MASK_NONE,	AUDIO_SYS_MASK_NONE,	COLOR_SYS_NTSC},
};
...
-----------------------------------------------------------------------------*/
INT32 acfg_TPV_dump_channel_info(VOID)
{
    SVL_REC_T   t_svl_rec;
    TSL_REC_T   t_tsl_rec;
    ...
    i4_ret = c_svl_get_rec_by_channel(h_g_acfg_svl_cable,
                                ui4_channel_id,
                                SB_VNET_ALL,
                                0,
                                &t_svl_rec,
    ...
    DBG_LOG_PRINT(("\n\nacfg_TPV_dump_channel_info end\n\n"));
#endif
...
INT32 acfg_TPV_load_default_channel(CHAR* ui1_area)
{
    UINT16 ui2_i;
    SVL_REC_T t_svl_rec;
    TSL_REC_T t_tsl_rec;
...
INT32 acfg_TPV_get_channel_freqency(VOID)
{
    SVL_REC_T   t_svl_rec;
    TSL_REC_T   t_tsl_rec;
	UINT32 ui4_channel_id = a_util_cnfg_get_crnt_channel_id();
