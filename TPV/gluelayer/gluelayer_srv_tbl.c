...
T_CMD_DATA_MAP_A at_a_cmd_map[GLUELAYER_CMD_A_END+1] =
{
    ...
    {GLUELAYER_CMD_A_FACTORY_SET_REGISTRATION,  a_TPV_factory_set_registration},
    {GLUELAYER_CMD_A_FACT_PARSER_INIT,  a_TPV_fact_parser_init},
    ...
    {GLUELAYER_CMD_A_HDR_PANEL_NITS,  acfg_cust_odm_current_default_hdr_panel_nits},
    {0,0}
};
